 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: llib-lc.c,v $ $Revision: 4.2.8.10 $ (DEC) $Date: 1993/12/17 21:06:59 $";
#endif 
/*
 */
/*
...
unsigned ualarm(m, i) unsigned m; unsigned i; { return (m); }
/* BRK(2) */
int	brk(e) char *e; { return (0); }
char *	sbrk(i) ssize_t i; { return (""); }
/* CHDIR(2) */
int	chdir(s) char *s; { return (0); }
/* CHMOD(2) */
int	chmod(s, m) char *s; mode_t m; { return (0); }
/* CHOWN(2) */
int	chown(s, o, g) char *s; uid_t o; gid_t g; { return (0); }
int	fchown(s, o, g) char *s; uid_t o; gid_t g; { return (0); }
/* CHROOT(2) */
...
void	exit(s) int s; {}
void	_exit(s) int s; {}
int	atexit(function) void (*function)(); { return 0; }
/* FCLEAR(2) */
...
/* RAISE(3) */
int raise(sig) int sig; { return sig; }
/* READ(2) */
#ifdef	_NONSTD_TYPES
...
#endif
/* READLINK(2) */
int  	readlink(p, b, i) const char *p; char *b; int i; { return 0; }
/* REBOOT(2) */
...
/* SETLOGIN(2) */
int  	setlogin(p) char * p; { return 0; }
/* SETPGID(2) */
int setpgid(p1, p2) pid_t p1; pid_t p2; { return 0; }
/* SETSID(2) */
pid_t	setsid() { return (pid_t)0; } 
/* SETUID(2) */
int	setuid(u) uid_t u; { return (u); }
int	seteuid(u) uid_t u; { return (u); }
...
/* SIGACTION(2) */
int sigaction(sig, act, oact) int sig; struct sigatcion *act, *oact;
	{ return 0; }
/* SIGHOLD(2) */
...
/* SIGPROCMASK(2) */
int sigprocmask(how, set, oset) int how; sigset_t *set, *oset; { return 0; }
/* SIGRELSE(2) */
int	sigrelse(s) int s; { return (s); }
/* SIGRETURN(2) */
int sigreturn(scp) struct sigcontext *scp; { return 0; }
/* SIGSEND(2) */
int sigsend(idtype, id, sig) idtype_t idtype; id_t id; int sig; { return sig; }
/* SIGSENDSET(2) */
int sigsendset(psetp, sig) procset_t *psetp; int sig; { return sig; }
/* SIGSET(2) */
...
/* SIGSUSPEND(2) */
int sigsuspend(signal_mask) sigset_t *signal_mask; { return 0; }
/* SIGVEC(2) */
int	sigvec(s, nv, ov) int s; struct sigvec *nv, *ov; { return (0); }
/* SIGWAIT(2) */
int sigwait(set) sigset_t *set; { return 0; }
/* STAT(2) */
...
void	sync() {}
/* SYMLINK (2) */
int symlink(p1, p2) const char *p1; const char *p2; { return 0; }
/* TCGETGRP(2) */
pid_t 	tcgetpgrp(i) int i; { return (pid_t)0; }
int 	tcsetpgrp(i, p) int i; pid_t p; { return 0; }
/* TIME */
...
/* TRUNCATE(2) */
int	truncate(p, l) const char *p; off_t l; { return 0; }
/* ULIMIT(2) */
...
/* CLOCK_GETDRIFT(2) */
int clock_getdrift(clock_id, oppb) int clock_id, *oppb; { return 0; }
/* CLOCK_GETRES(2) */
int clock_getres(clock_id, res) int clock_id; struct timespec *res;
	{ return 0; }
/* CLOCK_GETTIME(2) */
int clock_gettime(clock_id, tp) int clock_id; struct timespec *tp;
	{ return 0; }
/* CLOCK_SETDRIFT(2) */
int clock_setdrift(clock_id, ppb, oppb) int clock_id, ppb, *oppb; { return 0; }
/* CLOCK_SETTIME(2) */
int clock_settime(clock_id, tp) int clock_id; struct timespec *tp;
	{ return 0; }
/* CRYPT(3C) */
...
/* NANOSLEEP(2) */
int nanosleep(rqtp, rmtp)  struct timespec *rqtp; struct timespec *rmtp;
	{ return 0; }
/* NCSTRING(3C) */
...
/* RMDIR(2) */
int 	rmdir(p) const char *p; { return 0; }
/* SCANF(3S) */
	/*VARARGS1 SCANFLIKE1*/
...
/* SETREUID(2) */
int  setreuid(u1, u2) uid_t u1; uid_t u2; { return 0; }
/* SLEEP(3C) */
...
/* TIMER_CREATE(2) */
timer_t timer_create(clock_id, evp) int clock_id; struct sigevent *evp;
{ return (timer_t)0; }
/* TIMER_DELETE(2) */
int timer_delete(timerid) timer_t timerid; { return 0; }
/* TIMER_getoverrun(2) */
int timer_getoverrun(timerid) timer_t timerid; { return 0; }
/* TIMER_GETTIME(2) */
int timer_gettime(timerid, value) timer_t timerid; struct itimerspec *value;
	{ return 0; }
/* TIMER_SETTIME(2) */
int timer_settime(timerid, flags, value, ovalue) 
	 timer_t timerid; int flags; struct itimerspec *value;
...
wint_t	ungetwc(c, f) wint_t c; FILE *f; { return (c); }
/* VPRINTF(3S) */
#include <varargs.h>
...
size_t confstr(i, p, sz) int i; char *p; size_t sz; {return (size_t)0; }
#undef _NCbufstr
#undef _NCfreebuf
...
pid_t   getsid(p) pid_t p; { return p; }
...
void    *valloc (a) register ssize_t a; {};
#include <locale.h>
...
char	*initstate(seed, state, size) unsigned seed; char *state; int size; { return state; }
char	*setstate(state) char *state; { return state; }
...
char *strptime(buf, format, tm) const char *buf, *format; 
	struct tm *tm; { return buf; }
...
wint_t	fgetwc(s) FILE *s; { return (0); }
wint_t	fputwc(c,f) wint_t c; FILE *f; { return (c); }
...
wint_t	getwchar() { return (0); }
wint_t	putwchar(c) wint_t c; { return (c); }
...
int rpmatch(s) const char *s; { return 0; }
...
int	mbtowc(p,s,n) wchar_t *p; const char *s; size_t n;
	{ return (0); }
int	mblen(mbs, n) const char *mbs; size_t n; { return 0; }
