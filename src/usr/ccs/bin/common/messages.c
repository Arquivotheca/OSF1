 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: messages.c,v $ $Revision: 4.2.6.3 $ (DEC) $Date: 1993/11/01 19:21:31 $";
#endif 
/*
 */
/*
...
/* [7] */	"static variable %s set but not used",		/* werror::name */
...
/* [27] */	"conversion to long may sign-extend.",	/* werror (-Q)*/
...
/* [195]  */ "%s constant truncated to %s; operator %s", /* werror */
/* [196]  */ "Unable to parse format control string in scanf or printf", /* werror */
/* [197]  */ "Variable format control strings in scanf or printf unchecked by lint", /* werror */ 
/* [198]  */ "Format control string mismatch for parameter %d", /* werror */
/* [199]  */ "%%l%c is invalid in format control string; Parameters unchecked", /* werror */
/* [200]  */ "Internal error caused loss of format control information; Parameters unchecked", /* werror */   
/* [201]  */ "Format control string information missing for argument %d", /* werror */
/* [202]  */ "%s %s CAST to %s %s these structs differ in %s",
/* [203]  */ "pointer %s is truncated to %s by %s %s",
/* [204]  */ "Parameter %d not a pointer in %s",
/* [205]  */ "Result of '%s' ALWAYS yields zero",	/* warning -Q */
/* [206]  */ "Result of '%s' MAY yield zero",		/* warning -Q */
};
