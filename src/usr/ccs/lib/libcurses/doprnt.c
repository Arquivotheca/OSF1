...
static char rcsid[] = "@(#)$RCSfile: doprnt.c,v $ $Revision: 4.2.2.2 $ (DEC) $Date: 1993/06/12 21:20:43 $";
#endif
/*
 * HISTORY
 */
 ...
 */ 
/***
 ***  "doprnt.c  1.7  com/lib/curses,3.1,8943 10/16/89 23:13:31";
 ***/
/*
 * COMPONENT_NAME: (LIBCURSE) Curses Library
 *
 * FUNCTIONS:   memcpy, _doprnt, __dpdummy__
 *
 *
