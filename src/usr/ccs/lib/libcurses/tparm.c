...
static char rcsid[] = "@(#)$RCSfile: tparm.c,v $ $Revision: 4.2.2.2 $ (DEC) $Date: 1993/06/12 22:45:51 $";
#endif
/*
 * HISTORY
 */
/*** "tparm.c  1.8  com/lib/curses,3.1,9008 12/14/89 17:54:28"; ***/
/*
 * COMPONENT_NAME: (LIBCURSE) Curses Library
 *
 * FUNCTIONS:   taprm, _prstr, _err, _branchto
 *
 *
...
one:
		...
		case 'c':
			/*
			 * The idea is that various weird things can
			 ...
			 * this fix won't always work (e.g. the Ann Arbor
		...
		case '~': stack[top] = ~stack[top]; break;
		/* No unary minus, because minus is binary. */

		/*
		 * If-then-else.  Implemented by a low level fix of
