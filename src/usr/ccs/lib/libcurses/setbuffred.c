...
static char rcsid[] = "@(#)$RCSfile: setbuffred.c,v $ $Revision: 4.2.4.2 $ (DEC) $Date: 1993/06/12 22:29:55 $";
#endif
/*
 * HISTORY
 */
/*** "setbuffred.c  1.5  com/lib/curses,3.1,8943 10/16/89 23:39:13"; ***/
/*
