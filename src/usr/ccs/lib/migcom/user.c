 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: user.c,v $ $Revision: 4.2.2.2 $ (DEC) $Date: 1993/01/05 16:31:08 $";
#endif 
/*
 */
/*
    ...
    routine_t *rt;
{
    ...
    fputs("\tunsigned int ", file);
    WriteMessageSize(file, rt, rt->rtNumRequestVar, "=", "Request");
    fputs(";\n", file);
    ...
    routine_t *rt;
{
    ...
    fputs("\tif (((", file);
    WriteMessageSize(file, rt, rt->rtNumReplyVar,
				rt->rtNumReplyVar > 0? "<": "!=", "Reply");
    fputc(')', file);
