 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: type.c,v $ $Revision: 4.2.2.2 $ (DEC) $Date: 1992/04/06 15:21:32 $";
#endif 
/*
 */
/*
    ...
    register ipc_type_t *it;
{
	...
	bytes += 4;	/* correction for pointers */
#endif
