 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: malloc.c,v $ $Revision: 4.2.2.3 $ (DEC) $Date: 1992/08/07 13:53:15 $";
#endif 
/*
 */
/*
...
typedef struct free_list {
	volatile int lock;	/* spin lock for mutual exclusion */
...
private volatile int malloc_lock = SPIN_LOCK_UNLOCKED;
...
realloc(any_t old_base, size_t new_size)
{
	 ...
	 */
	h = (header_t) ((caddr_t)old_base - sizeof(union header));
	/*
