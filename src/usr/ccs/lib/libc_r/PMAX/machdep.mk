...
#
#
#	@(#)$RCSfile: machdep.mk,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 03:53:18 $
...
PMAXCOBJS = getlogin.o sigpending.o sigprocmask.o

PMAXSOBJS = _getlogin.o _sigpending.o _sigprocmsk.o _sigsuspend.o accept.o \
	    ...
	    shmget.o shutdown.o sigaction.o sigreturn.o \
