 ...
 */
#ifndef lint
static char     *sccsid = "@(#)$RCSfile: pmap_rmt.c,v $ $Revision: 4.2.7.2 $ (DEC) $Date: 1993/06/07 23:34:53 $";
#endif
/*
 */
...
#pragma weak clnt_broadcast = __clnt_broadcast
#pragma weak clnt_broadcast_exp = __clnt_broadcast_exp
#pragma weak pmap_rmtcall = __pmap_rmtcall
#pragma weak xdr_rmtcall_args = __xdr_rmtcall_args
#pragma weak xdr_rmtcallres = __xdr_rmtcallres
#endif
#endif
#ifdef _NAME_SPACE_WEAK_STRONG
#ifdef stat
	...
	register struct rmtcallres *crp;
{
	...
	if (xdr_reference(xdrs, &port_ptr, sizeof (u_int),
	    xdr_u_int) && xdr_u_int(xdrs, &crp->resultslen)) {
		crp->port_ptr = (u_int *)port_ptr;
