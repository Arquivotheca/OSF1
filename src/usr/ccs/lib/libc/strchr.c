 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: strchr.c,v $ $Revision: 4.2.5.4 $ (DEC) $Date: 1993/11/18 15:40:06 $";
#endif 
/*
 */
/*
 ...
 *
 * strchr.c	1.11  com/lib/c/str,3.1,8943 10/19/89 17:28:22
 */
