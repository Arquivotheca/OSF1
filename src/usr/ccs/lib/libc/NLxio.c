 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: NLxio.c,v $ $Revision: 4.2.4.3 $ (DEC) $Date: 1993/06/08 01:19:20 $";
#endif 
/*
 */
/*
 ...
 *
 * NLxio.c	1.2  com/lib/c/nls,3.1,8943 9/13/89 17:09:14
 */
...
#pragma weak NLxin = __NLxin
#pragma weak NLxout = __NLxout
#pragma weak NLxstart = __NLxstart
#endif
#endif
#include <stdio.h>
#include <fcntl.h>
