 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: iswpunct.c,v $ $Revision: 1.1.6.2 $ (DEC) $Date: 1993/06/07 23:18:54 $";
#endif
/*
...
#pragma weak iswpunct = __iswpunct
#endif
#endif
...
iswpunct(wint_t pc)
{
	if (METHOD(__lc_ctype, iswctype) == NULL)
		return __iswctype_sb(pc, _ISPUNCT, __lc_ctype);
	else
		return METHOD(__lc_ctype, iswctype)
			( pc, _ISPUNCT, __lc_ctype);
}
