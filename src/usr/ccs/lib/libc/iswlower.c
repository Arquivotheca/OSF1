 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: iswlower.c,v $ $Revision: 1.1.6.2 $ (DEC) $Date: 1993/06/07 23:18:26 $";
#endif
/*
...
#pragma weak iswlower = __iswlower
#endif
#endif
...
iswlower(wint_t pc)
{
	if (METHOD(__lc_ctype, iswctype) == NULL)
		return __iswctype_sb(pc, _ISLOWER, __lc_ctype);
	else
		return METHOD(__lc_ctype, iswctype)
			( pc, _ISLOWER, __lc_ctype);
}
