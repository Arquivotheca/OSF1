 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: iswcntrl.c,v $ $Revision: 1.1.6.2 $ (DEC) $Date: 1993/06/07 23:17:46 $";
#endif
/*
...
#pragma weak iswcntrl = __iswcntrl
#endif
#endif
...
iswcntrl(wint_t pc)
{
	if (METHOD(__lc_ctype, iswctype) == NULL)
		return __iswctype_sb(pc, _ISCNTRL, __lc_ctype);
	else
		return METHOD(__lc_ctype, iswctype)
			( pc, _ISCNTRL, __lc_ctype);
}
