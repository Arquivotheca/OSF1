...
#
#
#     @(#)$RCSfile: machdep.mk,v $ $Revision: 4.3.3.7 $ (DEC) $Date: 1992/09/29 14:38:10 $
...
PMAXCOBJS = alloca.o calls.o emulate_br.o fp_const.o getlogin.o \
...
PMAXSOBJS = Ovfork.o __udivsi3.o __umodsi3.o _exit.o _getlogin.o \
	...
	atomic_op.o bcmp.o bcopy.o bind.o brk.o bzero.o \
	...
	execute_br.o execv.o execve.o execwl.o \
	...
	listen.o lseek.o lstat.o madvise.o memcmp.o \
	memcpy.o memmove.o memset.o mkdir.o mknod.o \
	...
	rindex.o rmdir.o sbrk.o select.o semctl.o semget.o \
	...
	setregid.o setreuid.o setrlimit.o setsid.o setsockopt.o setsysinfo.o \
	...
	unlink.o utimes.o uswitch.o wait4.o \
	write.o writev.o chflags.o fchdir.o fchflags.o \
	swap_lw_bytes.o swap_wd_bytes.o swap_words.o \
	setpgrp.o umount.o revoke.o usleep_thread.o exportfs.o getsid.o

umount.o_CFLAGS		= -DSYS_umount=SYS_unmount

crt0.o: crt0.s
	${_AS_} -G 0 -DCRT0 ${_ASFLAGS_} -g0 -O2 $*.s -o $*.o

#COFF_SAVEGP=la $$28,_gp;
#
#crt0.o: crt0.s
#	${_CC_} -G 0 ${_CCFLAGS_} -S $*.c
#	${MV} $*.s $*.i
#	@echo "sed <post-processing> $*.i >$*.s"; \
#	 sed -e 's<__start:<__start: ${${OBJECT_FORMAT}_SAVEGP}move $$4,$$29<' \
#	     -e 's<\.option<\#\.option<' $*.i > $*.s
#	${_CC_} -G 0 ${_CCFLAGS_} -c $*.s
#	${RM} -f $*.i $*.s $*.S
#	${LD} -x -r $*.out
#	${MV} -f a.out $*.o
