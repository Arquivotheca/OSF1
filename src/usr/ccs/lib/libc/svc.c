 ...
 */
#ifndef lint
static char     *sccsid = "@(#)$RCSfile: svc.c,v $ $Revision: 4.2.7.2 $ (DEC) $Date: 1993/06/07 23:10:20 $";
#endif
/*
 */
...
#pragma weak svc_getreq = __svc_getreq
#pragma weak svc_getreqset = __svc_getreqset
#pragma weak svc_register = __svc_register
#pragma weak svc_sendreply = __svc_sendreply
#pragma weak svc_unregister = __svc_unregister
#pragma weak svc_versquiet = __svc_versquiet
#pragma weak svcerr_auth = __svcerr_auth
#pragma weak svcerr_decode = __svcerr_decode
#pragma weak svcerr_noproc = __svcerr_noproc
#pragma weak svcerr_noprog = __svcerr_noprog
#pragma weak svcerr_progvers = __svcerr_progvers
#pragma weak svcerr_systemerr = __svcerr_systemerr
#pragma weak svcerr_weakauth = __svcerr_weakauth
#pragma weak xprt_register = __xprt_register
#pragma weak xprt_unregister = __xprt_unregister
#endif
#endif
#ifdef _NAME_SPACE_WEAK_STRONG
#ifdef stat
...
svc_versquiet(xprt)
	register SVCXPRT *xprt;
{
	xprt->xp_p3 = (caddr_t)(SVC_VERSQUIET|(u_int)xprt->xp_p3);
}
