 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: wcsrchr.c,v $ $Revision: 4.2.5.2 $ (DEC) $Date: 1993/06/08 00:08:48 $";
#endif 
/*
 ...
 *
 * wcsrchr.c	1.3  com/lib/c/nls,3.1,9013 2/27/90 21:44:57
 */
