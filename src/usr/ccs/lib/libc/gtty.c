 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: gtty.c,v $ $Revision: 4.2.5.2 $ (DEC) $Date: 1993/06/07 23:08:30 $";
#endif 
/*
 */
/*
 ...
 *		and EINVAL.
 *
 * gtty.c	1.1  com/lib/c/tty,3.1,8943 3/22/89 13:42:32
 */
