 ...
 */
#ifndef lint
static char     *sccsid = "@(#)$RCSfile: yp_enum.c,v $ $Revision: 4.2.7.2 $ (DEC) $Date: 1993/06/08 00:21:27 $";
#endif
/*
 */
...
#pragma weak v1prot_dofirst = __v1prot_dofirst
#pragma weak v1prot_donext = __v1prot_donext
#pragma weak yp_first = __yp_first
#pragma weak yp_next = __yp_next
#endif
#endif
#define NULL 0L
#include <sys/time.h>
