 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: getdate.c,v $ $Revision: 1.1.6.4 $ (DEC) $Date: 1993/10/05 21:00:56 $";
#endif
/*
...
#pragma weak getdate_r = __getdate_r
#endif
#if !defined(_THREAD_SAFE)
#pragma weak getdate = __getdate
#endif
#endif
#include <sys/stat.h>
#include <sys/mode.h>
...
#ifdef  _THREAD_SAFE
struct tm *
getdate_r(char *start_string, struct tm *time_structp, int *getdate_errp)
{
	char *result;
#else
struct tm *
getdate(char *start_string)
{
	...
	/* tzset() call avoidance logic moved to top of tzset() */
	(void) tzset();
