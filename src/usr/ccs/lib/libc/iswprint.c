 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: iswprint.c,v $ $Revision: 1.1.6.2 $ (DEC) $Date: 1993/06/07 23:18:37 $";
#endif
/*
...
#pragma weak iswprint = __iswprint
#endif
#endif
...
iswprint(wint_t pc)
{
	if (METHOD(__lc_ctype, iswctype) == NULL)
		return __iswctype_sb(pc, _ISPRINT, __lc_ctype);
	else
		return METHOD(__lc_ctype, iswctype)
			( pc, _ISPRINT, __lc_ctype);
}
