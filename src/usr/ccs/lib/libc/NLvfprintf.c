 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: NLvfprintf.c,v $ $Revision: 4.2.4.3 $ (DEC) $Date: 1993/06/08 01:19:05 $";
#endif 
/*
 */
/*
 ...
 *
 * NLvfprintf.c	1.3  com/lib/c/prnt,3.1,8943 9/7/89 10:04:45
 */
...
#pragma weak NLvfprintf = __NLvfprintf
#endif
#endif
#include <stdio.h>
#include <varargs.h>
