 ...
 */
#ifndef lint
static char     *sccsid = "@(#)$RCSfile: xdr.c,v $ $Revision: 4.2.6.4 $ (DEC) $Date: 1993/09/21 21:34:39 $";
#endif
/*
 */
...
#include "pollution.h"
#define xdr_longlong_t __xdr_longlong_t
#define xdr_u_hyper __xdr_u_hyper
#define xdr_u_longlong_t __xdr_u_longlong_t
#define xdr_hyper __xdr_hyper
#if !defined(_THREAD_SAFE)
#pragma weak xdr_longlong_t = __xdr_longlong_t
#pragma weak xdr_u_hyper = __xdr_u_hyper
#pragma weak xdr_u_longlong_t = __xdr_u_longlong_t
#pragma weak xdr_hyper = __xdr_hyper
#pragma weak xdr_bool = __xdr_bool
#pragma weak xdr_bytes = __xdr_bytes
#pragma weak xdr_char = __xdr_char
#pragma weak xdr_enum = __xdr_enum
#pragma weak xdr_free = __xdr_free
#pragma weak xdr_int = __xdr_int
#pragma weak xdr_long = __xdr_long
#pragma weak xdr_netobj = __xdr_netobj
#pragma weak xdr_opaque = __xdr_opaque
#pragma weak xdr_short = __xdr_short
#pragma weak xdr_string = __xdr_string
#pragma weak xdr_u_char = __xdr_u_char
#pragma weak xdr_u_int = __xdr_u_int
#pragma weak xdr_u_long = __xdr_u_long
#pragma weak xdr_u_short = __xdr_u_short
#pragma weak xdr_union = __xdr_union
#pragma weak xdr_void = __xdr_void
#pragma weak xdr_wrapstring = __xdr_wrapstring
#endif
#endif
#ifdef KERNEL
#include "param.h"
	...
	long *lp;
{
		 ...
		 * The vaule must be no less than the most negative 32-bit
		 * signed quantity and no greater than the most positive.
		 */
		if ((*lp < (long)(-0x80000000L)) || (*lp > 0x7fffffffL)) {
			return (FALSE);
		}
		else
	...
	u_long *ulp;
{
        ...
        if (xdrs->x_op == XDR_DECODE) {
		u_int local_u_int;
                if (XDR_GETLONG(xdrs, &local_u_int)) {
			/* need to sign extend the 32 bit xdr_int */
			*ulp = (u_long)local_u_int;
			return (TRUE);
		} else
			return (FALSE);
	}
