 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: mkstemp.c,v $ $Revision: 4.2.5.3 $ (DEC) $Date: 1993/09/20 21:54:37 $";
#endif 
/*
 ...
 *
 * 1.3  com/lib/c/env/mkstemp.c, libcenv, bos320, 9137320a 9/6/91 12:36:57
 */

/* name space pollution clean up */
#ifdef _NAME_SPACE_WEAK_STRONG
#include "pollution.h"
#pragma weak mkstemp = __mkstemp
#endif
#include <sys/file.h>
 ...
 *			  file descriptor.
 *
 * NOTES:	Mkstemp expects a string of length at least 6, with
...
/*	id = (pid_t)lib_thread_id(_libc_lock_funcs); */
	...
	for (s0 = LETTERS; *last = *s0; s0++)
		if ((rv = open(template, O_CREAT|O_EXCL|O_RDWR, 0600)) >= 0)
			return (rv);
