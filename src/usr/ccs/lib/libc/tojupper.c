 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: tojupper.c,v $ $Revision: 4.2.5.2 $ (DEC) $Date: 1993/06/07 23:32:54 $";
#endif 
/*
 */
/*
 ...
 */                                                                   
/* tojupper.c	1.1  com/lib/c/gen/KJI,3.1,9021 10/19/89 17:27:35 */
/**********************************************************************/
/*								      */
/* SYNOPSIS							      */
/*	int							      */
...
register c;
{
	if (c < 0x8281 || c > 0x829a)
		/* c is outside the range [a-z] & has no uppercase equivalent */
		return (c);
	return (_tojupper (c));
}
#endif  /* KJI */
