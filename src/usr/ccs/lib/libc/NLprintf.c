 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: NLprintf.c,v $ $Revision: 4.2.4.3 $ (DEC) $Date: 1993/06/08 01:18:09 $";
#endif 
/*
 */
/*
 ...
 *
 * NLprintf.c	1.12  com/lib/c/prnt,3.1,8943 9/7/89 10:03:50
 */
...
#pragma weak NLprintf = __NLprintf
#endif
#endif
#include <stdio.h>
#include <stdarg.h>
