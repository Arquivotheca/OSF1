 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: fgetwc.c,v $ $Revision: 4.2.5.2 $ (DEC) $Date: 1993/06/07 22:51:15 $";
#endif 
/*
 ...
 *
 * fgetwc.c	1.3  com/lib/c/io,3.1,8943 9/12/89 17:48:30
 */
