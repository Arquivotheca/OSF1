 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: ttylock.c,v $ $Revision: 4.2.9.2 $ (DEC) $Date: 1993/06/07 23:41:14 $";
#endif 
/*
 */
/*
...
#pragma weak clrlock = __clrlock
#pragma weak numlocks = __numlocks
#pragma weak putlock = __putlock
#pragma weak tlockf = __tlockf
#pragma weak ttylock = __ttylock
#pragma weak ttylocked = __ttylocked
#pragma weak ttytouchlock = __ttytouchlock
#pragma weak ttyunlock = __ttyunlock
#pragma weak ttywait = __ttywait
#endif
#endif
#include <stdio.h>
#include <string.h>
...
/* #define ASCIILOCKS	Don't use ascii strings to be compatible w/tip */
