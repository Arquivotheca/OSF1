 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: siad_gr_adm.c,v $ $Revision: 1.1.11.3 $ (DEC) $Date: 1993/06/08 01:20:32 $";
#endif
#ifndef lint
static char	*sccsid = "@(#)putgr.c	3.1	(ULTRIX/OSF)	2/26/91";
#endif 
/*
 * *****************************************************************
 * *                                                               *
...
#pragma weak putgr = __putgr
#pragma weak putgrent = __putgrent
#endif
#endif
#include <stdio.h>
#include <sys/stat.h>
...
int
putgrent (struct group *g, FILE *f)
{
	register char	**q;
	char		buf[BUFSIZ+1];
	/*
