 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: iswalpha.c,v $ $Revision: 1.1.6.2 $ (DEC) $Date: 1993/06/07 23:17:36 $";
#endif
/*
...
#pragma weak iswalpha = __iswalpha
#endif
#endif
...
iswalpha(wint_t pc)
{
	if (METHOD(__lc_ctype, iswctype) == NULL)
		return __iswctype_sb(pc, _ISALPHA, __lc_ctype);
	else
		return METHOD(__lc_ctype, iswctype)
			( pc, _ISALPHA, __lc_ctype);
}
