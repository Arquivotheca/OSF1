...
#
#
#	@(#)$RCSfile: machdep.mk,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 03:03:27 $
...
MMAXSOBJS = Ovfork.o __udivsi3.o __umodsi3.o _exit.o _getlogin.o \
	...
	rindex.o rmdir.o sbrk.o select.o semctl.o \
...
crt0.o: crt0.S
	${_CC_} ${_CCFLAGS_} -DDEBUG -D_AIX -c crt0.S
