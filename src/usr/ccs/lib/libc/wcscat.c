 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: wcscat.c,v $ $Revision: 4.2.5.2 $ (DEC) $Date: 1993/06/07 23:58:47 $";
#endif 
/*
 ...
 *
 * wcscat.c	1.3  com/lib/c/nls,3.1,9013 2/27/90 21:41:41
 */
