 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: hsearch.c,v $ $Revision: 4.2.5.3 $ (DEC) $Date: 1993/10/14 15:39:27 $";
#endif 
/*
 * COMPONENT_NAME: (LIBCGEN) Standard C Library General Functions
 *
 * FUNCTIONS: hsearch, hcreate, hdestroy
 *
 *
 ...
 *
 * hsearch.c	1.11  com/lib/c/gen,3.1,8943 10/26/89 14:52:17
 */
/* name space pollution clean up */
#ifdef _NAME_SPACE_WEAK_STRONG
#include "pollution.h"
#if !defined(_THREAD_SAFE)
#pragma weak hcreate = __hcreate
#pragma weak hdestroy = __hdestroy
#pragma weak hsearch = __hsearch
#else
#pragma weak hcreate_r = __hcreate_r
#pragma weak hdestroy_r =  __hdestroy_r
#pragma weak hsearch_r = __hsearch_r
#endif
#endif
#ifdef _NAME_SPACE_WEAK_STRONG
#ifdef table
...
#define	FOUND(x)	(*target = x, (*target) ? 0 : (_Seterrno(ESRCH), -1))
#define	NOSPACE		(_Seterrno(ENOMEM), -1)
