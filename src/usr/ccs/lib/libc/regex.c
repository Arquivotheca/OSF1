 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: regex.c,v $ $Revision: 4.2.5.3 $ (DEC) $Date: 1993/09/23 18:30:09 $";
#endif 
/*
...
#pragma weak re_comp_r = __re_comp_r
#pragma weak re_exec_r = __re_exec_r
#endif
#if !defined(_THREAD_SAFE)
#pragma weak re_comp = __re_comp
#pragma weak re_exec = __re_exec
#endif
#endif
#include <nl_types.h>
#include "libc_msg.h"
...
#ifdef _THREAD_SAFE
char *
re_comp_r(register char *sp, REGEXD *regex_data)
#else
char *
...
#ifdef _THREAD_SAFE
int
re_exec_r(register char *p1, REGEXD *regex_data)
#else
int
