 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: fmtmsg.c,v $ $Revision: 1.1.6.2 $ (DEC) $Date: 1993/06/07 22:52:41 $";
#endif
/*
...
#include "pollution.h"
#pragma weak arg_setup = __arg_setup
#pragma weak fmtmsg = __fmtmsg
#pragma weak formatter = __formatter
#pragma weak isaverb = __isaverb
#pragma weak label_ok = __label_ok
#pragma weak severity_lookup = __severity_lookup
#endif
#include <sys/types.h>
#include <sys/stat.h>
#include <stdlib.h>
