 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: __strcoll_std.c,v $ $Revision: 1.1.5.4 $ (DEC) $Date: 1993/11/23 21:33:24 $";
#endif
/*
 ...
 *
 * 1.5  com/lib/c/str/__strcoll_std.c, libcstr, bos320, 9140320 9/24/91 15:45:44
 */
...
int
__strcoll_std(const char *str1, const char *str2, _LC_collate_t *hdl)
{
	...
	**********/
        ...
        **********/
        if (sort_mod == 0) {
            rc = __char_collate_std(hdl, str1_ptr, str2_ptr);
            (void)free(str1_rep);
            (void)free(str2_rep);
            return(rc);
    }
        ...
        **********/
	    ...
	    if (sort_mod & _COLL_POSITION_MASK)
	    	rc = __back_pos_collate_std(hdl, str1_ptr, str2_ptr, cur_order);
	    else
	    	rc = __backward_collate_std(hdl, str1_ptr, str2_ptr, cur_order);
	}
        ...
        **********/
	    ...
	    if (sort_mod & _COLL_POSITION_MASK)
	    	rc = __forw_pos_collate_std(hdl, str1_ptr, str2_ptr, cur_order);
	    else
	    	rc = __forward_collate_std(hdl, str1_ptr, str2_ptr, cur_order);
	}
