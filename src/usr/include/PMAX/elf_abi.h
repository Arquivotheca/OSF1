 ...
 */
/*
 *       @(#)$RCSfile: elf_abi.h,v $ $Revision: 4.2.4.3 $ (DEC) $Date: 1992/04/15 11:12:16 $
 */
/*
 * |-----------------------------------------------------------|
 ...
 * |-----------------------------------------------------------|
 */
/* $Header: /usr/sde/alpha/rcs/alpha/src/./usr/include/PMAX/elf_abi.h,v 4.2.4.3 1992/04/15 11:12:16 Al_Delorey Exp $ */
#ifndef _ELF_ABI_H_
#define _ELF_ABI_H_
