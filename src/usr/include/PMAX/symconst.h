 ...
 */
/*
 *       @(#)$RCSfile: symconst.h,v $ $Revision: 4.2.4.3 $ (DEC) $Date: 1992/06/04 12:18:11 $
 */
/*
 * |-----------------------------------------------------------|
 ...
 * |-----------------------------------------------------------|
 */
/* $Header: /usr/sde/alpha/rcs/alpha/src/./usr/include/PMAX/symconst.h,v 4.2.4.3 1992/06/04 12:18:11 Al_Delorey Exp $ */
