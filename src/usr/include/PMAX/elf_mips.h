 ...
 */
/*
 *       @(#)$RCSfile: elf_mips.h,v $ $Revision: 4.2.4.3 $ (DEC) $Date: 1992/04/15 08:03:43 $
 */
/*
 * |-----------------------------------------------------------|
 ...
 * |-----------------------------------------------------------|
 */
/* $Header: /usr/sde/alpha/rcs/alpha/src/./usr/include/PMAX/elf_mips.h,v 4.2.4.3 1992/04/15 08:03:43 Al_Delorey Exp $ */
#ifndef _ELF_MIPS_H_
#define _ELF_MIPS_H_
