 ...
 */
/*
 *       @(#)$RCSfile: obj.h,v $ $Revision: 4.2.4.2 $ (DEC) $Date: 1992/01/28 20:00:20 $
 */
/* $Copyright: |
 * |-----------------------------------------------------------|
 ...
 * |-----------------------------------------------------------|
 * $ */
/* $Header: /usr/sde/alpha/rcs/alpha/src/./usr/include/PMAX/obj.h,v 4.2.4.2 1992/01/28 20:00:20 Al_Delorey Exp $ */
...
#define section_vaddr(obj, psection) (psection->s_vaddr)
#define section_size(obj, psection) (psection->s_size)
#define section_name(obj, psection) (psection->s_name)
