 ...
 */
/*
 *       @(#)$RCSfile: disassembler.h,v $ $Revision: 4.2.4.2 $ (DEC) $Date: 1992/01/28 17:31:57 $
 */
/*
 * |-----------------------------------------------------------|
 ...
 * |-----------------------------------------------------------|
 */
/* $Header: /usr/sde/alpha/rcs/alpha/src/./usr/include/PMAX/disassembler.h,v 4.2.4.2 1992/01/28 17:31:57 Al_Delorey Exp $ */
