 ...
 */
/*	
 *	@(#)$RCSfile: mon.h,v $ $Revision: 4.2.9.2 $ (DEC) $Date: 1993/12/15 22:13:39 $
 */ 
/*
...
#ifndef _MON_H_
#define _MON_H_
#include <mach_o_types.h> /* fii define caddr_t et al */
/*
...
#ifndef _NO_PROTO
int moncontrol( int); /* returns previous value of mode */
/*
...
#ifndef _NO_PROTO
int monitor(
        caddr_t,  	/* low address of single range to profile */
        ...
        );              /* returns 0 if profiling started, -1 if not - err */
/* Note:
