 ...
 */
/*	
 *	@(#)$RCSfile: mach_o_header_md.h,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 05:04:50 $
 */ 
/*
 */
/*
 ...
 *
 * Version for the Intel 302 (AT386)
 *
...
*/
/* For the I386, all the field sizes can be represented in normal C,
