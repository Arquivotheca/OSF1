 ...
 * |-----------------------------------------------------------|
 */
/* $Header: /usr/sde/osf1/rcs/os/src/usr/include/cmplrs/binasm.h,v 4.2.8.6 1993/11/15 14:32:11 Ken_Lesniak Exp $ */
...
#if __alpha || __mips64
  bin_rec_len = 24;	{24 bytes per record}
#else
...
{ assembly macros for mips3 1/11/91 }
  ...
  binasm = packed record
	...
	fill0a : 0..511;		{ 9 bits to word boundary	      }
	case instr : itype of 	{ 7 bits			      }
	    ierr, idead : ();		{ ????? 			      }
...
#if __alpha || __mips64
	    ialign, iascii, iasciiz, icomm, ilcomm, isym, idfloat,
