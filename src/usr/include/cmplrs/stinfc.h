 ...
 * |-----------------------------------------------------------|
 */
/* $Header: /usr/sde/alpha/rcs/alpha/src/./usr/include/cmplrs/stinfc.h,v 4.2.4.2 1992/04/30 15:59:33 Ken_Lesniak Exp $ */
/*
...
function st_sym_idn(			{ get string from idn		      }
	...
	var sc : integer;		{ returned: sc field of sym	      }
	var st : integer;		{ returned: st field of sym	      }
	var value : integer64;		{ returned: value field of sym	      }
	var index : integer)		{ returned: index field of sym	      }
