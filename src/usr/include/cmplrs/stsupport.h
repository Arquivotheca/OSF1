 ...
 * |-----------------------------------------------------------|
 */
/* $Header: /usr/sde/alpha/rcs/alpha/src/./usr/include/cmplrs/stsupport.h,v 4.2.5.5 1993/01/12 22:50:08 Mark_Himelstein Exp $ */
/*
...
#define ST_FCOMPLEXBT(bt) ((bt == btStruct) || (bt == btUnion) || (bt == btTypedef) || (bt == btEnum) || (bt == btClass))
#define valueNil	0
#define export
