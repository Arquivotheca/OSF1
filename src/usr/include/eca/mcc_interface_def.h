 ...
 */
/*
 * @(#)$RCSfile: mcc_interface_def.h,v $ $Revision: 1.1.2.2 $ (DEC) $Date: 1993/04/26 21:01:22 $
 */
...
typedef unsigned long int MCC_T_EntityClass [10];
...
typedef unsigned long int MCC_T_ONCE [4];
...
typedef unsigned long int MCC_T_AttribIdentifier [11];
typedef struct _MCC_T_Time24 {
    unsigned char tm24_b_hour;
    unsigned char tm24_b_minute;
    } MCC_T_Time24;
typedef unsigned long int MCC_T_UsageState;
typedef unsigned long int MCC_T_AdminState;
typedef unsigned long int MCC_T_OperState;
...
typedef unsigned long int *MCC_A_HANDLE;
typedef unsigned long int *MCC_A_AES;
typedef unsigned long int *MCC_A_TIMEFRAME;
typedef unsigned char MCC_T_ILV;
typedef unsigned char MCC_T_ASN;
typedef unsigned long int MCC_T_IDCode;
typedef unsigned long int MCC_T_CVR;
typedef unsigned long int MCC_T_UNSLONG;
typedef unsigned short int MCC_T_UNSSHORT;
typedef long int MCC_T_LONG;
typedef long int MCC_T_INT;
...
#define MCC_K_OSE_TEXT_MAX 256
typedef struct _MCC_T_OSError {
    MCC_T_Enumeration ose_l_type;
    MCC_T_Unsigned32 ose_l_code;
    char ose_t_text [256];
    } MCC_T_OSError;
typedef struct _MCC_R_Reply_List {
    ...
    MCC_T_CVR *rpl_A_CVR;
    unsigned long int *rpl_A_Directive;
...
typedef struct _MCC_T_Descriptor {
    ...
    unsigned long int mcc_l_id;
    unsigned long int mcc_l_dt;
...
#define MCC_K_CLASS_GENERAL 16382
...
#define MCC_K_DD_GENERIC_PRESENTATION 33
...
#define MCC_K_HANDLE_MORE_UNKNOWN 0
#define MCC_K_HANDLE_MORE_SCHED 1
...
#define MCC_K_OS_ULTRIX 1
#define MCC_K_OS_VMS 2
#define MCC_K_OS_SYSVR3 3
#define MCC_K_OS_SYSVR4 4
#define MCC_K_OS_OS2 5
#define MCC_K_OS_MSDOS 6
#define MCC_K_OS_OSF1 7
#define MCC_K_OS_BSDUNIX 8
#define MCC_K_OS_NT 9
#define MCC_K_OS_SUNOS 10
#define MCC_K_OS_IBM 11
...
#define MCC_K_ASN_DT_ENUMERATED 10
#define MCC_K_ASN_DT_NUMERICSTRING 18
#define MCC_K_ASN_DT_PRINTABLESTRING 19
#define MCC_K_ASN_DT_GENERALIZEDTIME 24
#define MCC_K_ASN_DT_GRAPHICSTRING 25
#define MCC_K_ASN_DT_SEQUENCE 48
#define MCC_K_ASN_DT_SET 49
struct MCC_R_DB_RCODE {
    long int rcode_l_sts;
    long int rcode_l_stv;
    } ;
...
struct MCC_R_DSPTBLENT {
    ...
    unsigned long int dte_l_class_flags;
    unsigned long int dte_l_classcode;
    unsigned long int dte_l_instance_flags;
    MCC_T_Descriptor dte_r_instance;
    } ;
#define MCC_K_DSP_ENT_SIZE 42
