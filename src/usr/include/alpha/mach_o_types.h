...
typedef unsigned int		mo_long_t;	/* whole word (32 bits) */
...
typedef   unsigned int		mo_cpu_type_t;
typedef   unsigned int		mo_cpu_subtype_t;
typedef   unsigned int		mo_vendor_type_t;
