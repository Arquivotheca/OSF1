 ...
 */
/*	
 *	@(#)$RCSfile: mach_o_types.h,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 05:05:40 $
 */ 
/*
 */
/*
 ...
 * 
 * Version for the Multimax (NS32K), in the MMAX directory.
 *
...
/* tentative definitions of region usage types for the N32K */
 ...
 * These were cloned from reloc.h on the Multimax for the initial
 * MMAX revision.
 */
...
#define OUR_CPU_TYPE		MO_CPU_TYPE_NS32000

/* definition for the value of the mo_header_t.moh_cpu_subtype field
 * that is used on this machine
 */

#define OUR_CPU_SUBTYPE		MO_CPU_SUBTYPE_MMAX
