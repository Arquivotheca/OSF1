 ...
 */
/*	
 *	@(#)$RCSfile: mach_o_header_md.h,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 05:05:37 $
 */ 
/*
 */
/*
 ...
 *
 * Version for the Multimax (N32K), in the MMAX directory.
 *
 ...
 * should have its own definition of the value in case the files get out
 * of synch.
 */
