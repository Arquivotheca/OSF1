...
"*   Software   Foundation,  Inc.,  and  Bell  Laboratories.   Use,	*
"*   duplication, or disclosure is subject  to  restrictions  under	*
"*   license  agreements  with  the Open Software Foundation, Inc.,	*
"*   and AT&T.								*
"*									*
"************************************************************************
"
...
v/^#/s/%+\([^%]\)/%p2%'\1'%+%c/
$g/^# junk$/d
" handle pads (convert to $<num> format)
g/=\([0-9][0-9]*\**\)\([^,]*\)/s//=\2\$<\1>/g
w
q
