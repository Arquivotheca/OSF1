 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: tabln03.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 06:53:53 $";
#endif
/************************************************************************
 *									*
 *   Copyright (c) Digital Equipment Corporation, 1984, 1990, 1991	*
 *									*
