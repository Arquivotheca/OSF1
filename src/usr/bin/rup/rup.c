 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rup.c,v $ $Revision: 1.1.2.2 $ (DEC) $Date: 1993/05/26 17:44:17 $";
#endif
	...
	char **argv;
{
	...
	clnt_broadcast(RSTATPROG, RSTATVERS_SWTCH, RSTATPROC_STATS,
