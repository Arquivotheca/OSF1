...
static char rcsid[] = "@(#)$RCSfile: ntab.c,v $ $Revision: 4.2.4.3 $ (DEC) $Date: 1993/10/14 04:18:03 $";
#endif
/*
 * HISTORY
 */
 ...
 *
 * 001 21-May-91	gws
 *	this came from usr/local/nosupport/nroff ntab.c -r3.1
