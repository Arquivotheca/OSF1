 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: builtin.c,v $ $Revision: 1.1.8.4 $ (DEC) $Date: 1993/07/08 17:23:08 $";
#endif
...
#else	/* not HAVE_RANDOM */
#ifdef HAVE_LRAND48
#define	srandom(seed)	srand48((seed))
#define	random()	lrand48()
#define	initstate(seed, state, n)	1
#define	setstate(state)	1
#endif	/* HAVE LRAND48 */
