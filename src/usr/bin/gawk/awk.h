 ...
 */
/*
 * @(#)$RCSfile: awk.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/05/25 20:06:19 $
 */
...
#ifdef HAVE_BCOPY
#define memcpy(s, d, n)	bcopy((d), (s), (n))
...
#ifdef HAVE__SETJMP
/* these versions, if present,  avoid saving and restoring the signal mask */
...
#define	tree_eval(t)	(_t = (t),(_t) == NULL ? Nnull_string : \
			...
			(stack_ptr[(_t)->param_cnt]) == NULL ? Nnull_string : \
...
#define	STREQN(a,b,n)	((n)&& *(a)== *(b) && strncmp((a), (b), (size_t) (n)) == 0)
