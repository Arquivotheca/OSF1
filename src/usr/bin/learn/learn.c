 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: learn.c,v $ $Revision: 4.2.5.2 $ (DEC) $Date: 1993/10/11 17:18:51 $";
#endif 
/*
 */
/*
 ...
 *
 * learn.c	1.3  com/cmd/man/learn,3.1,9021 11/28/89 12:56:10
 */
...
char	*dname	= "/usr/lib/learn";	/* CHANGE THIS ON YOUR SYSTEM */
int	more;
char	*level;
int	speed;
char	*sname;
