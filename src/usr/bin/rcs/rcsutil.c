 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rcsutil.c,v $ $Revision: 1.1.8.2 $ (DEC) $Date: 1993/08/02 22:40:38 $";
#endif
/*
 *                     RCS utilities
 */
...
libId(utilId, "@(#)$RCSfile: rcsutil.c,v $ $Revision: 1.1.8.2 $ (DEC) $Date: 1993/08/02 22:40:38 $")
...
static sig_atomic_t heldsignal, holdlevel;
