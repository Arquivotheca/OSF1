 ...
 */
/*
 * @(#)$RCSfile: conf.h,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1993/05/28 01:49:12 $
 */

/* RCS compile-time configuration */

	/* $Id: conf.h,v 1.1.4.3 1993/05/28 01:49:12 Anthony_Hoffman Exp $ */
...
#define has_seteuid 1 /* Does seteuid() work?  See README.  */
...
#define DIFF "/usr/lbin/diff" /* name of 'diff' program */
#define DIFF3 "/usr/lbin/diff3" /* name of 'diff3' program */
/* #define DIFF3 "/usr/lbin/diff3prog" /* name of 'diff3' program */
...
/************************************************************************
 *									*
 * These definitions are not necessary for DEC OSF/1, and if declared,	*
 * caused compilation errors with -std1 (POSIX ANSI C standard) option,	*
 * I've just conditionalized this out, so it remains as a reference.	*
 *									*
 ************************************************************************/
#ifdef notdef
...
/*
 * Definitions necessary to build properly on DEC/OSF.
 */
#ifndef O_BINARY /* some non-Posix hosts need O_BINARY */
#	define O_BINARY 0 /* no effect on Posix */
#endif
