 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rcsclean.c,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1993/05/28 02:16:16 $";
#endif
...
mainProg(rcscleanId, "rcsclean", "$Id: rcsclean.c,v 1.1.4.3 1993/05/28 02:16:16 Anthony_Hoffman Exp $")
{
