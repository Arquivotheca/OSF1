 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rcsfcmp.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:38 $";
#endif
/*
 *                     RCS file comparison
 */
...
libId(fcmpId, "@(#)$RCSfile: rcsfcmp.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:38 $")
