 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: ident.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:38:51 $";
#endif
...
mainProg(identId, "ident", "@(#)$RCSfile: ident.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:38:51 $")
