 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: diff3.c,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1993/05/27 21:00:17 $";
#endif
 ...
 *
 * November 12, 1992 by Robin T. Miller
 *	Changed return types for pid from int to pid_t.
 */

