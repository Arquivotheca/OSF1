 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: merger.c,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1993/05/28 02:04:41 $";
#endif
...
libId(mergerId, "$Id: merger.c,v 1.1.4.3 1993/05/28 02:04:41 Anthony_Hoffman Exp $")
