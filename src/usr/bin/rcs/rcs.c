 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rcs.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:14 $";
#endif
/*
...
mainProg(rcsId, "rcs", "@(#)$RCSfile: rcs.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:14 $")
{
