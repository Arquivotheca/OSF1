 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rcsmap.c,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1993/05/28 02:42:22 $";
#endif
...
libId(mapId, "$Id: rcsmap.c,v 1.1.4.3 1993/05/28 02:42:22 Anthony_Hoffman Exp $")
