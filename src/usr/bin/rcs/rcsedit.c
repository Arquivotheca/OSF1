 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rcsedit.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:33 $";
#endif
/*
 *                     RCS stream editor
 */
...
libId(editId, "@(#)$RCSfile: rcsedit.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:33 $")
