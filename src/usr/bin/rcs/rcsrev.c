 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rcsrev.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:40:24 $";
#endif
/*
...
libId(revId, "@(#)$RCSfile: rcsrev.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:40:24 $")
