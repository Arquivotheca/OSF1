 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rcsgen.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:51 $";
#endif
/*
...
libId(genId, "@(#)$RCSfile: rcsgen.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:51 $")
