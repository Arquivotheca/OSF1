 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: ci.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:38:40 $";
#endif
...
mainProg(ciId, "ci", "@(#)$RCSfile: ci.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:38:40 $")
{
