 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: merge.c,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1993/05/28 02:00:16 $";
#endif
...
mainProg(mergeId, "merge", "$Id: merge.c,v 1.1.4.3 1993/05/28 02:00:16 Anthony_Hoffman Exp $")
{
