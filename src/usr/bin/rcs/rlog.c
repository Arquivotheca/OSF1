 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rlog.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:40:44 $";
#endif
/*
 *                       RLOG    operation
 */
...
mainProg(rlogId, "rlog", "@(#)$RCSfile: rlog.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:40:44 $")
{
