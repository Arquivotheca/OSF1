 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rcsdiff.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:27 $";
#endif
/*
...
mainProg(rcsdiffId, "rcsdiff", "@(#)$RCSfile: rcsdiff.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:27 $")
{
