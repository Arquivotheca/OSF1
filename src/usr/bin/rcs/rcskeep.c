 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rcskeep.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:57 $";
#endif
/*
...
libId(keepId, "@(#)$RCSfile: rcskeep.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:57 $")
