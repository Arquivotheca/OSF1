 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: partime.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:06 $";
#endif
/*
...
libId(partId, "@(#)$RCSfile: partime.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:06 $")
