 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rcsfnms.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:44 $";
#endif
/*
...
libId(fnmsId, "@(#)$RCSfile: rcsfnms.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:44 $")
