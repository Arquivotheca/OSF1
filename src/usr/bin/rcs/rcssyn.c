 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rcssyn.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:40:31 $";
#endif
/*
 *                     RCS file input
 */
...
libId(synId, "@(#)$RCSfile: rcssyn.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:40:31 $")
