 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rcsmerge.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:40:18 $";
#endif
/*
 *                       rcsmerge operation
 */
...
mainProg(rcsmergeId, "rcsmerge", "@(#)$RCSfile: rcsmerge.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:40:18 $")
{
