 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rcskeys.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:40:07 $";
#endif
/*
...
libId(keysId, "@(#)$RCSfile: rcskeys.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:40:07 $")
