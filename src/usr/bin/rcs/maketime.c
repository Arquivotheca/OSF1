 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: maketime.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:00 $";
#endif
#
/*
...
libId(maketId, "@(#)$RCSfile: maketime.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/08/02 22:39:00 $")
