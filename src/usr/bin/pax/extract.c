...
static char rcsid[] = "@(#)$RCSfile: extract.c,v $ $Revision: 1.1.5.2 $ (DEC) $Date: 1993/06/10 19:42:55 $";
#endif
/*
 * HISTORY
 */
...

{
    ...
    if ((namesize = SWAB(binary.b_name)) == 0 || namesize >= PATH_MAX+1) {
...

{
    ...
    if (binary.b_name == 0 || binary.b_name >= PATH_MAX+1) {
