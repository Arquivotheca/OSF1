...
static char rcsid[] = "@(#)$RCSfile: ttyio.c,v $ $Revision: 1.1.5.2 $ (DEC) $Date: 1993/06/10 20:39:40 $";
#endif
/*
 * HISTORY
 */
...

{
    ...
    if (ttyf < 0) {
	fatal(MSGSTR(TTY_UNVAIL, "/dev/tty Unavailable"));
    }
