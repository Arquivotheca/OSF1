 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: main.c,v $ $Revision: 4.2.5.2 $ (DEC) $Date: 1993/10/11 17:07:58 $";
#endif 
/*
 */
/*
	...
	char *argv[];
{
	...
	setlocale(LC_ALL,"");
	catd = NLcatopen (MF_FTP, NL_CAT_LOCALE);
