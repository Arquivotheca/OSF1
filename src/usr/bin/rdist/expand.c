 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: expand.c,v $ $Revision: 4.2.3.2 $ (DEC) $Date: 1992/10/07 15:44:32 $";
#endif 
/*
 */
/*
 ...
 * 
 * expand.c	1.5  com/cmd/arch/rdist,3.1,9013 12/21/89 14:48:30
 */
			...
			*cp1 = '\0';
			if (pw == NULL || strcmp(pw->pw_name, buf+1) != 0) {
				if ((pw = getpwnam(buf+1)) == NULL) {
					strcat(buf, MSGSTR(USERUNK, ": unknown user name"));
					yyerror(buf+1);
					return;
				}
			}
