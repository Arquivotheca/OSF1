 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: svt6.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 01:34:53 $";
#endif 
/*
 */
/*
 ...
 *
 * 001 21-May-91	gws
 *	this came from usr/local/nosupport/troff svt6.c -r3.1
...
extern int ch0;
extern int lg;
char fontf[NS] = "/usr/share/lib/font/ftXX";;
char *fontfile = fontf;
int ffi = 0;
extern int bd;
extern int level;
