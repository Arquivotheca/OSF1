 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: t10.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 01:34:56 $";
#endif 
/*
 */
/*
 ...
 *
 * 001 21-May-91	gws
 *	this came from usr/local/nosupport/troff t10.c -r3.1
