 ...
 */
/*
static char rcsid[] = "@(#)$RCSfile: ltfdefs.h,v $ $Revision: 4.2.6.3 $ (DEC) $Date: 1993/08/03 10:27:13 $";
 */
/*
 * HISTORY
 */
 ...
 *			Add Outbuf as a global variable to
 *			make its on a word boundary
 *	
 */
/**/
/*	-----------------
...
#define MSGSTR(num,str) catgets(catd,MS_LTF,num,str)
#ifdef debug
#include	"mtio.h"	/* NOTE: mtio.h depends on types.h */
#include	"devio.h"
#include	"ioctl.h"
#endif
...
extern	int	isdir;		/* Flag argument to scantape */
...
extern	nl_catd	catd;		/* Message Catalog */
extern	int	numdir;		/* Number of directories in chdir */

/*_O_c_*/
extern	char	Outbuf[MAXBLKWRT+1];   /* Output buffer for writes */
