 ...
 * HISTORY
 */
/* @(#)$RCSfile: parms.h,v $ $Revision: 4.2.5.2 $ (DEC) $Date: 1993/09/07 16:06:57 $ */
/* parms.h	1.6  com/cmd/uucp,3.1,9013 11/29/89 13:33:02 */
/* 
 * COMPONENT_NAME: UUCP parms.h
 * 
 * FUNCTIONS: GRPCHK 
 *
 *
...
/* static char sccsid[] = "parms.h	5.3 -  - "; */
/*	parms.h	1.20	*/
#ifndef lint
static	char	h_parms[] = "parms.h	1.20";
#endif

/* go through this carefully, configuring for your site */

/* One of the following three lines should not be commented out.
 * The other two should be unless you are running a unique hybrid.
 */
...
#define TCP		/* TCP (aix r5 and bsd systems) */
#ifdef TCP
#define BSDTCP
#endif
...
/* #define PATH	"PATH=/bin:/usr/bin:/usr/lbin/uucp "  */
...
/*
** usually this will be 60 or 100
*/
 ...
 */
#define NOSTRANGERS	"/usr/lbin/uucp/remote.unknown"	/* */
...
/* Only one of "ETCLOCKS" and "USRSPOOLLOCKS" should be defined.
 *
...
/* #define ETCLOCKS   define to use /etc/locks for LCK and device lock files */
