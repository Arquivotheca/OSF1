...
static char rcsid[] = "@(#)$RCSfile: logent.c,v $ $Revision: 4.3.5.2 $ (DEC) $Date: 1993/09/07 16:06:33 $";
#endif
/* 
 * COMPONENT_NAME: UUCP logent.c
 * 
 * FUNCTIONS: closelog, logent, millitick, syslog 
 *
 *
...
/*
 *	1.5  /com/cmd/uucp/logent.c, bos320 6/15/90 23:59:53";	
 */
#include "uucp.h"
