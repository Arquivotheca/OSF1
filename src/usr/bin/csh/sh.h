 ...
 */
/*
static char rcsid[] = "@(#)$RCSfile: sh.h,v $ $Revision: 4.2.11.6 $ (DEC) $Date: 1993/12/17 19:52:15 $";
 */
/*
 * HISTORY
 */
 ...
 *
 *
 *	1.18  com/cmd/csh/sh.h, 9123320, bos320 5/20/91 12:49:01	
 *
 *
...
#define MAX_RECURSION  (32*(sizeof(int))) /* CMR002 limit recursion to  */
					  /* CMR002 prevent core dumps   */
#ifndef _SBCS
#define NLQUOTE 0200    /* CMR001 this was \177 ,QAR 12931 , C.Richmond*/
#else
#define NLQUOTE '\177'
#endif
#define ALIASCHR '\002'
...
extern long			exp(uchar_t ***);                /* 002 */
extern long			exp0(uchar_t ***, bool);         /* 002 */
extern long			exp1(uchar_t ***, bool);         /* 002 */
extern long			exp2(uchar_t ***, bool);         /* 002 */
extern long			exp2a(uchar_t ***, bool);        /* 002 */
extern long			exp2b(uchar_t ***, bool);        /* 002 */
extern long			exp2c(uchar_t ***, bool);        /* 002 */
...
extern long			isa(uchar_t *, int);             /* 002 */
extern long			egetn(uchar_t *);                /* 002 */
...
extern void			unsetcenv(uchar_t *);
extern void			doumask(uchar_t **);
extern struct limits *		findlim(uchar_t *);
extern void			dolimit(uchar_t **);
extern long			getval(struct limits *, uchar_t **);
extern void			limtail(uchar_t *, uchar_t *);
extern void			plim(struct limits *, uchar_t);
extern void			dounlimit(register uchar_t **);
extern int			setlim(struct limits *, uchar_t, long); /* WW-01 */
extern void			dosuspend(void);
extern void			doeval(uchar_t **);
extern void			dowhich(uchar_t **);	/* 001 RNF */
extern int			executable(register char *);    /* 001 RNF */
...
#else
#define letter(c) (isalpha((uchar_t)(c)) || (uchar_t)(c) == '_')
#define digit(c)  ((uchar_t)(c) >= '0') && ((uchar_t)(c) <= '9')
extern int	  alum(uchar_t);
#endif
...
extern struct varent *		getvx(uchar_t *, int);
...
extern uchar_t *		putn(long);                        /* 002 */
extern void			putn1(long);                       /* 002 */
extern long			getn(uchar_t *);                   /* 002 */
extern uchar_t *		value(uchar_t *);
extern uchar_t *		value1(uchar_t *, struct varent *);
extern struct varent *		adrof(uchar_t *);
extern struct varent *		madrof(uchar_t *, struct varent *);
extern struct varent *		adrof1(uchar_t *, struct varent *);
extern void			set(uchar_t *, uchar_t *);
extern void			set1(uchar_t *, uchar_t **, struct varent *);
extern void			setq(uchar_t *, uchar_t **, struct varent *);
extern void			unset(uchar_t *[]);
extern void			unset1(uchar_t *[], struct varent *);
extern void			unsetv(uchar_t *);
extern void			unsetv1(uchar_t *, struct varent *);
...
extern void			srccat(uchar_t *, uchar_t *, int);
...
extern int			ed_tenex (uchar_t *, int);
extern void			SaveMacros (void);
extern int			dobindings (uchar_t *);
extern void			dobind (uchar_t **);
extern uchar_t *		folddown (uchar_t *, uchar_t *);
extern int			stablk (uchar_t *, uchar_t **);
#endif
