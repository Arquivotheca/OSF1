...
static char rcsid[] = "@(#)$RCSfile: biz31.c,v $ $Revision: 4.2.5.2 $ (DEC) $Date: 1993/09/07 15:07:32 $";
#endif
/* biz31.c	1.2  com/cmd/tip/aculib,3.1,9013 10/17/89 16:56:12"; */
/* 
