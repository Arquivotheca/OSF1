...
static char rcsid[] = "@(#)$RCSfile: tset.c,v $ $Revision: 4.2.8.3 $ (DEC) $Date: 1993/10/11 19:26:11 $";
#endif
/*
 * HISTORY
 */
 ...
 *
 * tset.c	1.3  com/cmd/tty/tset,3.1,9021 5/18/90 18:28:15
 */
...
**		-n --   ** This flag has been removed. **
**                      If the new tty driver from UCB is available, this flag
...
**		-h -- ** This flag has been removed. **
**                      don't read htmp file.  Normally the terminal type
...
**		-u -- ** This flag has been removed. **
**                      don't update htmp.  It seemed like this should
...
**			strings).
**		-v -- ** This flag has been removed. **
**                      On virtual terminal systems, don't set up a
...
# define	CHK(val, dft)	((val == 0 || val == (unsigned char)0xFF) ? dft : val)
...
# define	USAGE	MSGSTR(USE2, "usage: tset [-] [-rsIQS] [-eC] [-kC] [-iC] [-m [ident][test speed]:type] [type]\n")
