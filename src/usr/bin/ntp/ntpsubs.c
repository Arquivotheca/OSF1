 ...
 */
#ifndef lint
static char     *sccsid = "@(#)$RCSfile: ntpsubs.c,v $ $Revision: 4.2.2.2 $ (DEC) $Date: 1992/05/04 12:29:17 $";
#endif
/*
 */

/*
 *  	Previous History		ntpsubs.c,v $
 * Revision 4.1  91/09/18  21:51:20  devrcs
 * Start of AG pool
 * 
 * Revision 3.1  91/06/24  15:08:59  devbld
...
tstamp(stampp, tvp)
	...
	struct timeval *tvp;
{
	stampp->int_part = ntohl((u_int) (JAN_1970 + tvp->tv_sec));
	stampp->fraction = ntohl((u_int) ((float) tvp->tv_usec * 4294.967295));
}
#endif
