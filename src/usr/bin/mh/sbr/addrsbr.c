...
#ifndef	lint
static char ident[] = "@(#)$RCSfile: addrsbr.c,v $ $Revision: 4.2.3.2 $ (DEC) $Date: 1992/04/15 10:40:11 $ devrcs Exp Locker: devbld $";
#endif	lint
...
#define EOA	(4<<8)	/* end of address */
	...
	*adrcopy++ = c;
	if (state != COM)
/* PJS: Why lower-case the address???
...
#ifdef X400
    if (need_x400_me == 1 && uleq(cp, mq.m_mbox))
	return 1;
#endif X400
