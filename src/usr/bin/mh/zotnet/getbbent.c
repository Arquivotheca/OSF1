...
#ifndef	lint
static char ident[] = "@(#)$RCSfile: getbbent.c,v $ $Revision: 4.2.5.2 $ (DEC) $Date: 1993/12/21 21:40:03 $ devrcs Exp Locker: devbld $";
#endif	lint
...
/* bb_name:bb_aka's:bb_file:bb_passwd:bb_leader's:bb_addr:bb_request:bb_relay:bb_dists:bb_flags */
