...
#ifdef	X400
#define	X400UID	"x400"		/* name in /etc/passwd */
#define	X400DB	"X400"		/* file in X400UID's home directory */
#define	X400MODE	0600		/* default X400 subscriber maildrop mode */
/* #define	POMODE	0600		/* default X400 subscriber maildrop mode */
#endif	POP
