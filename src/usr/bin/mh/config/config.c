...
#define	binpath(file) "/usr/bin/mh/"#file
...
char *options[] = {"SYS5DIR", "_BSD", "ISI", "MHRC", "WHATNOW", "MHE", "BSD42", "BERK", "BSD43", "LOCKF", "NETWORK", "BIND", "RPATHS", "DPOP", "RPOP", "UK", "FOLDPROT='\"0700\"'", "MSGPROT='\"0600\"'", "TYPESIG='void'", "POPSERVICE='\"pop\"'", "SPRINTF='int'", "SENDMTS", "SMTP", "POP", "X400", NULL};
