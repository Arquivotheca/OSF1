...
#ifndef	lint
static char ident[] = "@(#)$RCSfile: vmh.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 01:39:30 $ devrcs Exp Locker: devbld $";
#endif	lint
#ifdef	SYS5
/*
...
char   *tgoto ();
					...
					/* SIGNALS */
static void     ALRMser (), PIPEser (), SIGser ();
#ifdef	SIGTSTP
static void  TSTPser ();
#endif	SIGTSTP
