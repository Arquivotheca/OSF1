...
#ifndef	lint
static char ident[] = "@(#)$RCSfile: msh.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 01:37:52 $ devrcs Exp Locker: devbld $";
#endif	lint
...
static void	intrser (), pipeser (), quitser ();
...
static  quit () {
    ...
    if (mhrename (tmpfil, mp -> foldpath) == NOTOK)
