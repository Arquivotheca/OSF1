...
#ifndef	lint
static char ident[] = "@(#)$RCSfile: replsbr.c,v $ $Revision: 4.2.5.2 $ (DEC) $Date: 1993/08/03 19:27:23 $ devrcs Exp Locker: devbld $";
#endif	lint
	      ...
	      *out;
{
    ...
    /*	XPG4  Must fflush to ensure that rewind actually resets
