...
#ifndef	lint
static char ident[] = "@(#)$RCSfile: sortm.c,v $ $Revision: 4.2.2.2 $ (DEC) $Date: 1992/12/09 07:55:10 $ devrcs Exp Locker: devbld $";
#endif	lint
