...
#ifndef	lint
static char ident[] = "@(#)$RCSfile: forw.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 01:37:32 $ devrcs Exp Locker: devbld $";
#endif	lint
...
#ifdef X400
#define TMPLTSW 23
    "template", 0,		/* interface to X.400: NB Number 23! */
#endif X400
...
/* PJS: Let 'template' default the editor...
	if (ted == (char *)NULL)
	    ted = getcpy("prompter");
 */
