...
#ifndef	lint
static char ident[] = "@(#)$RCSfile: distsbr.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 01:37:20 $ devrcs Exp Locker: devbld $";
#endif	lint
       ...
       *backup;
{
    ...
    if (mhrename (drft, strcpy (backup, m_backup (drft))) == NOTOK)
