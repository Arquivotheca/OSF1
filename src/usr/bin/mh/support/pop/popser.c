...
#ifndef	lint
static char ident[]="@(#)$RCSfile: popser.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 01:40:14 $ devrcs Exp Locker: devbld $";
#endif
...
/* PJS: Test for MMDF delimiters as well... */
	if (strcmp(buffer, mmdlm1) == 0 || strcmp(buffer, mmdlm2) == 0)
		return(1);
