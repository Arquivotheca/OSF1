...
#ifndef	lint
static char ident[] = "@(#)$RCSfile: popd.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 01:40:07 $ devrcs Exp Locker: devbld $";
#endif	lint
...
struct sockaddr_in *sin;
{
    ...
    addr = &sin -> sin_addr;
    hp = gethostbyaddr ((const char*)addr, sizeof *addr, sin -> sin_family); /*GAG 001*/
