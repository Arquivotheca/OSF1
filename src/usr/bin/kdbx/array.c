 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: array.c,v $ $Revision: 1.1.3.3 $ (DEC) $Date: 1992/11/05 17:47:01 $";
#endif
/*LINTLIBRARY*/

#ifndef lint
static  char    *sccsid = "@(#)array.c	1.4  (ULTRIX)        12/12/90";
#endif lint
...
unsigned int size;
{
  return(((unsigned long) element -
	  (unsigned long) ArrayElements(array))/size);
}
#endif
