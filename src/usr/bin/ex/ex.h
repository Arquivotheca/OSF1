 ...
 */
/*
static char rcsid[] = "@(#)$RCSfile: ex.h,v $ $Revision: 4.3.7.2 $ (DEC) $Date: 1993/06/10 19:29:37 $";
 */
/*
 * HISTORY
 */
 ...
 *
 * 1.19 com/cmd/edit/vi/ex.h, , bos320, 9134320 8/12/91 11:18:15
 * 
 ...
 * display in 1 column.
 */
#define QUOTE_CTRL_D    (~(wchar_t)0x1f)  /* 0xffe0 or 0xffffffe0 */
#define QUOTE_BSP       (~(wchar_t)0x1e)  /* 0xffe1 or 0xffffffe1 */
#define QUOTE_NL        (~(wchar_t)0x1d)  /* 0xffe2 or 0xffffffe2 */
#define QUOTE_CR        (~(wchar_t)0x1c)  /* 0xffe3 or 0xffffffe3 */
#define QUOTE_NUL       (~(wchar_t)0x1b)  /* 0xffe4 or 0xffffffe4 */
#define QUOTE_SP        (~(wchar_t)0x1a)  /* 0xffe5 or 0xffffffe5 */
#define QUOTE_WCD       (~(wchar_t)0x19)  /* 0xffe6 or 0xffffffe6 */
					/* character displays in two columns */
#define QUOTE_BULLET    (~(wchar_t)0x18)  /* 0xffe7 or 0xffffffe7 */
					/* partial char character */
#define ESCAPE  '\033'
#define Ctrl(c) ((c) & 037)
 ...
 */
var     wchar_t WCemptystr[1];  /* an wide char null string */
...
#ifdef _POSIX_SOURCE
var     speed_t ospeed;         /* Output speed (from termios) */
#else
...
int advance(wchar_t *, wchar_t *);
wchar_t colval(wchar_t);
int cclass(wchar_t *, wchar_t **, int);
void set(void);
int setend(void);
int any(int, char *);
