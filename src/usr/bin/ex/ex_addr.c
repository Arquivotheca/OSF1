...
static char rcsid[] = "@(#)$RCSfile: ex_addr.c,v $ $Revision: 4.2.7.2 $ (DEC) $Date: 1993/06/10 19:36:23 $";
#endif
/*
 * HISTORY
 */
 ...
 *
 * FUNCTION: address, getnum, setCNL, setNAEOL, setall, setcount, setdot,
 * setdot1, setnoaddr
 *
 *
 ...
 *
 * 1.7  com/cmd/edit/vi/ex_addr.c, bos320, 9134320 8/11/91 12:27:49
 * 
 */
