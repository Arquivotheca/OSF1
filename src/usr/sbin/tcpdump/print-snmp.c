 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: print-snmp.c,v $ $Revision: 1.1.2.2 $ (DEC) $Date: 1993/06/22 18:47:32 $";
#endif
/*
 ...
 *
 ...
 #	Based on: snmp.awk.x	1.1 (LANL) 1/15/90
 */
/*
 * Based on:
 * static char rcsid[] = "print-snmp.c,v 3.10 91/01/17 01:18:13 loverso Exp Locker: loverso $ (jlv)";
 */
