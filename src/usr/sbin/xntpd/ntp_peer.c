 ...
 */
#ifndef lint
static char     *sccsid = "@(#)$RCSfile: ntp_peer.c,v $ $Revision: 4.2.2.2 $ (DEC) $Date: 1992/05/04 16:57:42 $";
#endif
/*
 */
 ...
 */
u_int peer_timereset;		/* time stat counters were zeroed */
u_int findpeer_calls;		/* number of calls to findpeer */
u_int assocpeer_calls;		/* number of calls to findpeerbyassoc */
u_int peer_allocations;	/* number of allocations from the free list */
u_int peer_demobilizations;	/* number of structs freed to free list */
