 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: regex.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 05:59:04 $";
#endif 
/*
 */
/*
 ...
 */ 
#if !lint
static char sccsid[] = "regex.c	1.1  com/cmd/acct/lib,3.1,8935 5/15/89 17:19:15";
#endif
#define SSIZE	50
#define TGRP	48
#define A256	01
