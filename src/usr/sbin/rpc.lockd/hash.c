 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: hash.c,v $ $Revision: 1.1.3.3 $ (DEC) $Date: 1992/12/11 16:52:51 $";
#endif
#ifndef lint
static char sccsid[] = "@(#)hash.c	1.2 90/07/23 NFSSRC4.0 1.7 88/05/09 Copyr 1986 Sun Micro";
#endif
