 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: prot_lock.c,v $ $Revision: 1.1.3.4 $ (DEC) $Date: 1992/12/11 16:53:39 $";
#endif
#ifndef lint
static char sccsid[] = "@(#)prot_lock.c	1.4 90/11/09 NFSSRC4.1 Copyr 1990 Sun Micro";
#endif
