 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: svc_udp.c,v $ $Revision: 1.1.3.4 $ (DEC) $Date: 1992/08/25 13:31:52 $";
#endif
#ifndef lint
static char sccsid[] = "@(#)svc_udp.c	1.3 90/10/22 NFSSRC4.1 Copyr 1990 Sun Micro";
#endif
	...
	u_int sendsz, recvsz;
{
	...
	bzero((char *)xprt, sizeof (SVCXPRT));
	if (xprt == NULL) {
	...
	bzero((char *)rpc_buffer(xprt), su->su_iosz);
	xdrmem_create(
