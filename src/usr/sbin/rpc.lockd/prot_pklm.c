 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: prot_pklm.c,v $ $Revision: 1.1.3.3 $ (DEC) $Date: 1992/12/11 16:54:06 $";
#endif
#ifndef lint
static char sccsid[] = "@(#)prot_pklm.c	1.3 90/11/09 NFSSRC4.1 Copyr 1990 Sun Micro";
#endif
