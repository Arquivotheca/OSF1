 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: prot_libr.c,v $ $Revision: 1.1.6.2 $ (DEC) $Date: 1993/09/23 15:57:20 $";
#endif
#ifndef lint
static char sccsid[] = "@(#)prot_libr.c	1.3 90/11/09 NFSSRC4.1 Copyr 1990 Sun Micro";
#endif
