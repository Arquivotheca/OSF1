 ...
 */
/*
 * @(#)$RCSfile: common.h,v $ $Revision: 1.1.6.2 $ (DEC) $Date: 1993/05/26 17:46:34 $
 */
/* RE_SID: @(%)/tmp_mnt/vol/dosnfs/shades_SCCS/unix/pcnfsd/v2/src/SCCS/s.common.h 1.6 92/08/18 12:54:31 SMI */
/*
**=====================================================================
