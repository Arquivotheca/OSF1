 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: pcnfsd_xdr.c,v $ $Revision: 1.1.2.3 $ (DEC) $Date: 1992/09/29 14:20:21 $";
#endif
/* RE_SID: @(%)/tmp_mnt/vol/dosnfs/shades_SCCS/unix/pcnfsd/v2/src/SCCS/s.pcnfsd_xdr.c 1.2 92/08/18 12:54:21 SMI */
/*
