 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: sm_proc.c,v $ $Revision: 1.1.3.3 $ (DEC) $Date: 1992/05/08 14:46:31 $";
#endif
#ifndef lint
static char sccsid[] = 	"@(#)sm_proc.c	1.2 90/07/23 4.1NFSSRC Copyr 1988 Sun Micro";
#endif
