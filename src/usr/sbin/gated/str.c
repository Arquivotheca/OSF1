 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: str.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 06:08:13 $";
#endif 
/*
 */
/*
...
#include "gated_msg.h" 
extern nl_catd catd;
#define MSGSTR(n,s) NLcatgets(catd,MS_STR,n,s) 
#else
#define MSGSTR(n,s) s
#endif
...
#ifdef  STR_DEBUG
  printf(MSGSTR(STR_1,"cap: rcvd \"%s\"\n"), string);
#endif
...
#ifdef STR_DEBUG
  printf(MSGSTR(STR_2,"cap: rtn \"%s\", string == \"%s\"\n"), word, string);
#endif
...
#ifdef STR_DEBUG
  printf(MSGSTR(STR_3,"next_white: rcvd \"%s\"\n"), string);
#endif
...
#ifdef STR_DEBUG
  printf(MSGSTR(STR_4,"next_white: rtn %d\n"), (*ptr == '\0') ? 0 :
						  ptr - string);
#endif
...
#ifdef STR_DEBUG
  printf(MSGSTR(STR_5,"asubstr: rcvd \"%s\"(string) %d(start) %d(stop)\n"),
   string, start, stop);
#endif
...
#ifdef STR_DEBUG
  printf(MSGSTR(STR_6,"asubstr: rtn \"%s\"\n"), asubstr);
#endif
