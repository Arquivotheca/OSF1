 ...
 */
/*	
 *	@(#)$RCSfile: egp.h,v $ $Revision: 4.2.2.2 $ (DEC) $Date: 1992/04/20 15:56:04 $
 */ 
/*
 */
/*
...
struct egpngh {
	...
	int	ng_hint;		/* Send acquire, hello or cease interval 
						in seconds */
	time_t	ng_htime;		/* Time for next acquire, hello, or cease */
	...
	time_t	ng_stime;		/* Time to send next NR poll */
	...
	time_t	ng_rtime;		/* Time to rcv next NR poll */
