 ...
 */
/*
 * @(#)$RCSfile: sgi.map.h,v $ $Revision: 1.1.2.2 $ (DEC) $Date: 1993/06/22 19:23:49 $
 */
/* Based on:
 * /home/harbor/davy/system/nfswatch/RCS/sgi.map.h,v 4.0 1993/03/01 19:59:00 davy Exp $
 *
 ...
 *
 * Revision 1.3  1993/01/13  21:25:45  davy
 * Added ether_header, so we don't need to include the ultrix map.
 *
 * Revision 1.2  1993/01/13  20:18:17  davy
 * Added RCS headers.
 *
 */
...
/* good old SGI bastards not putting all the definitions in the
 * include files ... this defn pulled from <sys/vfs.h> SunOS4.1
 */
