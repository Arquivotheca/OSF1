...
#
#
#	@(#)$RCSfile: machdep.mk,v $ $Revision: 1.1.8.6 $ (DEC) $Date: 1993/08/24 19:50:01 $	
...
#
jmp.s		: ../../../ccs/lib/libc/${target_machine}/_setjmp_incl.s
longjmp.s	: ../../../ccs/lib/libc/${target_machine}/_longjmp_incl.s \
		  ../../../ccs/lib/libc/${target_machine}/ljresume_incl.s
