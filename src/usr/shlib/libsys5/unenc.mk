...
# HISTORY
#
# @(#)$RCSfile: unenc.mk,v $ $Revision: 1.1.2.10 $ (DEC) $Date: 1993/11/22 22:03:40 $
#

VPATH			= ${target_machine}:${LIBSYS5}:${LIBSYS5}/${target_machine}

${MAKETOP}/usr/ccs/lib/libsys5:${MAKETOP}/usr/ccs/lib/libsys5/alpha:${MAKETOP}/usr/ccs/lib/libc

UNENC_STDOBJS		= setpgrp.o mount.o umount.o crt1.o mknod.o \
			  mktemp.o getcwd.o \
			  sys5init.o mkfifo.o pipe.o ttyname.o \
			  siginfo_sig.o sigset.o sigpause.o truncate.o
