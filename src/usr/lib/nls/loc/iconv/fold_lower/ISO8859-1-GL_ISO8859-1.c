 ...
 */
#ifndef lint
static char     *sccsid = "@(#)$RCSfile: ISO8859-1-GL_ISO8859-1.c,v $ $Revision: 1.1.3.2 $ (DEC) $Date: 1993/06/28 23:01:59 $";
#endif
/*
 ...
 * 
 * 1.3  com/cmd/iconv/fold_lower/ISO8859-1-GL_ISO8859-1.c, cmdiconv, bos320, 9130320 7/16/91 03:07:23
 */

#include <stdlib.h>
#include "iconv_local.h"	/* from usr/ccs/lib/libiconv */
#include "fold_lower.h"
#include "ISO8859-1-GL_ISO8859-1.h"
