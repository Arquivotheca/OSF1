...
/*
* SCCS_data: @(#) Xmp.c	1.4 92/06/10 06:14:00
*
...
#include <X11/Xm/Xm.h>
#include <X11/Xm/RowColumnP.h>	/* RC_Type */
#include <X11/Xm/Text.h>	/* xmTextWidgetClass */
...
\tUsage: XmpTableChildOptions( w options )" );
    ...
    if (NULL == (widget = WcFullNameToWidget( w, params[0] )) )
    {
