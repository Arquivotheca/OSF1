...
/*
* SCCS_data: @(#) WcActCB.c    1.5 92/06/10 06:11:08
*
...
#define MAX_DIM(a,b) ((a)>(b)?(a):(b))
    ...
    {
	XtVaSetValues( sameWidgets[i],
		XtNborderWidth,	(XtArgVal)maxBorder,
		XtNheight,	(XtArgVal)maxHeight,
		XtNwidth,	(XtArgVal)maxWidth,
		NULL );
    }
    ...
    AddOrRemoveProc	AddOrRemove;
{
    ...
    if ( (Widget)NULL == (target = WcFullNameToWidget( w, name )) )
    {
