...
typedef struct _MapAgRec {	/* Stores hash table for mapping.	*/
    ...
    long		shiftA;	/* used by Hash: num insig LSBs in `a'	*/
    long		shiftB;	/* used by Hash: num insig LSBs in `b'	*/
    long		shiftC;	/* used by Hash: num insig LSBs in `c'	*/
...
#define MapAg_STATIC { \
    ...
    /* newAgent->mask	 */ (long)0,			\
    /* newAgent->numMaps */ (int)0,			\
    /* newAgent->shiftA  */ (long)0,			\
    /* newAgent->shiftB  */ (long)0,			\
    /* newAgent->shiftC  */ (long)0,			\
