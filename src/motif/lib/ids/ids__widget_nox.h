...
#ifndef IDS__WIDGET_NOX_H
#define IDS__WIDGET_NOX_H
...
typedef struct _ModelDataStruct
    ...
    int          comp_space_org;            /* component space organization */
...
typedef struct _PixelAllocStruct
    ...
    unsigned long   *colors;                    /* NOT USED IN NO X11 MODE  */
...
typedef struct _WorkNotify
    ...
    unsigned long  *event;		/* NOT USED IN NO X11 MODE          */
...
typedef struct _RenderContextStruct
    ...
    unsigned long   *appl_color_list;   /* IDS pointer to store appl color lst*/
    ...
    unsigned long   *ximage;		/* IDS pointer to output XImage	      */
    ...
    unsigned long   *display;		/* X11 display id		      */
    unsigned long   *screen;		/* X11 screen pointer		      */
    unsigned long   *visual;		/* X11 visual pointer		      */
    unsigned long    window;		/* X11 window id		      */
    unsigned long    width, height;     /* X11 window dimensions              */
    unsigned long    depth;             /* X11 number of planes in window     */
    unsigned long    colormap;          /* X11 colormap                       */
...
typedef struct _DataForXieStruct{
    ...
    unsigned long    pixmap;            /* NO X11 MODE */
    unsigned long    zero_mac_gc;
    unsigned long    zero_min_gc;
    unsigned long    image_gc;
    unsigned long    foreground_pixel;
    unsigned long    background_pixel;
    unsigned long    internal_roi_x;  /* Upper Right X coord of internal ROI */ 
    unsigned long    internal_roi_y;  /* Upper Right Y coord of internal ROI */ 
...
typedef struct _RenderContextStructXie    {
    ...
    unsigned long    photoflo;          /* XIE server image object for flow   */
    unsigned long    raw_photo;         /* XIE server image object to rerender*/
    unsigned long    save_photo;        /* XIE photo after rendition          */
    unsigned long    disp_photo;        /* XIE photo just before display      */
    unsigned long    lut_photo;         /* XIE export lut photo for next expor*/
    unsigned long       xiedat;            /* all data needed to build the pipe  */
    ...
    unsigned long    fill_roi;          /* XIE fill geometry                  */
    unsigned long    crop_roi;          /* XIE crop roi                       */
    unsigned long    tsrc_roi;          /* XIE Move translate dst geometry    */
    unsigned long    point_roi;         /* XIE Move translate dst geometry    */
    unsigned long    tdst_roi;          /* XIE Move translate dst geometry    */
    unsigned long    logic_roi;         /* XIE Logical op ROI                 */
    unsigned long    math_roi;          /* XIE Logical op ROI                 */
...
typedef struct _PhotoContextXie{
    ...
    unsigned long    pixmapGC;          /* temp bitonal GC until pipe lives   */
} PhotoContextStruct, *PhotoContext;

#endif /* IDS__WIDGET_NOX_H */
