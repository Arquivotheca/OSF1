...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: Primitive.c,v $ $Revision: 1.1.6.4 $ $Date: 1993/07/15 16:53:57 $"
#endif
#endif
/*
...
static XtResource resources[] =
{
...
#ifdef DEC_MOTIF_RTOL
   {
     ...
     DXmRLayoutDirection,
     sizeof(unsigned char),
     XtOffset (XmPrimitiveWidget, primitive.dxm_layout_direction),
     XmRImmediate,
...
#endif /* _NO_PROTO */
{
   ...
   /* Make sure label widgets sre interested in button and key events */
   /* so that context sensitive help will work on them                */
