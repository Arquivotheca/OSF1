 ...
 */
/*
 * @(#)$RCSfile: DragICCI.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/05/06 15:34:13 $
 */
/* 
 ...
 * Motif Release 1.2
*/ 
/*   $RCSfile: DragICCI.h,v $ $Revision: 1.1.4.2 $ $Date: 1993/05/06 15:34:13 $ */
/*
...
#ifdef ALPHA_BUG_FIX
/* alpha port note: CARD32 should be 4 bytes long, long may not be */
#define swap4bytes(l) {\
        CARD32 t = (CARD32) l;\
        char n, *tp = (char *) &t;\
        tp += sizeof(CARD32) - 4;\
...
#else
#define swap4bytes(l) {\
        unsigned long t = (unsigned long) l;\
        char n, *tp = (char *) &t;\
        tp += sizeof(long) - 4;\
	n = tp[0]; tp[0] = tp[3]; tp[3] = n;\
	n = tp[1]; tp[1] = tp[2]; tp[2] = n;\
...
extern unsigned char _XmByteOrderChar;
