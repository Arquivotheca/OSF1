...
#define _XmSCDefaultButtonShadowThickness   _XmSCDefaultButtonShadowThickne
#define _XmSCFONTLIST_DEFAULT_TAG_STRING    _XmSCFONTLIST_DEFAULT_TAG_STRIN
#define _XmSCXmFONTLIST_DEFAULT_TAG_STRING  _XmSCXmFONTLIST_DEFAULT_TAG_STR
#define _XmSdefaultButtonShadowThickness    _XmSdefaultButtonShadowThicknes
#define _XmStearOffMenuDeactivateCallback   _XmStearOffMenuDeactivateCallba
#endif
