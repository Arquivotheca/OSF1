 ...
 */
/*
 * @(#)$RCSfile: GadgetP.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/05/06 15:38:51 $
 */
/* 
 ...
 * Motif Release 1.2
*/ 
/*   $RCSfile: GadgetP.h,v $ $Revision: 1.1.4.2 $ $Date: 1993/05/06 15:38:51 $ */
/*
...
typedef struct _XmGadgetCacheRef
{
   ...
   long				data;
   /* 
    on alpha, long has different alignment requirements than int 
    (mod 8 vers. mod 4). Stucts also aligns to the mod 8. I have 
    used long here as this forces proper alignment and should be
    generic to other platforms.
    ddhill 11/23/92
    */
#else
   int				data;
