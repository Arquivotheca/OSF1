...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: SeparatoG.c,v $ $Revision: 1.1.6.3 $ $Date: 1993/07/15 17:12:16 $"
#endif
#endif
/*
...
externaldef(xmseparatorgcacheobjclassrec) XmSeparatorGCacheObjClassRec xmSeparatorGCacheObjClassRec =
#else
