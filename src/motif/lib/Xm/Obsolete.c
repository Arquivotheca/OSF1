...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: Obsolete.c,v $ $Revision: 1.1.4.4 $ $Date: 1993/10/18 15:33:14 $"
#endif
#endif
#ifdef  REV_INFO
#ifndef lint
...
#define _XmFileSelectionBoxCreateFilterLabel     _XmFileSelBoxCreateFilterLabel 
#define _XmFileSelectionBoxCreateDirListLabel    _XmFileSelBoxCreateDirListLab
#define _XmFileSelectionBoxCreateDirList         _XmFileSelBoxCreateDirList 
#define _XmFileSelectionBoxCreateFilterText      _XmFileSelBoxCreateFilterText 
#define _XmFileSelectionBoxGetFilterLabelString  _XmFileSelBoxGetFilterLabelStr 
#define _XmFileSelectionBoxGetDirListLabelString _XmFileSelBoxGetDirListLabelSt 
#define _XmFileSelectionBoxGetDirListItemCount   _XmFileSelBoxGetDirListItemCou 
#define _XmFileSelectionBoxGetDirListItems       _XmFileSelBoxGetDirListItems
#define _XmFileSelectionBoxGetListItemCount  	 _XmFileSelBoxGetListItemCount
#define _XmFileSelectionBoxGetNoMatchString 	 _XmFileSelectionBoxGetNoMatchSt
#endif
...
#ifdef VMS
/* VMS limit of 31 characters in extern function names */
#define _XmTextOutLoadGCsAndRecolorCursors _XmTextOutLoadGCsRecolorCursors
#endif
...
#ifndef VMS
/*
** These are not required for VMS.  They were never UNIVERSAL in previous releases
** of Motif and they simply cause linker problems now.
*/
