...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: DragBS.c,v $ $Revision: 1.1.4.3 $ $Date: 1993/07/15 16:17:46 $"
#endif
#endif
/*
...
#ifdef ALPHA_BUG_FIX
		/* Cardinal is not long enough for Alpha addresses
		   and truncated to 32 bits the address.
		   The size_t should be a generic fix */
	        (BYTE *)((size_t)info + propBufRec.data.size);
#else
