...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: XmStrDefs.c,v $ $Revision: 1.1.6.2 $ $Date: 1993/05/06 15:58:47 $"
#endif
#endif
/*
...
*/
#ifdef DEC_MOTIF_BUG_FIX
externaldef(_dxmstrings) _XmConst char _DXmStrings[] = {
#else
_XmConst char _DXmStrings[] = {
#endif
0,
'D','X','m','l','a','y','o','u','t','D','i','r','e','c','t','i','o','n',0,
'D','X','m','L','a','y','o','u','t','D','i','r','e','c','t','i','o','n',0,
'D','X','m','f','i','t','T','o','S','c','r','e','e','n','P','o','l','i','c','y',0,
'D','X','m','F','i','t','T','o','S','c','r','e','e','n','P','o','l','i','c','y',0,
