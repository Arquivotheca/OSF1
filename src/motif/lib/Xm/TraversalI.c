...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: TraversalI.c,v $ $Revision: 1.1.4.5 $ $Date: 1993/12/17 21:19:41 $"
#endif
#endif
#ifdef  REV_INFO
#ifndef lint
...
#endif /* _NO_PROTO */
{
  ...
  if(    tgraph->num_entries    )
    {
      while(    node = GetNodeOfWidget( tgraph, wid)    )
	{
