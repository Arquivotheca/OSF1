...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: Mrmappl.c,v $ $Revision: 1.1.6.3 $ $Date: 1993/08/31 18:31:21 $"
#endif
#endif
 ...
 */
...
#ifdef DEC_MOTIF_BUG_FIX
  {
    ...
    /*
    **  Must initialize the fields of os_ext_list to the default values.  Not doing this
    **  breaks this function on VMS.  CS, 13-Aug-93
    */
    (*os_ext_list)->version = (Cardinal) MrmOsOpenParamVersion;
    (*os_ext_list)->default_fname = (char *) NULL;
    (*os_ext_list)->nam_flg.related_nam = (unsigned long) 0;
  }
#else
    os_ext_list = (MrmOsOpenParamPtr *)&new_os_ext_list;
#endif
