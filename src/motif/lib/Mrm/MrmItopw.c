...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: MrmItopw.c,v $ $Revision: 1.1.6.2 $ $Date: 1993/05/06 13:46:28 $"
#endif
#endif
...
#ifdef ALPHA_BUG_FIX
    (name, URMWriteAccess, os_ext, &fileid, fname_return) ;
#else
...
#ifdef ALPHA_BUG_FIX
filedesc->lowlevel_id = (void *)fileid ;
#else
