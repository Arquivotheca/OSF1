 ...
 * HISTORY
 */
/* DEC/CMS REPLACEMENT HISTORY, Element BKR_API_UTIL.C*/
...
BkrClientStruct *client_ctx;
{
	...
	/* 
	 * try running dxbook first, if it is not there, run 
	 * /usr/bin/X11/dxbook.  If that is not there, exit.
	 */
	execvp( argv[0], argv );
