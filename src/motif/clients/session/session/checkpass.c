...
static char *BuildSystemHeader= "$Header: /alphabits/u3/x11/ode/rcs/x11/src/motif/clients/session/session/checkpass.c,v 1.1.2.2 92/06/24 16:04:23 Leela_Obilichetti Exp $";	/* BuildSystemHeader */
...
char * get_rootpasswd()
  {
    ...
    /* This should eventually replace the if (TRUE)...
