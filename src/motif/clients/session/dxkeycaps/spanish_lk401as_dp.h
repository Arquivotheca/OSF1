 ...
 */
/*
 * @(#)$RCSfile: spanish_lk401as_dp.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:24:27 $
 */
...
static struct key spanish_lk401as_dp_row1 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key spanish_lk401as_dp_row2 [] = {
 {0,	0,	0,	5, 7},
 {0xbf, "\\", "@", 7, 7,	0,	XK_at, XK_backslash},
 ...
 {0xf5, "[", "]", 7, 7,	0,	XK_bracketright, XK_bracketleft},
/*DEL*/
...
static struct key spanish_lk401as_dp_row3 [] = {
 {0,	0,	0,		5, 7},
...
static struct key spanish_lk401as_dp_row4 [] = {
 ...
 {0xe7, 0, "K", 7, 7,	0,	XK_K},
 {0xec, 0, "L", 7, 7,	0,	XK_L},
 {0xf2, "}", "{", 7, 7,	0,	XK_braceleft, XK_braceright},
 {251,	0,	0,		7, 7,	0,	XK_apostrophe,	XK_quotedbl},
 {0xf7, "~", "|", 7, 7,	0,	XK_bar, DXK_tilde},
 {0,	0,	0,		24, 7},
/*LEFT*/
 {170,	0, 0,		8, 7,	0,	XK_Up},
 {0,	0,	0,		15, 7},
...
static struct key spanish_lk401as_dp_row5 [] = {
...
static struct key spanish_lk401as_dp_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row spanish_lk401as_dp_rows [] = {
  { sizeof (spanish_lk401as_dp_row1) / sizeof (struct key), 7, spanish_lk401as_dp_row1 },
  { 0, 7, 0 },
  { sizeof (spanish_lk401as_dp_row2) / sizeof (struct key), 7, spanish_lk401as_dp_row2 },
  { sizeof (spanish_lk401as_dp_row3) / sizeof (struct key), 7, spanish_lk401as_dp_row3 },
  { sizeof (spanish_lk401as_dp_row4) / sizeof (struct key), 7, spanish_lk401as_dp_row4 },
  { sizeof (spanish_lk401as_dp_row5) / sizeof (struct key), 7, spanish_lk401as_dp_row5 },
  { sizeof (spanish_lk401as_dp_row6) / sizeof (struct key), 7, spanish_lk401as_dp_row6 }
};

static struct keyboard spanish_lk401as_dp = {
  "LK401 (Espanol)",
  sizeof (spanish_lk401as_dp_rows) / sizeof (struct row),
  spanish_lk401as_dp_rows,
  6, 3, 3
};
