 ...
 */
/*
 * @(#)$RCSfile: norwegian_lk401an_dp.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:21:52 $
 */
...
static struct key norwegian_lk401an_dp_row1 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key norwegian_lk401an_dp_row2 [] = {
 {0,	0,	0,	5, 7},
...
static struct key norwegian_lk401an_dp_row3 [] = {
 {0,	0,	0,		5, 7},
...
static struct key norwegian_lk401an_dp_row4 [] = {
...
static struct key norwegian_lk401an_dp_row5 [] = {
...
static struct key norwegian_lk401an_dp_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row norwegian_lk401an_dp_rows [] = {
  { sizeof (norwegian_lk401an_dp_row1) / sizeof (struct key), 7, norwegian_lk401an_dp_row1 },
  { 0, 7, 0 },
  { sizeof (norwegian_lk401an_dp_row2) / sizeof (struct key), 7, norwegian_lk401an_dp_row2 },
  { sizeof (norwegian_lk401an_dp_row3) / sizeof (struct key), 7, norwegian_lk401an_dp_row3 },
  { sizeof (norwegian_lk401an_dp_row4) / sizeof (struct key), 7, norwegian_lk401an_dp_row4 },
  { sizeof (norwegian_lk401an_dp_row5) / sizeof (struct key), 7, norwegian_lk401an_dp_row5 },
  { sizeof (norwegian_lk401an_dp_row6) / sizeof (struct key), 7, norwegian_lk401an_dp_row6 }
};

static struct keyboard norwegian_lk401an_dp = {
  "LK401 (Norsk)",
  sizeof (norwegian_lk401an_dp_rows) / sizeof (struct row),
  norwegian_lk401an_dp_rows,
  6, 3, 3
};
