 ...
 *
 * This file describes the HP 720 workstation keyboard.
...
static struct key HP_720_row5 [] = {
 {39,	"Del",	"Esc",		7, 7,		0,	XK_Delete, XK_Escape},
 {12,	"Shift",0,		11, 7,		ShiftMask,	XK_Shift_L},
 {36,	"Z",	0,		7, 7,		0,		XK_Z},
 {35,	"X",	0,		7, 7,		0,		XK_X},
 {34,	"C",	0,		7, 7,		0,		XK_C},
 {33,	"V",	0,		7, 7,		0,		XK_V},
...
static struct row HP_720_rows [] = {
	{ sizeof (HP_720_row0) / sizeof (struct key), 7, HP_720_row0 },
	{ 0, 3, 0 },
	{ sizeof (HP_720_row2) / sizeof (struct key), 7, HP_720_row2 },
	{ sizeof (HP_720_row3) / sizeof (struct key), 7, HP_720_row3 },
	{ sizeof (HP_720_row4) / sizeof (struct key), 7, HP_720_row4 },
	{ sizeof (HP_720_row5) / sizeof (struct key), 7, HP_720_row5 },
	{ sizeof (HP_720_row6) / sizeof (struct key), 7, HP_720_row6 }
};

static struct keyboard HP_720 = {
	"HP 720",
	sizeof (HP_720_rows) / sizeof (struct row),
	HP_720_rows,
	6, 3, 3
};
