 ...
 */
/*
 * @(#)$RCSfile: swiss_french_lk201lk_tw.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:26:06 $
 */
...
static struct key swiss_french_lk201lk_tw_row0 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key swiss_french_lk201lk_tw_row2 [] = {
 {0,	0,	0,	5, 7},
 {0xbf, StrXK_degree, "!", 7, 7,	0,	XK_exclam, XK_degree},
 {0xc0, "+", "1", 7, 7,	0,	XK_1, XK_plus},
 {0xc5, "\"", "2", 7, 7,	0,	XK_2, XK_quotedbl},
 {0xcb, "*", "3", 7, 7,	0,	XK_3, XK_asterisk},
 {0xd0, StrXK_ccedilla, "4", 7, 7,	0,	XK_4, XK_ccedilla},
 ...
 {0xf9, "?", "'", 7, 7,	0,	XK_apostrophe, XK_question},
 {245,	0,	0,	7, 7,	0,	XK_equal,	XK_plus},
/*DEL*/
...
static struct key swiss_french_lk201lk_tw_row3 [] = {
 {0,	0,	0,		5, 7},
 ...
 {0xeb, 0, "O", 7, 7,	0,	XK_O},
 {0xf0, 0, "P", 7, 7,	0,	XK_P},
 {0xfa, StrXK_udiaeresis, StrXK_egrave, 7, 7,	0,	XK_egrave, XK_udiaeresis},
 {246,	0,	0,		7, 7,	0,	XK_bracketright,XK_braceright},
 {0,	0,	0,		2, 7},
...
static struct key swiss_french_lk201lk_tw_row4 [] = {
 ...
 {0xe7, 0, "K", 7, 7,	0,	XK_K},
 {0xec, 0, "L", 7, 7,	0,	XK_L},
 {0xf2, StrXK_odiaeresis, StrXK_eacute, 7, 7,	0,	XK_eacute, XK_odiaeresis},
 {0xfb, StrXK_adiaeresis, StrXK_agrave, 7, 7,	0,	XK_agrave, XK_adiaeresis},
 {0xf7, StrXK_sterling, "$", 7, 7,	0,	XK_dollar, XK_sterling},
 {0,	0,	0,		24, 7},
/*LEFT*/
 {170,	0, 0,		8, 7,	0,	XK_Up},
 {0,	0,	0,		15, 7},
...
static struct key swiss_french_lk201lk_tw_row5 [] = {
...
static struct key swiss_french_lk201lk_tw_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row swiss_french_lk201lk_tw_rows [] = {
  { sizeof (swiss_french_lk201lk_tw_row0) / sizeof (struct key), 7, swiss_french_lk201lk_tw_row0 },
  { 0, 7, 0 },
  { sizeof (swiss_french_lk201lk_tw_row2) / sizeof (struct key), 7, swiss_french_lk201lk_tw_row2 },
  { sizeof (swiss_french_lk201lk_tw_row3) / sizeof (struct key), 7, swiss_french_lk201lk_tw_row3 },
  { sizeof (swiss_french_lk201lk_tw_row4) / sizeof (struct key), 7, swiss_french_lk201lk_tw_row4 },
  { sizeof (swiss_french_lk201lk_tw_row5) / sizeof (struct key), 7, swiss_french_lk201lk_tw_row5 },
  { sizeof (swiss_french_lk201lk_tw_row6) / sizeof (struct key), 7, swiss_french_lk201lk_tw_row6 }
};

static struct keyboard swiss_french_lk201lk_tw = {
  "LK201 (SuisseRomande)",
  sizeof (swiss_french_lk201lk_tw_rows) / sizeof (struct row),
  swiss_french_lk201lk_tw_rows,
  6, 3, 3
};
