 ...
 */
/*
 * @(#)$RCSfile: portugal.h,v $ $Revision: 1.1.4.6 $ (DEC) $Date: 1994/01/24 19:20:49 $
 */
...
static struct key portugal_row1 [] = {
...
static struct key portugal_row3 [] = {
 ...
 {0x44, 0, "O", 8, 8,	0,	XK_O},
 {0x4d, 0, "P", 8, 8,	0,	XK_P},
 {0x54, "*", "+", 8, 8,	0,	XK_plus, XK_asterisk, XK_diaeresis},
 {0x5b, "`", StrXK_acute, 8, 8,	0,	XK_acute, XK_grave},
 {0,    0,  0,      	2, 7},
...
static struct key portugal_row4 [] = {
 ...
 {0x42, 0, "K", 8, 8,	0,	XK_K},
 {0x4b, 0, "L", 8, 8,	0,	XK_L},
 {0x4c, StrXK_Ccedilla, StrXK_ccedilla, 8, 8,	0,	XK_ccedilla, XK_Ccedilla},
 {0x52, StrXK_ordfeminine, StrXK_masculine, 8, 8,	0,	XK_masculine, XK_ordfeminine},
 {0x53, "^", "~", 8, 8,	0,	XK_asciitilde, XK_asciicircum},
 {0,	0,	0,			42,7},
...
static struct key portugal_row5 [] = {
...
static struct key portugal_row6 [] = {
...
static struct row portugal_rows [] = {
  { sizeof (portugal_row1) / sizeof (struct key), 8, portugal_row1 },
  { 0, 8, 0 },
  { sizeof (portugal_row2) / sizeof (struct key), 8, portugal_row2 },
  { sizeof (portugal_row3) / sizeof (struct key), 8, portugal_row3 },
  { sizeof (portugal_row4) / sizeof (struct key), 8, portugal_row4 },
  { sizeof (portugal_row5) / sizeof (struct key), 8, portugal_row5 },
  { sizeof (portugal_row6) / sizeof (struct key), 8, portugal_row6 },
};

static struct keyboard portugal = {
  "PCXAL (Portugues)",
  sizeof (portugal_rows) / sizeof (struct row),
  portugal_rows,
  6, 3, 3
};
