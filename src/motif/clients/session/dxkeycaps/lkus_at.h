 ...
 */
/*
 * @(#)$RCSfile: lkus_at.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:21:06 $
 */
/* xkeycaps, Copyright (c) 1991 Jamie Zawinski <jwz@lucid.com>
 *
 * This file describes the LK443 (101-key DEC PC) keyboard.
 * By Steven W. Orr <steveo@world.std.com>.
 */

static struct key lkus_at_row1 [] = {
...
static struct key lkus_at_row2 [] = {
 {0xbf, "~", "`", 8, 8,	0,	XK_grave, XK_asciitilde, XK_grave, XK_asciitilde},
 {0xc0, "!", "1", 8, 8,	0,	XK_1, XK_exclam},
 {0xc5, "@", "2", 8, 8,	0,	XK_2, XK_at},
 {0xcb, "#", "3", 8, 8,	0,	XK_3, XK_numbersign},
 {0xd0, "$", "4", 8, 8,	0,	XK_4, XK_dollar},
 {0xd6, "", "5", 8, 8,	0,	XK_5, XK_percent},
 {0xdb, "^", "6", 8, 8,	0,	XK_6, XK_asciicircum},
 {0xe0, "&", "7", 8, 8,	0,	XK_7, XK_ampersand},
 {0xe5, "*", "8", 8, 8,	0,	XK_8, XK_asterisk},
 {0xea, "(", "9", 8, 8,	0,	XK_9, XK_parenleft},
 {0xef, ")", "0", 8, 8,	0,	XK_0, XK_parenright},
 {0xf9, "_", "-", 8, 8,	0,	XK_minus, XK_underscore},
 {0xf5, "+", "=", 8, 8,	0,	XK_equal, XK_plus},
/*DEL*/	
...
static struct key lkus_at_row3 [] = {
 ...
 {0xeb, 0, "O", 8, 8,	0,	XK_O},
 {0xf0, 0, "P", 8, 8,	0,	XK_P},
 {0xfa, "{", "[", 8, 8,	0,	XK_bracketleft, XK_braceleft},
 {0xf6, "}", "]", 8, 8,	0,	XK_bracketright, XK_braceright},
 {0xf7, "|", "\\", 12, 8,	0,	XK_backslash, XK_bar},
 {0,    0,  0, 	4, 8},
/*KPDEL*/
...
static struct key lkus_at_row4 [] = {
 ...
 {0xe7, 0, "K", 8, 	8,	0,	XK_K},
 {0xec, 0, "L", 8, 	8,	0,	XK_L},
 {0xf2, ":", ";", 8,	8,	0,	XK_semicolon, XK_colon},
 {0xfb, "\"", "'", 8, 	8,	0,	XK_apostrophe, XK_quotedbl},
 {0xbd, 0, 0, 18, 8,   0,  XK_Return},
 {0,    0,  0,  32, 8},
/*LEFT*/
 {0x99, 0, 0, 8, 8,	0, XK_KP_4, XK_Left},
 {0x9a, 0, 0, 8, 8,	0, XK_KP_5},
 {0x9b, 0, 0, 8, 8,	0, XK_KP_6, XK_Right},
};

static struct key lkus_at_row5 [] = {
 {0xae, 0, 0, 18, 8,	ShiftMask,	XK_Shift_L},
 {0xc3, 0, "Z", 8, 8,	0,		XK_Z},
 {0xc8, 0, "X", 8, 8,	0,		XK_X},
 {0xce, 0, "C", 8, 8,	0,		XK_C},
 {0xd3, 0, "V", 8, 8,	0,		XK_V},
 ...
 {0xde, 0, "N", 8, 8,	0,		XK_N},
 {0xe3, 0, "M", 8, 8,	0,		XK_M},
 {0xe8, "<", ",", 8, 8,	0,		XK_comma, XK_less},
 {0xed, ">", ".", 8, 8,	0,		XK_period, XK_greater},
 {0xf3, "?", "/", 8, 8,	0,		XK_slash, XK_question},
/*SHIFT*/
...
static struct row lkus_at_rows [] = {
  { sizeof (lkus_at_row1) / sizeof (struct key), 8, lkus_at_row1 },
  { 0, 8, 0 },
  { sizeof (lkus_at_row2) / sizeof (struct key), 8, lkus_at_row2 },
  { sizeof (lkus_at_row3) / sizeof (struct key), 8, lkus_at_row3 },
  { sizeof (lkus_at_row4) / sizeof (struct key), 8, lkus_at_row4 },
  { sizeof (lkus_at_row5) / sizeof (struct key), 8, lkus_at_row5 },
  { sizeof (lkus_at_row6) / sizeof (struct key), 8, lkus_at_row6 },
};

static struct keyboard lkus_at = {
  "LK443 (American)",
  sizeof (lkus_at_rows) / sizeof (struct row),
  lkus_at_rows,
  6, 3, 3
};
