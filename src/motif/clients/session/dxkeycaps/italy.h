 ...
 */
/*
 * @(#)$RCSfile: italy.h,v $ $Revision: 1.1.4.5 $ (DEC) $Date: 1994/01/24 19:19:19 $
 */
...
static struct key italy_row2 [] = {
 {0xe, "|", "\\", 8, 8,	0,	XK_backslash, XK_bar},
 {0x16, "!", "1", 8, 8,	0,	XK_1, XK_exclam},
 {0x1e, "\"", "2", 8, 8,	0,	XK_2, XK_quotedbl},
 {0x26, StrXK_sterling, "3", 8, 8,	0,	XK_3, XK_sterling},
 ...
 {0x55, StrXK_igrave, "=", 8, 8,	0,	XK_equal, XK_igrave},
...
static struct key italy_row3 [] = {
 ...
 {0x44, 0, "O", 8, 8,	0,	XK_O},
 {0x4d, 0, "P", 8, 8,	0,	XK_P},
 {0x54, StrXK_eacute, StrXK_egrave, 8, 8,	0,	XK_egrave, XK_eacute, XK_bracketleft},
...
static struct key italy_row4 [] = {
 ...
 {0x42, 0, "K", 8, 8,	0,	XK_K},
 {0x4b, 0, "L", 8, 8,	0,	XK_L},
 {0x4c, StrXK_ccedilla, StrXK_ograve, 8, 8,	0,	XK_ograve, XK_ccedilla, XK_at},
 {0x52, StrXK_degree, StrXK_agrave, 8, 8,	0,	XK_agrave, XK_degree, XK_numbersign},
 {0x53, StrXK_section, StrXK_ugrave, 8, 8,	0,	XK_ugrave, XK_section},
 {0,	0,	0,			42,7},
...
static struct row italy_rows [] = {
  { sizeof (italy_row1) / sizeof (struct key), 8, italy_row1 },
  { 0, 8, 0 },
  { sizeof (italy_row2) / sizeof (struct key), 8, italy_row2 },
  { sizeof (italy_row3) / sizeof (struct key), 8, italy_row3 },
  { sizeof (italy_row4) / sizeof (struct key), 8, italy_row4 },
  { sizeof (italy_row5) / sizeof (struct key), 8, italy_row5 },
  { sizeof (italy_row6) / sizeof (struct key), 8, italy_row6 },
};

static struct keyboard italy = {
  "PCXAL (Italiano)",
  sizeof (italy_rows) / sizeof (struct row),
  italy_rows,
  6, 3, 3
};
