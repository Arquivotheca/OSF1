 ...
 */
/*
 * @(#)$RCSfile: lkdenmark.h,v $ $Revision: 1.1.4.4 $ (DEC) $Date: 1994/01/24 19:19:38 $
 */
...
static struct key lkdenmark_row1 [] = {
...
static struct key lkdenmark_row2 [] = {
 {0xbf, StrXK_section, StrXK_onehalf, 8, 8,	0,	XK_onehalf, XK_section, XK_onehalf, XK_section},
 {0xc0, "!", "1", 8, 8,	0,	XK_1, XK_exclam},
 {0xc5, "\"", "2",8, 8,	0,	XK_2, XK_quotedbl, XK_at},
 {0xcb, "#", "3", 8, 8,	0,	XK_3, XK_numbersign, XK_sterling},
 {0xd0, StrXK_currency, "4", 8, 8,	0,	XK_4, XK_currency, XK_dollar},
 ...
 {0xf9, "?", "+", 8, 8,	0,	XK_plus, XK_question},
 {0xf5, "`", StrXK_acute, 8, 8,	0,	XK_acute, XK_grave, XK_bar},
/*DEL*/
...
static struct key lkdenmark_row3 [] = {
 ...
 {0xeb, 0, "O", 8, 8,	0,	XK_O},
 {0xf0, 0, "P", 8, 8,	0,	XK_P},
 {0xfa, StrXK_Aring, StrXK_aring, 8, 8,	0,	XK_aring, XK_Aring},
 {0xf6, "^", StrXK_diaeresis, 8, 8,	0,	XK_diaeresis, XK_asciicircum, XK_asciitilde},
 {0,    0,  0, 	2, 7},
...
static struct key lkdenmark_row4 [] = {
 ...
 {0xe7, 0, "K", 8, 8,	0,	XK_K},
 {0xec, 0, "L", 8, 8,	0,	XK_L},
 {0xf2, StrXK_AE, StrXK_ae, 8, 8,	0,	XK_ae, XK_AE},
 {0xfb, StrXK_oslash, StrXK_Ooblique, 8, 8,	0,	XK_Ooblique, XK_oslash},
 {0xf7, "*", "'", 8, 8,	0,	XK_apostrophe, XK_asterisk},
 {0,    0,  0, 42, 7},
/*LEFT*/
...
static struct key lkdenmark_row5 [] = {
...
static struct key lkdenmark_row6 [] = {
...
static struct row lkdenmark_rows [] = {
  { sizeof (lkdenmark_row1) / sizeof (struct key), 8, lkdenmark_row1 },
  { 0, 8, 0 },
  { sizeof (lkdenmark_row2) / sizeof (struct key), 8, lkdenmark_row2 },
  { sizeof (lkdenmark_row3) / sizeof (struct key), 8, lkdenmark_row3 },
  { sizeof (lkdenmark_row4) / sizeof (struct key), 8, lkdenmark_row4 },
  { sizeof (lkdenmark_row5) / sizeof (struct key), 8, lkdenmark_row5 },
  { sizeof (lkdenmark_row6) / sizeof (struct key), 8, lkdenmark_row6 },
};

static struct keyboard lkdenmark = {
  "LK444 (Dansk)",
  sizeof (lkdenmark_rows) / sizeof (struct row),
  lkdenmark_rows,
  6, 3, 3
};
