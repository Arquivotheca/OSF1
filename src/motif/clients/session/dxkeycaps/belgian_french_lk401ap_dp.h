 ...
 */
/*
 * @(#)$RCSfile: belgian_french_lk401ap_dp.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:11:04 $
 */
...
static struct key belgian_french_lk401ap_dp_row1 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key belgian_french_lk401ap_dp_row2 [] = {
 {0,	0,	0,	5, 7},
 {191,	0,	0,	7, 7,	0,	XK_grave,	XK_asciitilde},
 {0xc0, "1", "&", 7, 7,	0,	XK_ampersand, XK_1},
 {0xc5, "2", "|", 7, 7,	0,	XK_bar, XK_2},
 {0xcb, "3", "\"", 7, 7,	0,	XK_quotedbl, XK_3},
 {0xd0, "4", "'", 7, 7,	0,	XK_apostrophe, XK_4},
 {0xd6, "5", "(", 7, 7,	0,	XK_parenleft, XK_5},
 {0xdb, "6", "[", 7, 7,	0,	XK_bracketleft, XK_6},
 {0xe0, "7", "]", 7, 7,	0,	XK_bracketright, XK_7},
 {0xe5, "8", "!", 7, 7,	0,	XK_exclam, XK_8},
 {0xea, "9", "{", 7, 7,	0,	XK_braceleft, XK_9},
 {0xef, "0", "}", 7, 7,	0,	XK_braceright, XK_0},
...
static struct key belgian_french_lk401ap_dp_row3 [] = {
 {0,	0,	0,		5, 7},
...
static struct key belgian_french_lk401ap_dp_row4 [] = {
 ...
 {0xec, 0, "L", 7, 7,	0,	XK_L},
 {0xf2, 0, "M", 7, 7,	0,	XK_M},
 {0xfb, "", "\\", 7, 7,	0,	XK_backslash, XK_percent},
...
static struct key belgian_french_lk401ap_dp_row5 [] = {
...
static struct key belgian_french_lk401ap_dp_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row belgian_french_lk401ap_dp_rows [] = {
  { sizeof (belgian_french_lk401ap_dp_row1) / sizeof (struct key), 7, belgian_french_lk401ap_dp_row1 },
  { 0, 7, 0 },
  { sizeof (belgian_french_lk401ap_dp_row2) / sizeof (struct key), 7, belgian_french_lk401ap_dp_row2 },
  { sizeof (belgian_french_lk401ap_dp_row3) / sizeof (struct key), 7, belgian_french_lk401ap_dp_row3 },
  { sizeof (belgian_french_lk401ap_dp_row4) / sizeof (struct key), 7, belgian_french_lk401ap_dp_row4 },
  { sizeof (belgian_french_lk401ap_dp_row5) / sizeof (struct key), 7, belgian_french_lk401ap_dp_row5 },
  { sizeof (belgian_french_lk401ap_dp_row6) / sizeof (struct key), 7, belgian_french_lk401ap_dp_row6 }
};

static struct keyboard belgian_french_lk401ap_dp = {
  "LK401 (Francais)",
  sizeof (belgian_french_lk401ap_dp_rows) / sizeof (struct row),
  belgian_french_lk401ap_dp_rows,
  6, 3, 3
};
