 ...
 */
/*
 * @(#)$RCSfile: portuguese_lk201lv.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:22:52 $
 */
...
static struct key portuguese_lk201lv_row0 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key portuguese_lk201lv_row2 [] = {
 {0,	0,	0,	5, 7},
...
static struct key portuguese_lk201lv_row3 [] = {
 {0,	0,	0,		5, 7},
...
static struct key portuguese_lk201lv_row4 [] = {
...
static struct key portuguese_lk201lv_row5 [] = {
...
static struct key portuguese_lk201lv_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row portuguese_lk201lv_rows [] = {
  { sizeof (portuguese_lk201lv_row0) / sizeof (struct key), 7, portuguese_lk201lv_row0 },
  { 0, 7, 0 },
  { sizeof (portuguese_lk201lv_row2) / sizeof (struct key), 7, portuguese_lk201lv_row2 },
  { sizeof (portuguese_lk201lv_row3) / sizeof (struct key), 7, portuguese_lk201lv_row3 },
  { sizeof (portuguese_lk201lv_row4) / sizeof (struct key), 7, portuguese_lk201lv_row4 },
  { sizeof (portuguese_lk201lv_row5) / sizeof (struct key), 7, portuguese_lk201lv_row5 },
  { sizeof (portuguese_lk201lv_row6) / sizeof (struct key), 7, portuguese_lk201lv_row6 }
};

static struct keyboard portuguese_lk201lv = {
  "LK201 (Portugues)",
  sizeof (portuguese_lk201lv_rows) / sizeof (struct row),
  portuguese_lk201lv_rows,
  6, 3, 3
};
