 ...
 */
/*
 * @(#)$RCSfile: uk_at.h,v $ $Revision: 1.1.4.5 $ (DEC) $Date: 1994/01/24 19:21:11 $
 */
...
static struct key uk_at_row2 [] = {
 {0xe, StrXK_notsign, "`", 8, 8,	0,	XK_grave, XK_notsign, XK_bar},
...
static struct key uk_at_row4 [] = {
 ...
 {0x52, "@", "'", 8, 8,	0,	XK_quoteright, XK_at},
 {0x53, "~", "#", 8, 8,	0,	XK_numbersign, XK_asciitilde},
 {0,	0,	0,			42,7},
...
static struct row uk_at_rows [] = {
  { sizeof (uk_at_row1) / sizeof (struct key), 8, uk_at_row1 },
  { 0, 8, 0 },
  { sizeof (uk_at_row2) / sizeof (struct key), 8, uk_at_row2 },
  { sizeof (uk_at_row3) / sizeof (struct key), 8, uk_at_row3 },
  { sizeof (uk_at_row4) / sizeof (struct key), 8, uk_at_row4 },
  { sizeof (uk_at_row5) / sizeof (struct key), 8, uk_at_row5 },
  { sizeof (uk_at_row6) / sizeof (struct key), 8, uk_at_row6 },
};

static struct keyboard uk_at = {
  "PCXAL (British/Irish)",
  sizeof (uk_at_rows) / sizeof (struct row),
  uk_at_rows,
  6, 3, 3
};
