 ...
 */
/*
 * @(#)$RCSfile: lkspain.h,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1994/01/24 19:20:13 $
 */
...
static struct key lkspain_row1 [] = {
...
static struct key lkspain_row2 [] = {
 {0xbf, StrXK_ordfeminine, StrXK_masculine, 8, 8,	0,	XK_masculine, XK_ordfeminine, XK_masculine, XK_ordfeminine},
 {0xc0, "!", "1", 8, 8,	0,	XK_1, XK_exclam, XK_bar},
 {0xc5, "\"", "2",8, 8,	0,	XK_2, XK_quotedbl, XK_at},
 {0xcb, StrXK_periodcentered, "3", 8, 8,	0,	XK_3, XK_periodcentered, XK_numbersign},
 {0xd0, "$", "4", 8, 8,	0,	XK_4, XK_dollar},
 {0xd6, "", "5", 8, 8,	0,	XK_5, XK_percent},
 {0xdb, "&", "6", 8, 8,	0,	XK_6, XK_ampersand, XK_notsign},
 {0xe0, "/", "7", 8, 8,	0,	XK_7, XK_slash},
 {0xe5, "(", "8", 8, 8,	0,	XK_8, XK_parenleft},
 {0xea, ")", "9", 8, 8,	0,	XK_9, XK_parenright},
 {0xef, "=", "0", 8, 8,	0,	XK_0, XK_equal},
 {0xf9, "?", "'", 8, 8,	0,	XK_apostrophe, XK_question},
 {0xf5, StrXK_questiondown, StrXK_exclamdown, 8, 8,	0,	XK_exclamdown, XK_questiondown},
/*DEL*/
...
static struct key lkspain_row3 [] = {
 ...
 {0xeb, 0, "O", 8, 8,	0,	XK_O},
 {0xf0, 0, "P", 8, 8,	0,	XK_P},
 {0xfa, "^", "`", 8, 8,	0,	XK_grave, XK_asciicircum, XK_bracketleft},
 {0xf6, "*", "+", 8, 8,	0,	XK_plus, XK_asterisk, XK_bracketright},
 {0,    0,  0, 	2, 7},
...
static struct key lkspain_row4 [] = {
 ...
 {0xe7, 0, "K", 8, 8,	0,	XK_K},
 {0xec, 0, "L", 8, 8,	0,	XK_L},
 {0xf2, StrXK_Ntilde, StrXK_ntilde, 8, 8,	0,	XK_ntilde, XK_Ntilde},
 {0xfb, StrXK_diaeresis, StrXK_acute, 8, 8,	0,	XK_acute, XK_diaeresis, XK_braceleft},
 {0xf7, StrXK_Ccedilla, StrXK_ccedilla, 8, 8,	0,	XK_ccedilla, XK_Ccedilla, XK_braceright},
 {0,    0,  0, 42, 7},
/*LEFT*/
...
static struct key lkspain_row5 [] = {
...
static struct key lkspain_row6 [] = {
...
static struct row lkspain_rows [] = {
  { sizeof (lkspain_row1) / sizeof (struct key), 8, lkspain_row1 },
  { 0, 8, 0 },
  { sizeof (lkspain_row2) / sizeof (struct key), 8, lkspain_row2 },
  { sizeof (lkspain_row3) / sizeof (struct key), 8, lkspain_row3 },
  { sizeof (lkspain_row4) / sizeof (struct key), 8, lkspain_row4 },
  { sizeof (lkspain_row5) / sizeof (struct key), 8, lkspain_row5 },
  { sizeof (lkspain_row6) / sizeof (struct key), 8, lkspain_row6 },
};

static struct keyboard lkspain = {
  "LK444 (Espanol)",
  sizeof (lkspain_rows) / sizeof (struct row),
  lkspain_rows,
  6, 3, 3
};
