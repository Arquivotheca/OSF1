 ...
 */
/*
 * @(#)$RCSfile: norway.h,v $ $Revision: 1.1.4.5 $ (DEC) $Date: 1994/01/24 19:20:44 $
 */
...
static struct key norway_row2 [] = {
 {0xe, StrXK_section, "|", 8, 8,	0,	XK_bar, XK_section},
 ...
 {0x4e, "?", "+", 8, 8,	0,	XK_plus, XK_question},
 {0x55, "`", "\\", 8, 8,	0,	XK_backslash, XK_grave, XK_acute},
...
static struct key norway_row4 [] = {
 ...
 {0x42, 0, "K", 8, 8,	0,	XK_K},
 {0x4b, 0, "L", 8, 8,	0,	XK_L},
 {0x4c, StrXK_Ooblique, StrXK_oslash, 8, 8,	0,	XK_oslash, XK_Ooblique},
 {0x52, StrXK_AE, StrXK_ae, 8, 8,	0,	XK_ae, XK_AE},
...
static struct key norway_row5 [] = {
 {0x12,	"Shift",0,		10, 8,	ShiftMask,	XK_Shift_L},
 {0x13, "|", "\\", 8, 8,	0,		XK_backslash, XK_bar},
 {0x1a, 0, "Z", 8, 8,	0,		XK_Z},
 {0x22, 0, "X", 8, 8,	0,		XK_X},
 {0x21, 0, "C", 8, 8,	0,		XK_C},
 {0x2a, 0, "V", 8, 8,	0,		XK_V},
...
static struct row norway_rows [] = {
  { sizeof (norway_row1) / sizeof (struct key), 8, norway_row1 },
  { 0, 8, 0 },
  { sizeof (norway_row2) / sizeof (struct key), 8, norway_row2 },
  { sizeof (norway_row3) / sizeof (struct key), 8, norway_row3 },
  { sizeof (norway_row4) / sizeof (struct key), 8, norway_row4 },
  { sizeof (norway_row5) / sizeof (struct key), 8, norway_row5 },
  { sizeof (norway_row6) / sizeof (struct key), 8, norway_row6 },
};

static struct keyboard norway = {
  "PCXAL (Norsk)",
  sizeof (norway_rows) / sizeof (struct row),
  norway_rows,
  6, 3, 3
};
