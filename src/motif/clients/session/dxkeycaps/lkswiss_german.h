 ...
 */
/*
 * @(#)$RCSfile: lkswiss_german.h,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1994/01/24 19:20:30 $
 */
...
static struct key lkswiss_german_row1 [] = {
...
static struct key lkswiss_german_row2 [] = {
 ...
 {0xf9, "?", "+", 8, 8,	0,	XK_plus, XK_question, XK_acute},
...
static struct key lkswiss_german_row3 [] = {
 ...
 {0xeb, 0, "O", 8, 8,	0,	XK_O},
 {0xf0, 0, "P", 8, 8,	0,	XK_P},
 {0xfa, StrXK_egrave, StrXK_udiaeresis, 8, 8,	0,	XK_udiaeresis, XK_egrave, XK_bracketleft},
...
static struct key lkswiss_german_row4 [] = {
 ...
 {0xe7, 0, "K", 8, 8,	0,	XK_K},
 {0xec, 0, "L", 8, 8,	0,	XK_L},
 {0xf2, StrXK_eacute, StrXK_odiaeresis, 8, 8,	0,	XK_odiaeresis, XK_eacute},
 {0xfb, StrXK_agrave, StrXK_adiaeresis, 8, 8,	0,	XK_adiaeresis, XK_agrave, XK_braceleft},
...
static struct key lkswiss_german_row5 [] = {
...
static struct key lkswiss_german_row6 [] = {
...
static struct row lkswiss_german_rows [] = {
  { sizeof (lkswiss_german_row1) / sizeof (struct key), 8, lkswiss_german_row1 },
  { 0, 8, 0 },
  { sizeof (lkswiss_german_row2) / sizeof (struct key), 8, lkswiss_german_row2 },
  { sizeof (lkswiss_german_row3) / sizeof (struct key), 8, lkswiss_german_row3 },
  { sizeof (lkswiss_german_row4) / sizeof (struct key), 8, lkswiss_german_row4 },
  { sizeof (lkswiss_german_row5) / sizeof (struct key), 8, lkswiss_german_row5 },
  { sizeof (lkswiss_german_row6) / sizeof (struct key), 8, lkswiss_german_row6 },
};

static struct keyboard lkswiss_german = {
  "LK444 (Schweiz)",
  sizeof (lkswiss_german_rows) / sizeof (struct row),
  lkswiss_german_rows,
  6, 3, 3
};
