 ...
 */
/*
 * @(#)$RCSfile: france.h,v $ $Revision: 1.1.4.5 $ (DEC) $Date: 1994/01/24 19:19:00 $
 */
...
static struct key france_row2 [] = {
 {0xe, 0, StrXK_twosuperior, 8, 8,	0,	XK_twosuperior},
 {0x16, "1", "&", 8, 8,	0,	XK_ampersand, XK_1},
 {0x1e, "2", StrXK_eacute, 8, 8,	0,	XK_eacute, XK_2, XK_asciitilde},
 {0x26, "3", "\"", 8, 8,	0,	XK_quotedbl, XK_3, XK_numbersign},
 {0x25, "4", "'", 8, 8,	0,	XK_apostrophe, XK_4, XK_braceleft},
 {0x2e, "5", "(", 8, 8,	0,	XK_parenleft, XK_5, XK_bracketleft},
 {0x36, "6", "-", 8, 8,	0,	XK_minus, XK_6, XK_bar},
 {0x3d, "7", StrXK_egrave, 8, 8,	0,	XK_egrave, XK_7, XK_grave},
 {0x3e, "8", "_", 8, 8,	0,	XK_underscore, XK_8, XK_backslash},
 {0x46, "9", StrXK_ccedilla, 8, 8,	0,	XK_ccedilla, XK_9, XK_asciicircum},
 {0x45, "0", StrXK_agrave, 8, 8,	0,	XK_agrave, XK_0, XK_at},
 {0x4e, StrXK_degree, ")", 8, 8,	0,	XK_parenright, XK_degree, XK_bracketright},
 {0x55, "+", "=", 8, 8,	0,	XK_equal, XK_plus, XK_braceright},
...
static struct key france_row3 [] = {
 ...
 {0x44, 0, "O", 8, 8,	0,	XK_O},
 {0x4d, 0, "P", 8, 8,	0,	XK_P},
 {0x54, StrXK_diaeresis, "^", 8, 8,	0,	XK_asciicircum, XK_diaeresis},
 {0x5b, StrXK_sterling, "$", 8, 8,	0,	XK_dollar, XK_sterling, XK_currency},
 {0,    0,  0,      	2, 7},
...
static struct key france_row4 [] = {
 ...
 {0x4b, 0, "L", 8, 8,	0,	XK_L},
 {0x4c, 0, "M", 8, 8,	0,	XK_M},
 {0x52, "", StrXK_ugrave, 8, 8,	0,	XK_ugrave, XK_percent},
 {0x53, StrXK_mu, "*", 8, 8,	0,	XK_asterisk, XK_mu},
 {0,	0,	0,			42,7},
...
static struct key france_row5 [] = {
 ...
 {0x4a, StrXK_section, "!", 8, 8,	0,		XK_exclam, XK_section},
...
static struct row france_rows [] = {
  { sizeof (france_row1) / sizeof (struct key), 8, france_row1 },
  { 0, 8, 0 },
  { sizeof (france_row2) / sizeof (struct key), 8, france_row2 },
  { sizeof (france_row3) / sizeof (struct key), 8, france_row3 },
  { sizeof (france_row4) / sizeof (struct key), 8, france_row4 },
  { sizeof (france_row5) / sizeof (struct key), 8, france_row5 },
  { sizeof (france_row6) / sizeof (struct key), 8, france_row6 },
};

static struct keyboard france = {
  "PCXAL (Francais)",
  sizeof (france_rows) / sizeof (struct row),
  france_rows,
  6, 3, 3
};
