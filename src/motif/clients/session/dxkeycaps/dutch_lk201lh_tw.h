 ...
 */
/*
 * @(#)$RCSfile: dutch_lk201lh_tw.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:12:13 $
 */
...
static struct key dutch_lk201lh_tw_row0 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key dutch_lk201lh_tw_row2 [] = {
 {0,	0,	0,	5, 7},
 {191,	0,	0,	7, 7,	0,	XK_grave,	XK_asciitilde},
 {0xc0, StrXK_onequarter, "1", 7, 7,	0,	XK_1, XK_onequarter},
 {0xc5, StrXK_onehalf, "2", 7, 7,	0,	XK_2, XK_onehalf},
 {0xcb, StrXK_sterling, "3", 7, 7,	0,	XK_3, XK_sterling},
 {0xd0, "$", "4", 7, 7,	0,	XK_4, XK_dollar},
 {0xd6, "", "5", 7, 7,	0,	XK_5, XK_percent},
 {0xdb, "#", "6", 7, 7,	0,	XK_6, XK_numbersign},
 {0xe0, "&", "7", 7, 7,	0,	XK_7, XK_ampersand},
 {0xe5, "(", "8", 7, 7,	0,	XK_8, XK_parenleft},
 {0xea, ")", "9", 7, 7,	0,	XK_9, XK_parenright},
 {0xef, StrXK_section, "0", 7, 7,	0,	XK_0, XK_section},
 {0xf9, "\"", "'", 7, 7,	0,	XK_apostrophe, XK_quotedbl},
 {0xf5, ":", "/", 7, 7,	0,	XK_slash, XK_colon},
/*DEL*/
...
static struct key dutch_lk201lh_tw_row3 [] = {
 {0,	0,	0,		5, 7},
 ...
 {0xf6, "!", "*", 7, 7,	0,	XK_asterisk, XK_exclam},
 {0,	0,	0,		2, 7},
...
static struct key dutch_lk201lh_tw_row4 [] = {
 ...
 {0xe7, 0, "K", 7, 7,	0,	XK_K},
 {0xec, 0, "L", 7, 7,	0,	XK_L},
 {0xf2, "_", "-", 7, 7,	0,	XK_minus, XK_underscore},
 {251,	0,	0,		7, 7,	0,	XK_apostrophe,	XK_quotedbl},
 {0xf7, "|", "@", 7, 7,	0,	XK_at, XK_bar},
 {0,	0,	0,		24, 7},
/*LEFT*/
 {170,	0, 0,		8, 7,	0,	XK_Up},
 {0,	0,	0,		15, 7},
...
static struct key dutch_lk201lh_tw_row5 [] = {
 ...
 {0xde, 0, "N", 7, 7,	0,	XK_N},
 {0xe3, 0, "M", 7, 7,	0,	XK_M},
 {0xe8, "?", ",", 7, 7,	0,	XK_comma, XK_question},
 {0xed, ";", ".", 7, 7,	0,	XK_period, XK_semicolon},
 {0xf3, "=", "+", 7, 7,	0,	XK_plus, XK_equal},
/*SHIFT*/
...
static struct key dutch_lk201lh_tw_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row dutch_lk201lh_tw_rows [] = {
  { sizeof (dutch_lk201lh_tw_row0) / sizeof (struct key), 7, dutch_lk201lh_tw_row0 },
  { 0, 7, 0 },
  { sizeof (dutch_lk201lh_tw_row2) / sizeof (struct key), 7, dutch_lk201lh_tw_row2 },
  { sizeof (dutch_lk201lh_tw_row3) / sizeof (struct key), 7, dutch_lk201lh_tw_row3 },
  { sizeof (dutch_lk201lh_tw_row4) / sizeof (struct key), 7, dutch_lk201lh_tw_row4 },
  { sizeof (dutch_lk201lh_tw_row5) / sizeof (struct key), 7, dutch_lk201lh_tw_row5 },
  { sizeof (dutch_lk201lh_tw_row6) / sizeof (struct key), 7, dutch_lk201lh_tw_row6 }
};

static struct keyboard dutch_lk201lh_tw = {
  "LK201 (Nederlands)",
  sizeof (dutch_lk201lh_tw_rows) / sizeof (struct row),
  dutch_lk201lh_tw_rows,
  6, 3, 3
};
