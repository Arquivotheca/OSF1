 ...
 */
/*
 * @(#)$RCSfile: dutch_us_lk401ah.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:12:26 $
 */
...
static struct key dutch_us_lk401ah_row1 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key dutch_us_lk401ah_row2 [] = {
 {0,	0,	0,	5, 7},
 {0xbf, "~", "`", 7, 7,	0,	XK_grave, XK_asciitilde},
 ...
 {0xdb, "^", "6", 7, 7,	0,	XK_6, XK_asciicircum},
...
static struct key dutch_us_lk401ah_row3 [] = {
 {0,	0,	0,		5, 7},
 ...
 {0xeb, 0, "O", 7, 7,	0,	XK_O},
 {0xf0, 0, "P", 7, 7,	0,	XK_P},
 {0xfa, "{", "[", 7, 7,	0,	XK_bracketleft, XK_braceleft},
...
static struct key dutch_us_lk401ah_row4 [] = {
 ...
 {0xfb, "\"", "'", 7, 7,	0,	XK_apostrophe, XK_quotedbl},
...
static struct key dutch_us_lk401ah_row5 [] = {
...
static struct key dutch_us_lk401ah_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row dutch_us_lk401ah_rows [] = {
  { sizeof (dutch_us_lk401ah_row1) / sizeof (struct key), 7, dutch_us_lk401ah_row1 },
  { 0, 7, 0 },
  { sizeof (dutch_us_lk401ah_row2) / sizeof (struct key), 7, dutch_us_lk401ah_row2 },
  { sizeof (dutch_us_lk401ah_row3) / sizeof (struct key), 7, dutch_us_lk401ah_row3 },
  { sizeof (dutch_us_lk401ah_row4) / sizeof (struct key), 7, dutch_us_lk401ah_row4 },
  { sizeof (dutch_us_lk401ah_row5) / sizeof (struct key), 7, dutch_us_lk401ah_row5 },
  { sizeof (dutch_us_lk401ah_row6) / sizeof (struct key), 7, dutch_us_lk401ah_row6 }
};

static struct keyboard dutch_us_lk401ah = {
  "LK401 (Nederlands)",
  sizeof (dutch_us_lk401ah_rows) / sizeof (struct row),
  dutch_us_lk401ah_rows,
  6, 3, 3
};
