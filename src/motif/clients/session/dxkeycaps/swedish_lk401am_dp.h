 ...
 */
/*
 * @(#)$RCSfile: swedish_lk401am_dp.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:25:45 $
 */
...
static struct key swedish_lk401am_dp_row1 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key swedish_lk401am_dp_row3 [] = {
 {0,	0,	0,		5, 7},
 ...
 {0xf6, "\\", "#", 7, 7,	0,	XK_numbersign, XK_backslash},
 {0,	0,	0,		2, 7},
...
static struct key swedish_lk401am_dp_row4 [] = {
 ...
 {0xe7, 0, "K", 7, 7,	0,	XK_K},
 {0xec, 0, "L", 7, 7,	0,	XK_L},
 {0xf2, "{", "}", 7, 7,	0,	XK_braceright, XK_braceleft},
 {0xfb, 0, "|", 7, 7,	0,	XK_bar},
...
static struct key swedish_lk401am_dp_row5 [] = {
...
static struct key swedish_lk401am_dp_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row swedish_lk401am_dp_rows [] = {
  { sizeof (swedish_lk401am_dp_row1) / sizeof (struct key), 7, swedish_lk401am_dp_row1 },
  { 0, 7, 0 },
  { sizeof (swedish_lk401am_dp_row2) / sizeof (struct key), 7, swedish_lk401am_dp_row2 },
  { sizeof (swedish_lk401am_dp_row3) / sizeof (struct key), 7, swedish_lk401am_dp_row3 },
  { sizeof (swedish_lk401am_dp_row4) / sizeof (struct key), 7, swedish_lk401am_dp_row4 },
  { sizeof (swedish_lk401am_dp_row5) / sizeof (struct key), 7, swedish_lk401am_dp_row5 },
  { sizeof (swedish_lk401am_dp_row6) / sizeof (struct key), 7, swedish_lk401am_dp_row6 }
};

static struct keyboard swedish_lk401am_dp = {
  "LK401 (Svenska)",
  sizeof (swedish_lk401am_dp_rows) / sizeof (struct row),
  swedish_lk401am_dp_rows,
  6, 3, 3
};
