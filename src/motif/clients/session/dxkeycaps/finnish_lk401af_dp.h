 ...
 */
/*
 * @(#)$RCSfile: finnish_lk401af_dp.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:12:48 $
 */
...
static struct key finnish_lk401af_dp_row1 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key finnish_lk401af_dp_row2 [] = {
 {0,	0,	0,	5, 7},
...
static struct key finnish_lk401af_dp_row3 [] = {
 {0,	0,	0,		5, 7},
 ...
 {0xeb, 0, "O", 7, 7,	0,	XK_O},
 {0xf0, 0, "P", 7, 7,	0,	XK_P},
 {0xfa, "]", "}", 7, 7,	0,	XK_braceright, XK_bracketright},
 {0xf6, "^", "~", 7, 7,	0,	XK_asciitilde, XK_asciicircum},
 {0,	0,	0,		2, 7},
...
static struct key finnish_lk401af_dp_row4 [] = {
 ...
 {0xe7, 0, "K", 7, 7,	0,	XK_K},
 {0xec, 0, "L", 7, 7,	0,	XK_L},
 {0xf2, "\\", "|", 7, 7,	0,	XK_bar, XK_backslash},
 {0xfb, "[", "{", 7, 7,	0,	XK_braceleft, XK_bracketleft},
...
static struct key finnish_lk401af_dp_row5 [] = {
...
static struct key finnish_lk401af_dp_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row finnish_lk401af_dp_rows [] = {
  { sizeof (finnish_lk401af_dp_row1) / sizeof (struct key), 7, finnish_lk401af_dp_row1 },
  { 0, 7, 0 },
  { sizeof (finnish_lk401af_dp_row2) / sizeof (struct key), 7, finnish_lk401af_dp_row2 },
  { sizeof (finnish_lk401af_dp_row3) / sizeof (struct key), 7, finnish_lk401af_dp_row3 },
  { sizeof (finnish_lk401af_dp_row4) / sizeof (struct key), 7, finnish_lk401af_dp_row4 },
  { sizeof (finnish_lk401af_dp_row5) / sizeof (struct key), 7, finnish_lk401af_dp_row5 },
  { sizeof (finnish_lk401af_dp_row6) / sizeof (struct key), 7, finnish_lk401af_dp_row6 }
};

static struct keyboard finnish_lk401af_dp = {
  "LK401 (Suomi)",
  sizeof (finnish_lk401af_dp_rows) / sizeof (struct row),
  finnish_lk401af_dp_rows,
  6, 3, 3
};
