 ...
 */
/*
 * @(#)$RCSfile: lknorway.h,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1994/01/24 19:20:06 $
 */
...
static struct key lknorway_row1 [] = {
...
static struct key lknorway_row2 [] = {
 {0xbf, StrXK_section, "|", 8, 8,	0,	XK_bar, XK_section, XK_bar, XK_section},
 ...
 {0xf5, "`", "\\", 8, 8,	0,	XK_backslash, XK_grave, XK_acute},
/*DEL*/
...
static struct key lknorway_row3 [] = {
...
static struct key lknorway_row4 [] = {
 ...
 {0xe7, 0, "K", 8, 8,	0,	XK_K},
 {0xec, 0, "L", 8, 8,	0,	XK_L},
 {0xf2, StrXK_Ooblique, StrXK_oslash, 8, 8,	0,	XK_oslash, XK_Ooblique},
 {0xfb, StrXK_AE, StrXK_ae, 8, 8,	0,	XK_ae, XK_AE},
...
static struct key lknorway_row5 [] = {
...
static struct key lknorway_row6 [] = {
...
static struct row lknorway_rows [] = {
  { sizeof (lknorway_row1) / sizeof (struct key), 8, lknorway_row1 },
  { 0, 8, 0 },
  { sizeof (lknorway_row2) / sizeof (struct key), 8, lknorway_row2 },
  { sizeof (lknorway_row3) / sizeof (struct key), 8, lknorway_row3 },
  { sizeof (lknorway_row4) / sizeof (struct key), 8, lknorway_row4 },
  { sizeof (lknorway_row5) / sizeof (struct key), 8, lknorway_row5 },
  { sizeof (lknorway_row6) / sizeof (struct key), 8, lknorway_row6 },
};

static struct keyboard lknorway = {
  "LK444 (Norsk)",
  sizeof (lknorway_rows) / sizeof (struct row),
  lknorway_rows,
  6, 3, 3
};
