 ...
 */
/*
 * @(#)$RCSfile: swedish_lk201nm_tw.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:24:54 $
 */
...
static struct key swedish_lk201nm_tw_row0 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key swedish_lk201nm_tw_row2 [] = {
 {0,	0,	0,	5, 7},
 {0xbf, StrXK_degree, "~", 7, 7,	0,	XK_asciitilde, XK_degree},
 ...
 {0xf5, "`", "^", 7, 7,	0,	XK_asciicircum, XK_grave},
/*DEL*/
...
static struct key swedish_lk201nm_tw_row3 [] = {
 {0,	0,	0,		5, 7},
 ...
 {0xf6, 0, StrXK_Udiaeresis, 7, 7,	0,	XK_Udiaeresis},
 {0,	0,	0,		2, 7},
...
static struct key swedish_lk201nm_tw_row4 [] = {
...
static struct key swedish_lk201nm_tw_row5 [] = {
...
static struct key swedish_lk201nm_tw_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row swedish_lk201nm_tw_rows [] = {
  { sizeof (swedish_lk201nm_tw_row0) / sizeof (struct key), 7, swedish_lk201nm_tw_row0 },
  { 0, 7, 0 },
  { sizeof (swedish_lk201nm_tw_row2) / sizeof (struct key), 7, swedish_lk201nm_tw_row2 },
  { sizeof (swedish_lk201nm_tw_row3) / sizeof (struct key), 7, swedish_lk201nm_tw_row3 },
  { sizeof (swedish_lk201nm_tw_row4) / sizeof (struct key), 7, swedish_lk201nm_tw_row4 },
  { sizeof (swedish_lk201nm_tw_row5) / sizeof (struct key), 7, swedish_lk201nm_tw_row5 },
  { sizeof (swedish_lk201nm_tw_row6) / sizeof (struct key), 7, swedish_lk201nm_tw_row6 }
};

static struct keyboard swedish_lk201nm_tw = {
  "LK201 (Svenska)",
  sizeof (swedish_lk201nm_tw_rows) / sizeof (struct row),
  swedish_lk201nm_tw_rows,
  6, 3, 3
};
