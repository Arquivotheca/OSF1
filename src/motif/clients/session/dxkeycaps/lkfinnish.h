 ...
 */
/*
 * @(#)$RCSfile: lkfinnish.h,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1994/01/24 19:19:40 $
 */
...
static struct key lkfinnish_row1 [] = {
...
static struct key lkfinnish_row2 [] = {
...
static struct key lkfinnish_row3 [] = {
...
static struct key lkfinnish_row4 [] = {
...
static struct key lkfinnish_row5 [] = {
...
static struct key lkfinnish_row6 [] = {
...
static struct row lkfinnish_rows [] = {
  { sizeof (lkfinnish_row1) / sizeof (struct key), 8, lkfinnish_row1 },
  { 0, 8, 0 },
  { sizeof (lkfinnish_row2) / sizeof (struct key), 8, lkfinnish_row2 },
  { sizeof (lkfinnish_row3) / sizeof (struct key), 8, lkfinnish_row3 },
  { sizeof (lkfinnish_row4) / sizeof (struct key), 8, lkfinnish_row4 },
  { sizeof (lkfinnish_row5) / sizeof (struct key), 8, lkfinnish_row5 },
  { sizeof (lkfinnish_row6) / sizeof (struct key), 8, lkfinnish_row6 },
};

static struct keyboard lkfinnish = {
  "LK444 (Suomi)",
  sizeof (lkfinnish_rows) / sizeof (struct row),
  lkfinnish_rows,
  6, 3, 3
};
