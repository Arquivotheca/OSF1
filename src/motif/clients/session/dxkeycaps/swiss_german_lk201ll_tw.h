 ...
 */
/*
 * @(#)$RCSfile: swiss_german_lk201ll_tw.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:26:43 $
 */
...
static struct key swiss_german_lk201ll_tw_row0 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key swiss_german_lk201ll_tw_row2 [] = {
 {0,	0,	0,	5, 7},
...
static struct key swiss_german_lk201ll_tw_row3 [] = {
 {0,	0,	0,		5, 7},
 ...
 {0xeb, 0, "O", 7, 7,	0,	XK_O},
 {0xf0, 0, "P", 7, 7,	0,	XK_P},
 {0xfa, StrXK_egrave, StrXK_udiaeresis, 7, 7,	0,	XK_udiaeresis, XK_egrave},
...
static struct key swiss_german_lk201ll_tw_row4 [] = {
 ...
 {0xe7, 0, "K", 7, 7,	0,	XK_K},
 {0xec, 0, "L", 7, 7,	0,	XK_L},
 {0xf2, StrXK_eacute, StrXK_odiaeresis, 7, 7,	0,	XK_odiaeresis, XK_eacute},
 {0xfb, StrXK_agrave, StrXK_adiaeresis, 7, 7,	0,	XK_adiaeresis, XK_agrave},
...
static struct key swiss_german_lk201ll_tw_row5 [] = {
...
static struct key swiss_german_lk201ll_tw_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row swiss_german_lk201ll_tw_rows [] = {
  { sizeof (swiss_german_lk201ll_tw_row0) / sizeof (struct key), 7, swiss_german_lk201ll_tw_row0 },
  { 0, 7, 0 },
  { sizeof (swiss_german_lk201ll_tw_row2) / sizeof (struct key), 7, swiss_german_lk201ll_tw_row2 },
  { sizeof (swiss_german_lk201ll_tw_row3) / sizeof (struct key), 7, swiss_german_lk201ll_tw_row3 },
  { sizeof (swiss_german_lk201ll_tw_row4) / sizeof (struct key), 7, swiss_german_lk201ll_tw_row4 },
  { sizeof (swiss_german_lk201ll_tw_row5) / sizeof (struct key), 7, swiss_german_lk201ll_tw_row5 },
  { sizeof (swiss_german_lk201ll_tw_row6) / sizeof (struct key), 7, swiss_german_lk201ll_tw_row6 }
};

static struct keyboard swiss_german_lk201ll_tw = {
  "LK201 (Schweiz)",
  sizeof (swiss_german_lk201ll_tw_rows) / sizeof (struct row),
  swiss_german_lk201ll_tw_rows,
  6, 3, 3
};
