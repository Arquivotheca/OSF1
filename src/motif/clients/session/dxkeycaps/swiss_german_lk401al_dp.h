 ...
 */
/*
 * @(#)$RCSfile: swiss_german_lk401al_dp.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:27:00 $
 */
...
static struct key swiss_german_lk401al_dp_row1 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key swiss_german_lk401al_dp_row2 [] = {
 {0,	0,	0,	5, 7},
...
static struct key swiss_german_lk401al_dp_row3 [] = {
 {0,	0,	0,		5, 7},
 ...
 {0xeb, 0, "O", 7, 7,	0,	XK_O},
 {0xf0, 0, "P", 7, 7,	0,	XK_P},
 {0xfa, "\\", "|", 7, 7,	0,	XK_bar, XK_backslash},
...
static struct key swiss_german_lk401al_dp_row4 [] = {
 ...
 {0xe7, 0, "K", 7, 7,	0,	XK_K},
 {0xec, 0, "L", 7, 7,	0,	XK_L},
 {0xf2, "[", "{", 7, 7,	0,	XK_braceleft, XK_bracketleft},
 {0xfb, "]", "}", 7, 7,	0,	XK_braceright, XK_bracketright},
 {0xf7, "#", "$", 7, 7,	0,	XK_dollar, XK_numbersign},
 {0,	0,	0,		24, 7},
/*LEFT*/
 {170,	0, 0,		8, 7,	0,	XK_Up},
 {0,	0,	0,		15, 7},
...
static struct key swiss_german_lk401al_dp_row5 [] = {
...
static struct key swiss_german_lk401al_dp_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row swiss_german_lk401al_dp_rows [] = {
  { sizeof (swiss_german_lk401al_dp_row1) / sizeof (struct key), 7, swiss_german_lk401al_dp_row1 },
  { 0, 7, 0 },
  { sizeof (swiss_german_lk401al_dp_row2) / sizeof (struct key), 7, swiss_german_lk401al_dp_row2 },
  { sizeof (swiss_german_lk401al_dp_row3) / sizeof (struct key), 7, swiss_german_lk401al_dp_row3 },
  { sizeof (swiss_german_lk401al_dp_row4) / sizeof (struct key), 7, swiss_german_lk401al_dp_row4 },
  { sizeof (swiss_german_lk401al_dp_row5) / sizeof (struct key), 7, swiss_german_lk401al_dp_row5 },
  { sizeof (swiss_german_lk401al_dp_row6) / sizeof (struct key), 7, swiss_german_lk401al_dp_row6 }
};

static struct keyboard swiss_german_lk401al_dp = {
  "LK401 (Schweiz)",
  sizeof (swiss_german_lk401al_dp_rows) / sizeof (struct row),
  swiss_german_lk401al_dp_rows,
  6, 3, 3
};
