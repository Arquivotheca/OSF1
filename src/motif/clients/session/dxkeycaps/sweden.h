 ...
 */
/*
 * @(#)$RCSfile: sweden.h,v $ $Revision: 1.1.4.6 $ (DEC) $Date: 1994/01/24 19:21:02 $
 */
...
static struct key sweden_row2 [] = {
 {0xe, StrXK_onehalf, StrXK_section, 8, 8,	0,	XK_section, XK_onehalf},
...
static struct key sweden_row4 [] = {
 ...
 {0x42, 0, "K", 8, 8,	0,	XK_K},
 {0x4b, 0, "L", 8, 8,	0,	XK_L},
 {0x4c, StrXK_oslash, StrXK_Ooblique, 8, 8,	0,	XK_Ooblique, XK_oslash},
...
static struct row sweden_rows [] = {
  { sizeof (sweden_row1) / sizeof (struct key), 8, sweden_row1 },
  { 0, 8, 0 },
  { sizeof (sweden_row2) / sizeof (struct key), 8, sweden_row2 },
  { sizeof (sweden_row3) / sizeof (struct key), 8, sweden_row3 },
  { sizeof (sweden_row4) / sizeof (struct key), 8, sweden_row4 },
  { sizeof (sweden_row5) / sizeof (struct key), 8, sweden_row5 },
  { sizeof (sweden_row6) / sizeof (struct key), 8, sweden_row6 },
};

static struct keyboard sweden = {
  "PCXAL (Svenska)",
  sizeof (sweden_rows) / sizeof (struct row),
  sweden_rows,
  6, 3, 3
};
