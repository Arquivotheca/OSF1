 ...
 */
/*
 * @(#)$RCSfile: lkswiss_french.h,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1994/01/24 19:20:20 $
 */
...
static struct key lkswiss_french_row1 [] = {
...
static struct key lkswiss_french_row2 [] = {
 {0xbf, StrXK_degree, StrXK_section, 8, 8,	0,	XK_section, XK_degree, XK_section, XK_degree},
 {0xc0, "+", "1", 8, 8,	0,	XK_1, XK_plus, XK_bar},
 {0xc5, "\"", "2",8, 8,	0,	XK_2, XK_quotedbl, XK_at},
 {0xcb, "*", "3", 8, 8,	0,	XK_3, XK_asterisk, XK_numbersign},
 {0xd0, StrXK_ccedilla, "4", 8, 8,	0,	XK_4, XK_ccedilla},
 {0xd6, "", "5", 8, 8,	0,	XK_5, XK_percent},
 {0xdb, "&", "6", 8, 8,	0,	XK_6, XK_ampersand, XK_notsign},
 {0xe0, "/", "7", 8, 8,	0,	XK_7, XK_slash, XK_brokenbar},
 {0xe5, "(", "8", 8, 8,	0,	XK_8, XK_parenleft, XK_cent},
 {0xea, ")", "9", 8, 8,	0,	XK_9, XK_parenright},
 {0xef, "=", "0", 8, 8,	0,	XK_0, XK_equal},
 {0xf9, "?", "'", 8, 8,	0,	XK_apostrophe, XK_question, XK_acute},
 {0xf5, "`", "^", 8, 8,	0,	XK_asciicircum, XK_grave, XK_asciitilde},
/*DEL*/
...
static struct key lkswiss_french_row3 [] = {
 ...
 {0xeb, 0, "O", 8, 8,	0,	XK_O},
 {0xf0, 0, "P", 8, 8,	0,	XK_P},
 {0xfa, StrXK_udiaeresis, StrXK_egrave, 8, 8,	0,	XK_egrave, XK_udiaeresis, XK_bracketleft},
 {0xf6, "!", StrXK_diaeresis, 8, 8,	0,	XK_diaeresis, XK_exclam, XK_bracketright},
 {0,    0,  0, 	2, 7},
...
static struct key lkswiss_french_row4 [] = {
 ...
 {0xe7, 0, "K", 8, 8,	0,	XK_K},
 {0xec, 0, "L", 8, 8,	0,	XK_L},
 {0xf2, StrXK_odiaeresis, StrXK_eacute, 8, 8,	0,	XK_eacute, XK_odiaeresis},
 {0xfb, StrXK_adiaeresis, StrXK_agrave, 8, 8,	0,	XK_agrave, XK_adiaeresis, XK_braceleft},
 {0xf7, StrXK_sterling, "$", 8, 8,	0,	XK_dollar, XK_sterling, XK_braceright},
 {0,    0,  0, 42, 7},
/*LEFT*/
...
static struct key lkswiss_french_row5 [] = {
...
static struct key lkswiss_french_row6 [] = {
...
static struct row lkswiss_french_rows [] = {
  { sizeof (lkswiss_french_row1) / sizeof (struct key), 8, lkswiss_french_row1 },
  { 0, 8, 0 },
  { sizeof (lkswiss_french_row2) / sizeof (struct key), 8, lkswiss_french_row2 },
  { sizeof (lkswiss_french_row3) / sizeof (struct key), 8, lkswiss_french_row3 },
  { sizeof (lkswiss_french_row4) / sizeof (struct key), 8, lkswiss_french_row4 },
  { sizeof (lkswiss_french_row5) / sizeof (struct key), 8, lkswiss_french_row5 },
  { sizeof (lkswiss_french_row6) / sizeof (struct key), 8, lkswiss_french_row6 },
};

static struct keyboard lkswiss_french = {
  "LK444 (SuisseRomande)",
  sizeof (lkswiss_french_rows) / sizeof (struct row),
  lkswiss_french_rows,
  6, 3, 3
};
