 ...
 */
/*
 * @(#)$RCSfile: swiss_german.h,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1994/01/24 19:21:06 $
 */
/* 
...
static struct key swiss_german_row1 [] = {
...
static struct key swiss_german_row2 [] = {
...
static struct key swiss_german_row3 [] = {
...
static struct key swiss_german_row4 [] = {
...
static struct key swiss_german_row5 [] = {
...
static struct key swiss_german_row6 [] = {
...
static struct row swiss_german_rows [] = {
  { sizeof (swiss_german_row1) / sizeof (struct key), 8, swiss_german_row1 },
  { 0, 8, 0 },
  { sizeof (swiss_german_row2) / sizeof (struct key), 8, swiss_german_row2 },
  { sizeof (swiss_german_row3) / sizeof (struct key), 8, swiss_german_row3 },
  { sizeof (swiss_german_row4) / sizeof (struct key), 8, swiss_german_row4 },
  { sizeof (swiss_german_row5) / sizeof (struct key), 8, swiss_german_row5 },
  { sizeof (swiss_german_row6) / sizeof (struct key), 8, swiss_german_row6 },
};

static struct keyboard swiss_german = {
  "PCXAL (Schweiz)",
  sizeof (swiss_german_rows) / sizeof (struct row),
  swiss_german_rows,
  6, 3, 3
};
