 ...
 */
/*
 * @(#)$RCSfile: lksweden.h,v $ $Revision: 1.1.4.4 $ (DEC) $Date: 1994/01/24 19:20:16 $
 */
...
static struct key lksweden_row1 [] = {
...
static struct key lksweden_row2 [] = {
 {0xbf, StrXK_onehalf, StrXK_section, 8, 8,	0,	XK_section, XK_onehalf, XK_section, XK_onehalf},
 ...
 {0xf9, "?", "+", 8, 8,	0,	XK_plus, XK_question, XK_backslash},
...
static struct key lksweden_row3 [] = {
...
static struct key lksweden_row4 [] = {
 ...
 {0xe7, 0, "K", 8, 8,	0,	XK_K},
 {0xec, 0, "L", 8, 8,	0,	XK_L},
 {0xf2, StrXK_oslash, StrXK_Ooblique, 8, 8,	0,	XK_Ooblique, XK_oslash},
...
static struct key lksweden_row5 [] = {
...
static struct key lksweden_row6 [] = {
...
static struct row lksweden_rows [] = {
  { sizeof (lksweden_row1) / sizeof (struct key), 8, lksweden_row1 },
  { 0, 8, 0 },
  { sizeof (lksweden_row2) / sizeof (struct key), 8, lksweden_row2 },
  { sizeof (lksweden_row3) / sizeof (struct key), 8, lksweden_row3 },
  { sizeof (lksweden_row4) / sizeof (struct key), 8, lksweden_row4 },
  { sizeof (lksweden_row5) / sizeof (struct key), 8, lksweden_row5 },
  { sizeof (lksweden_row6) / sizeof (struct key), 8, lksweden_row6 },
};

static struct keyboard lksweden = {
  "LK444 (Svenska)",
  sizeof (lksweden_rows) / sizeof (struct row),
  lksweden_rows,
  6, 3, 3
};
