 ...
 */
/*
 * @(#)$RCSfile: germany.h,v $ $Revision: 1.1.4.6 $ (DEC) $Date: 1994/01/24 19:19:09 $
 */
...
static struct key germany_row1 [] = {
...
static struct key germany_row2 [] = {
 {0xe, StrXK_degree, "^", 8, 8,	0,	XK_asciicircum, XK_degree},
 {0x16, "!", "1", 8, 8,	0,	XK_1, XK_exclam},
 {0x1e, "\"", "2", 8, 8,	0,	XK_2, XK_quotedbl, XK_twosuperior},
 {0x26, StrXK_sterling, "3", 8, 8,	0,	XK_3, XK_sterling, XK_threesuperior},
 ...
 {0x4e, "?", StrXK_ssharp, 8, 8,	0,	XK_ssharp, XK_question, XK_backslash},
...
static struct key germany_row3 [] = {
 {0x0d,	"Tab",	0,		12, 8,	0,	XK_Tab},
 {0x15, "Q", "q", 8, 8,	0,	XK_q, XK_Q, XK_at},
 {0x1d, 0, "W", 8, 8,	0,	XK_W},
 {0x24, 0, "E", 8, 8,	0,	XK_E},
 {0x2d, 0, "R", 8, 8,	0,	XK_R},
 {0x2c, 0, "T", 8, 8,	0,	XK_T},
 ...
 {0x44, 0, "O", 8, 8,	0,	XK_O},
 {0x4d, 0, "P", 8, 8,	0,	XK_P},
 {0x54, StrXK_Udiaeresis, StrXK_udiaeresis, 8, 8,	0,	XK_udiaeresis, XK_Udiaeresis},
 {0x5b, "*", "+", 8, 8,	0,	XK_plus, XK_asterisk, XK_asciitilde},
 {0,    0,  0,      	2, 7},
...
static struct key germany_row4 [] = {
 ...
 {0x53, "'", "#", 8, 8,	0,	XK_numbersign, XK_apostrophe},
 {0,	0,	0,			42,7},
...
static struct key germany_row5 [] = {
 {0x12,	"Shift",0,		10, 8,	ShiftMask,	XK_Shift_L},
 {0x13, ">", "<", 8, 8,	0,		XK_less, XK_greater, XK_bar},
 {0x1a, 0, "Y", 8, 8,	0,		XK_Y},
 {0x22, 0, "X", 8, 8,	0,		XK_X},
 {0x21, 0, "C", 8, 8,	0,		XK_C},
 {0x2a, 0, "V", 8, 8,	0,		XK_V},
...
static struct key germany_row6 [] = {
...
static struct row germany_rows [] = {
  { sizeof (germany_row1) / sizeof (struct key), 8, germany_row1 },
  { 0, 8, 0 },
  { sizeof (germany_row2) / sizeof (struct key), 8, germany_row2 },
  { sizeof (germany_row3) / sizeof (struct key), 8, germany_row3 },
  { sizeof (germany_row4) / sizeof (struct key), 8, germany_row4 },
  { sizeof (germany_row5) / sizeof (struct key), 8, germany_row5 },
  { sizeof (germany_row6) / sizeof (struct key), 8, germany_row6 },
};

static struct keyboard germany = {
  "PCXAL (Deutsch)",
  sizeof (germany_rows) / sizeof (struct row),
  germany_rows,
  6, 3, 3
};
