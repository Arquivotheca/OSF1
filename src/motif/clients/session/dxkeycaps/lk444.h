 ...
 */
/*
 * @(#)$RCSfile: lk444.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/08/02 20:31:48 $
 */
...
static struct key lk444_row4 [] = {
 ...
 {0x52, "\"", "'", 8, 8,	0,	XK_quoteright, XK_quotedbl},
...
static struct row lk444_rows [] = {
  { sizeof (lk444_row1) / sizeof (struct key), 8, lk444_row1 },
  { 0, 8, 0 },
  { sizeof (lk444_row2) / sizeof (struct key), 8, lk444_row2 },
  { sizeof (lk444_row3) / sizeof (struct key), 8, lk444_row3 },
  { sizeof (lk444_row4) / sizeof (struct key), 8, lk444_row4 },
  { sizeof (lk444_row5) / sizeof (struct key), 8, lk444_row5 },
  { sizeof (lk444_row6) / sizeof (struct key), 8, lk444_row6 },
};

static struct keyboard lk444 = {
  "LK444",
  sizeof (lk444_rows) / sizeof (struct row),
  lk444_rows,
  6, 3, 3
};
