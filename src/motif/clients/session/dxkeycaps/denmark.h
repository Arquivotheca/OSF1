 ...
 */
/*
 * @(#)$RCSfile: denmark.h,v $ $Revision: 1.1.4.6 $ (DEC) $Date: 1994/01/24 19:18:31 $
 */
...
static struct key denmark_row1 [] = {
...
static struct key denmark_row2 [] = {
 {0xe, StrXK_section, StrXK_onehalf, 8, 8,	0,	XK_onehalf, XK_section},
 ...
 {0x55, "`", StrXK_acute, 8, 8,	0,	XK_acute, XK_grave, XK_bar},
...
static struct key denmark_row3 [] = {
...
static struct key denmark_row4 [] = {
 ...
 {0x42, 0, "K", 8, 8,	0,	XK_K},
 {0x4b, 0, "L", 8, 8,	0,	XK_L},
 {0x4c, StrXK_AE, StrXK_ae, 8, 8,	0,	XK_ae, XK_AE},
 {0x52, StrXK_oslash, StrXK_Ooblique, 8, 8,	0,	XK_Ooblique, XK_oslash},
...
static struct key denmark_row5 [] = {
...
static struct key denmark_row6 [] = {
...
static struct row denmark_rows [] = {
  { sizeof (denmark_row1) / sizeof (struct key), 8, denmark_row1 },
  { 0, 8, 0 },
  { sizeof (denmark_row2) / sizeof (struct key), 8, denmark_row2 },
  { sizeof (denmark_row3) / sizeof (struct key), 8, denmark_row3 },
  { sizeof (denmark_row4) / sizeof (struct key), 8, denmark_row4 },
  { sizeof (denmark_row5) / sizeof (struct key), 8, denmark_row5 },
  { sizeof (denmark_row6) / sizeof (struct key), 8, denmark_row6 },
};

static struct keyboard denmark = {
  "PCXAL (Dansk)",
  sizeof (denmark_rows) / sizeof (struct row),
  denmark_rows,
  6, 3, 3
};
