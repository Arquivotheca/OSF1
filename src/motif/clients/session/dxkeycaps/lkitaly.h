 ...
 */
/*
 * @(#)$RCSfile: lkitaly.h,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1994/01/24 19:19:56 $
 */
...
static struct key lkitaly_row1 [] = {
...
static struct key lkitaly_row2 [] = {
 {0xbf, "|", "\\", 8, 8,	0,	XK_backslash, XK_bar, XK_backslash, XK_bar},
 {0xc0, "!", "1", 8, 8,	0,	XK_1, XK_exclam},
 {0xc5, "\"", "2",8, 8,	0,	XK_2, XK_quotedbl},
 {0xcb, StrXK_sterling, "3", 8, 8,	0,	XK_3, XK_sterling},
 ...
 {0xf5, StrXK_igrave, "=", 8, 8,	0,	XK_equal, XK_igrave},
/*DEL*/
...
static struct key lkitaly_row3 [] = {
 ...
 {0xeb, 0, "O", 8, 8,	0,	XK_O},
 {0xf0, 0, "P", 8, 8,	0,	XK_P},
 {0xfa, StrXK_eacute, StrXK_egrave, 8, 8,	0,	XK_egrave, XK_eacute, XK_bracketleft},
...
static struct key lkitaly_row4 [] = {
 ...
 {0xe7, 0, "K", 8, 8,	0,	XK_K},
 {0xec, 0, "L", 8, 8,	0,	XK_L},
 {0xf2, StrXK_ccedilla, StrXK_ograve, 8, 8,	0,	XK_ograve, XK_ccedilla, XK_at},
 {0xfb, StrXK_degree, StrXK_agrave, 8, 8,	0,	XK_agrave, XK_degree, XK_numbersign},
 {0xf7, StrXK_section, StrXK_ugrave, 8, 8,	0,	XK_ugrave, XK_section},
 {0,    0,  0, 42, 7},
/*LEFT*/
...
static struct key lkitaly_row5 [] = {
...
static struct key lkitaly_row6 [] = {
...
static struct row lkitaly_rows [] = {
  { sizeof (lkitaly_row1) / sizeof (struct key), 8, lkitaly_row1 },
  { 0, 8, 0 },
  { sizeof (lkitaly_row2) / sizeof (struct key), 8, lkitaly_row2 },
  { sizeof (lkitaly_row3) / sizeof (struct key), 8, lkitaly_row3 },
  { sizeof (lkitaly_row4) / sizeof (struct key), 8, lkitaly_row4 },
  { sizeof (lkitaly_row5) / sizeof (struct key), 8, lkitaly_row5 },
  { sizeof (lkitaly_row6) / sizeof (struct key), 8, lkitaly_row6 },
};

static struct keyboard lkitaly = {
  "LK444 (Italiano)",
  sizeof (lkitaly_rows) / sizeof (struct row),
  lkitaly_rows,
  6, 3, 3
};
