 ...
 */
/*
 * @(#)$RCSfile: spanish_lk201ls_tw.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:23:50 $
 */
...
static struct key spanish_lk201ls_tw_row0 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key spanish_lk201ls_tw_row2 [] = {
 {0,	0,	0,	5, 7},
 {0xbf, StrXK_exclamdown, StrXK_questiondown, 7, 7,	0,	XK_questiondown, XK_exclamdown},
 ...
 {0xf5, StrXK_ordfeminine, StrXK_masculine, 7, 7,	0,	XK_masculine, XK_ordfeminine},
/*DEL*/
...
static struct key spanish_lk201ls_tw_row3 [] = {
 {0,	0,	0,		5, 7},
...
static struct key spanish_lk201ls_tw_row4 [] = {
 ...
 {0xe7, 0, "K", 7, 7,	0,	XK_K},
 {0xec, 0, "L", 7, 7,	0,	XK_L},
 {0xf2, 0, StrXK_Ntilde, 7, 7,	0,	XK_Ntilde},
 {251,	0,	0,		7, 7,	0,	XK_apostrophe,	XK_quotedbl},
 {0xf7, "~", StrXK_ccedilla, 7, 7,	0,	XK_ccedilla, DXK_tilde},
 {0,	0,	0,		24, 7},
/*LEFT*/
 {170,	0, 0,		8, 7,	0,	XK_Up},
 {0,	0,	0,		15, 7},
...
static struct key spanish_lk201ls_tw_row5 [] = {
...
static struct key spanish_lk201ls_tw_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row spanish_lk201ls_tw_rows [] = {
  { sizeof (spanish_lk201ls_tw_row0) / sizeof (struct key), 7, spanish_lk201ls_tw_row0 },
  { 0, 7, 0 },
  { sizeof (spanish_lk201ls_tw_row2) / sizeof (struct key), 7, spanish_lk201ls_tw_row2 },
  { sizeof (spanish_lk201ls_tw_row3) / sizeof (struct key), 7, spanish_lk201ls_tw_row3 },
  { sizeof (spanish_lk201ls_tw_row4) / sizeof (struct key), 7, spanish_lk201ls_tw_row4 },
  { sizeof (spanish_lk201ls_tw_row5) / sizeof (struct key), 7, spanish_lk201ls_tw_row5 },
  { sizeof (spanish_lk201ls_tw_row6) / sizeof (struct key), 7, spanish_lk201ls_tw_row6 }
};

static struct keyboard spanish_lk201ls_tw = {
  "LK201 (Espanol)",
  sizeof (spanish_lk201ls_tw_rows) / sizeof (struct row),
  spanish_lk201ls_tw_rows,
  6, 3, 3
};
