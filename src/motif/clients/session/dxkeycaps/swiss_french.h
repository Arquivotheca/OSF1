 ...
 */
/*
 * @(#)$RCSfile: swiss_french.h,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1994/01/24 19:21:04 $
 */
/* 
...
static struct key swiss_french_row1 [] = {
...
static struct key swiss_french_row2 [] = {
 {0xe, StrXK_degree, StrXK_section, 8, 8,	0,	XK_section, XK_degree, XK_section, XK_degree},
 ...
 {0x4e, "?", "'", 8, 8,	0,	XK_apostrophe, XK_question, XK_acute},
...
static struct key swiss_french_row3 [] = {
 ...
 {0x44, 0, "O", 8, 	8,	0,	XK_O},
 {0x4d, 0, "P", 8, 	8,	0,	XK_P},
 {0x54, StrXK_udiaeresis, StrXK_egrave, 8,	8,	0,	XK_egrave, XK_udiaeresis, XK_bracketleft},
...
static struct key swiss_french_row4 [] = {
 ...
 {0x42, 0, "K", 8, 	8,	0,	XK_K},
 {0x4b, 0, "L", 8, 	8,	0,	XK_L},
 {0x4c, StrXK_odiaeresis, StrXK_eacute, 8,	8,	0,	XK_eacute, XK_odiaeresis},
 {0x52, StrXK_adiaeresis, StrXK_agrave, 8,	8,	0,	XK_agrave, XK_adiaeresis, XK_braceleft},
...
static struct key swiss_french_row5 [] = {
...
static struct key swiss_french_row6 [] = {
...
static struct row swiss_french_rows [] = {
  { sizeof (swiss_french_row1) / sizeof (struct key), 8, swiss_french_row1 },
  { 0, 8, 0 },
  { sizeof (swiss_french_row2) / sizeof (struct key), 8, swiss_french_row2 },
  { sizeof (swiss_french_row3) / sizeof (struct key), 8, swiss_french_row3 },
  { sizeof (swiss_french_row4) / sizeof (struct key), 8, swiss_french_row4 },
  { sizeof (swiss_french_row5) / sizeof (struct key), 8, swiss_french_row5 },
  { sizeof (swiss_french_row6) / sizeof (struct key), 8, swiss_french_row6 },
};

static struct keyboard swiss_french = {
  "PCXAL (SuisseRomande)",
  sizeof (swiss_french_rows) / sizeof (struct row),
  swiss_french_rows,
  6, 3, 3
};
