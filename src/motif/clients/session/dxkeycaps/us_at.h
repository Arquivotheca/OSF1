 ...
 */
/*
 * @(#)$RCSfile: us_at.h,v $ $Revision: 1.1.4.4 $ (DEC) $Date: 1993/12/20 17:48:55 $
 */
...
static struct row us_at_rows [] = {
  { sizeof (us_at_row1) / sizeof (struct key), 8, us_at_row1 },
  { 0, 8, 0 },
  { sizeof (us_at_row2) / sizeof (struct key), 8, us_at_row2 },
  { sizeof (us_at_row3) / sizeof (struct key), 8, us_at_row3 },
  { sizeof (us_at_row4) / sizeof (struct key), 8, us_at_row4 },
  { sizeof (us_at_row5) / sizeof (struct key), 8, us_at_row5 },
  { sizeof (us_at_row6) / sizeof (struct key), 8, us_at_row6 },
};

static struct keyboard us_at = {
  "PCXAL (American)",
  sizeof (us_at_rows) / sizeof (struct row),
  us_at_rows,
  6, 3, 3
};
