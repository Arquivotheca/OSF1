 ...
 */
/*
 * @(#)$RCSfile: icelandic_lk201lu_tw.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:14:14 $
 */
...
static struct key icelandic_lk201lu_tw_row0 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key icelandic_lk201lu_tw_row2 [] = {
 {0,	0,	0,	5, 7},
 ...
 {0xf9, 0, StrXK_Odiaeresis, 7, 7,	0,	XK_Odiaeresis},
...
static struct key icelandic_lk201lu_tw_row3 [] = {
 {0,	0,	0,		5, 7},
 ...
 {0xeb, 0, "O", 7, 7,	0,	XK_O},
 {0xf0, 0, "P", 7, 7,	0,	XK_P},
 {0xfa, 0, StrXK_ETH, 7, 7,	0,	XK_ETH},
 {0xf6, "?", "'", 7, 7,	0,	XK_apostrophe, XK_question},
 {0,	0,	0,		2, 7},
...
static struct key icelandic_lk201lu_tw_row4 [] = {
 ...
 {0xe7, 0, "K", 7, 7,	0,	XK_K},
 {0xec, 0, "L", 7, 7,	0,	XK_L},
 {0xf2, 0, StrXK_AE, 7, 7,	0,	XK_AE},
 {251,	0,	0,		7, 7,	0,	XK_apostrophe,	XK_quotedbl},
 {0xf7, "*", "+", 7, 7,	0,	XK_plus, XK_asterisk},
 {0,	0,	0,		24, 7},
/*LEFT*/
 {170,	0, 0,		8, 7,	0,	XK_Up},
 {0,	0,	0,		15, 7},
...
static struct key icelandic_lk201lu_tw_row5 [] = {
 ...
 {0xf3, 0, StrXK_THORN, 7, 7,	0,	XK_THORN},
/*SHIFT*/
...
static struct key icelandic_lk201lu_tw_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row icelandic_lk201lu_tw_rows [] = {
  { sizeof (icelandic_lk201lu_tw_row0) / sizeof (struct key), 7, icelandic_lk201lu_tw_row0 },
  { 0, 7, 0 },
  { sizeof (icelandic_lk201lu_tw_row2) / sizeof (struct key), 7, icelandic_lk201lu_tw_row2 },
  { sizeof (icelandic_lk201lu_tw_row3) / sizeof (struct key), 7, icelandic_lk201lu_tw_row3 },
  { sizeof (icelandic_lk201lu_tw_row4) / sizeof (struct key), 7, icelandic_lk201lu_tw_row4 },
  { sizeof (icelandic_lk201lu_tw_row5) / sizeof (struct key), 7, icelandic_lk201lu_tw_row5 },
  { sizeof (icelandic_lk201lu_tw_row6) / sizeof (struct key), 7, icelandic_lk201lu_tw_row6 }
};

static struct keyboard icelandic_lk201lu_tw = {
  "LK201 (Suomi)",
  sizeof (icelandic_lk201lu_tw_rows) / sizeof (struct row),
  icelandic_lk201lu_tw_rows,
  6, 3, 3
};
