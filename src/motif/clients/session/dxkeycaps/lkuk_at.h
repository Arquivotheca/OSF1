 ...
 */
/*
 * @(#)$RCSfile: lkuk_at.h,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1994/01/24 19:20:32 $
 */
...
static struct key lkuk_at_row1 [] = {
...
static struct key lkuk_at_row2 [] = {
 {0xbf, StrXK_notsign, "`", 8, 8,	0,	XK_grave, XK_notsign, XK_bar, XK_bar},
...
static struct key lkuk_at_row3 [] = {
...
static struct key lkuk_at_row4 [] = {
 ...
 {0xfb, "@", "'", 8, 8,	0,	XK_quoteright, XK_at},
 {0xf7, "~", "#", 8, 8,	0,	XK_numbersign, XK_asciitilde},
 {0,    0,  0, 42, 7},
/*LEFT*/
...
static struct key lkuk_at_row5 [] = {
 {0xae, 0, 0, 10, 8,	ShiftMask,	XK_Shift_L},
 {0xc9, "|", "\\", 8, 	8,   0,      XK_backslash, XK_bar},
 {0xc3, 0, "Z", 8, 	8,	0,		XK_Z},
 {0xc8, 0, "X", 8, 	8,	0,		XK_X},
 {0xce, 0, "C", 8, 	8,	0,		XK_C},
 {0xd3, 0, "V", 8, 	8,	0,		XK_V},
...
static struct key lkuk_at_row6 [] = {
...
static struct row lkuk_at_rows [] = {
  { sizeof (lkuk_at_row1) / sizeof (struct key), 8, lkuk_at_row1 },
  { 0, 8, 0 },
  { sizeof (lkuk_at_row2) / sizeof (struct key), 8, lkuk_at_row2 },
  { sizeof (lkuk_at_row3) / sizeof (struct key), 8, lkuk_at_row3 },
  { sizeof (lkuk_at_row4) / sizeof (struct key), 8, lkuk_at_row4 },
  { sizeof (lkuk_at_row5) / sizeof (struct key), 8, lkuk_at_row5 },
  { sizeof (lkuk_at_row6) / sizeof (struct key), 8, lkuk_at_row6 },
};

static struct keyboard lkuk_at = {
  "LK444 (British/Irish)",
  sizeof (lkuk_at_rows) / sizeof (struct row),
  lkuk_at_rows,
  6, 3, 3
};
