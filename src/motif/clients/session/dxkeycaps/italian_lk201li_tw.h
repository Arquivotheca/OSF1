 ...
 */
/*
 * @(#)$RCSfile: italian_lk201li_tw.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:14:24 $
 */
...
static struct key italian_lk201li_tw_row0 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key italian_lk201li_tw_row2 [] = {
 {0,	0,	0,	5, 7},
 {191,	0,	0,	7, 7,	0,	XK_grave,	XK_asciitilde},
 {0xc0, "1", StrXK_sterling, 7, 7,	0,	XK_sterling, XK_1},
...
static struct key italian_lk201li_tw_row3 [] = {
 {0,	0,	0,		5, 7},
 ...
 {0xeb, 0, "O", 7, 7,	0,	XK_O},
 {0xf0, 0, "P", 7, 7,	0,	XK_P},
 {0xfa, "=", StrXK_igrave, 7, 7,	0,	XK_igrave, XK_equal},
...
static struct key italian_lk201li_tw_row4 [] = {
 ...
 {0xf7, StrXK_section, "*", 7, 7,	0,	XK_asterisk, XK_section},
 {0,	0,	0,		24, 7},
/*LEFT*/
 {170,	0, 0,		8, 7,	0,	XK_Up},
 {0,	0,	0,		15, 7},
...
static struct key italian_lk201li_tw_row5 [] = {
 ...
 {0xf3, "!", StrXK_ograve, 7, 7,	0,	XK_ograve, XK_exclam},
/*SHIFT*/
...
static struct key italian_lk201li_tw_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row italian_lk201li_tw_rows [] = {
  { sizeof (italian_lk201li_tw_row0) / sizeof (struct key), 7, italian_lk201li_tw_row0 },
  { 0, 7, 0 },
  { sizeof (italian_lk201li_tw_row2) / sizeof (struct key), 7, italian_lk201li_tw_row2 },
  { sizeof (italian_lk201li_tw_row3) / sizeof (struct key), 7, italian_lk201li_tw_row3 },
  { sizeof (italian_lk201li_tw_row4) / sizeof (struct key), 7, italian_lk201li_tw_row4 },
  { sizeof (italian_lk201li_tw_row5) / sizeof (struct key), 7, italian_lk201li_tw_row5 },
  { sizeof (italian_lk201li_tw_row6) / sizeof (struct key), 7, italian_lk201li_tw_row6 }
};

static struct keyboard italian_lk201li_tw = {
  "LK201 (Italiano)",
  sizeof (italian_lk201li_tw_rows) / sizeof (struct row),
  italian_lk201li_tw_rows,
  6, 3, 3
};
