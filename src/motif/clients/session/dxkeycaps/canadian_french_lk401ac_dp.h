 ...
 */
/*
 * @(#)$RCSfile: canadian_french_lk401ac_dp.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/11/09 17:11:35 $
 */
...
static struct key canadian_french_lk401ac_dp_row1 [] = {
 {86,	0,	0,	7, 7,	0,	XK_F1},
 {87,	0,	0,	7, 7,	0,	XK_F2},
 {88,	0,	0,	7, 7,	0,	XK_F3},
 {89,	0,	0,	7, 7,	0,	XK_F4},
...
static struct key canadian_french_lk401ac_dp_row3 [] = {
 {0,	0,	0,		5, 7},
 ...
 {0xeb, 0, "O", 7, 7,	0,	XK_O},
 {0xf0, 0, "P", 7, 7,	0,	XK_P},
 {0xfa, "[", "]", 7, 7,	0,	XK_bracketright, XK_bracketleft},
 {0xf6, "@", "#", 7, 7,	0,	XK_numbersign, XK_at},
 {0,	0,	0,		2, 7},
...
static struct key canadian_french_lk401ac_dp_row4 [] = {
 ...
 {0xe7, 0, "K", 7, 7,	0,	XK_K},
 {0xec, 0, "L", 7, 7,	0,	XK_L},
 {0xf2, ":", ";", 7, 7,	0,	XK_semicolon, XK_colon},
 {251,	0,	0,		7, 7,	0,	XK_apostrophe,	XK_quotedbl},
 {0xf7, "|", "\\", 7, 7,	0,	XK_backslash, XK_bar},
 {0,	0,	0,		24, 7},
/*LEFT*/
 {170,	0, 0,		8, 7,	0,	XK_Up},
 {0,	0,	0,		15, 7},
...
static struct key canadian_french_lk401ac_dp_row5 [] = {
 ...
 {0xde, 0, "N", 7, 7,	0,	XK_N},
 {0xe3, 0, "M", 7, 7,	0,	XK_M},
 {0xe8, "'", ",", 7, 7,	0,	XK_comma, XK_apostrophe},
 {0xed, 0, ".", 7, 7,	0,	XK_period},
 {0xf3, 0, StrXK_Eacute, 7, 7,	0,	XK_Eacute},
/*SHIFT*/
...
static struct key canadian_french_lk401ac_dp_row6 [] = {
 {0,	0,	0,		9, 7},
...
static struct row canadian_french_lk401ac_dp_rows [] = {
  { sizeof (canadian_french_lk401ac_dp_row1) / sizeof (struct key), 7, canadian_french_lk401ac_dp_row1 },
  { 0, 7, 0 },
  { sizeof (canadian_french_lk401ac_dp_row2) / sizeof (struct key), 7, canadian_french_lk401ac_dp_row2 },
  { sizeof (canadian_french_lk401ac_dp_row3) / sizeof (struct key), 7, canadian_french_lk401ac_dp_row3 },
  { sizeof (canadian_french_lk401ac_dp_row4) / sizeof (struct key), 7, canadian_french_lk401ac_dp_row4 },
  { sizeof (canadian_french_lk401ac_dp_row5) / sizeof (struct key), 7, canadian_french_lk401ac_dp_row5 },
  { sizeof (canadian_french_lk401ac_dp_row6) / sizeof (struct key), 7, canadian_french_lk401ac_dp_row6 }
};

static struct keyboard canadian_french_lk401ac_dp = {
  "LK401 (Canadien)",
  sizeof (canadian_french_lk401ac_dp_rows) / sizeof (struct row),
  canadian_french_lk401ac_dp_rows,
  6, 3, 3
};
