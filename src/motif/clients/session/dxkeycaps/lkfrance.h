 ...
 */
/*
 * @(#)$RCSfile: lkfrance.h,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1994/01/24 19:19:42 $
 */
...
static struct key lkfrance_row1 [] = {
...
static struct key lkfrance_row2 [] = {
 {0xbf, StrXK_twosuperior, StrXK_twosuperior, 8, 8,	0,	XK_twosuperior, XK_twosuperior, XK_twosuperior, XK_twosuperior},
 {0xc0, "1", "&", 8, 8,	0,	XK_ampersand, XK_1},
 {0xc5, "2", "~", 8, 8,	0,	XK_eacute, XK_2, XK_asciitilde},
 {0xcb, "3", "\"", 8, 8,	0,	XK_quotedbl, XK_3, XK_numbersign},
 {0xd0, "4", "'", 8, 8,	0,	XK_apostrophe, XK_4, XK_braceleft},
 {0xd6, "5", "(", 8, 8,	0,	XK_parenleft, XK_5, XK_bracketleft},
 {0xdb, "6", "-", 8, 8,	0,	XK_minus, XK_6, XK_bar},
 {0xe0, "7", StrXK_egrave, 8, 8,	0,	XK_egrave, XK_7, XK_grave},
 {0xe5, "8", "_", 8, 8,	0,	XK_underscore, XK_8, XK_backslash},
 {0xea, "9", StrXK_ccedilla, 8, 8,	0,	XK_ccedilla, XK_9, XK_asciicircum},
 {0xef, "0", StrXK_agrave, 8, 8,	0,	XK_agrave, XK_0, XK_at},
 {0xf9, StrXK_degree, ")", 8, 8,	0,	XK_parenright, XK_degree, XK_bracketright},
 {0xf5, "+", "=", 8, 8,	0,	XK_equal, XK_plus, XK_braceright},
/*DEL*/
...
static struct key lkfrance_row3 [] = {
 ...
 {0xeb, 0, "O", 8, 8,	0,	XK_O},
 {0xf0, 0, "P", 8, 8,	0,	XK_P},
 {0xfa, StrXK_diaeresis, "^", 8, 8,	0,	XK_asciicircum, XK_diaeresis},
 {0xf6, StrXK_sterling, "$", 8, 8,	0,	XK_dollar, XK_sterling, XK_currency},
 {0,    0,  0, 	2, 7},
...
static struct key lkfrance_row4 [] = {
 ...
 {0xec, 0, "L", 8, 8,	0,	XK_L},
 {0xf2, 0, "M", 8, 8,	0,	XK_M},
 {0xfb, "", StrXK_ugrave, 8, 8,	0,	XK_ugrave, XK_percent},
 {0xf7, StrXK_mu, "*", 8, 8,	0,	XK_asterisk, XK_mu},
 {0,    0,  0, 42, 7},
/*LEFT*/
...
static struct key lkfrance_row5 [] = {
 {0xae, 0, 0, 10, 8,	ShiftMask,	XK_Shift_L},
 {0xc9, ">", "<", 8, 	8,   0,      XK_less, XK_greater},
 {0xc3, 0, "W", 8, 	8,	0,		XK_W},
 {0xc8, 0, "X", 8, 	8,	0,		XK_X},
 {0xce, 0, "C", 8, 	8,	0,		XK_C},
 {0xd3, 0, "V", 8, 	8,	0,		XK_V},
 ...
 {0xf3, StrXK_section, "!", 8, 	8,	0,		XK_exclam, XK_section},
/*SHIFT*/
...
static struct key lkfrance_row6 [] = {
...
static struct row lkfrance_rows [] = {
  { sizeof (lkfrance_row1) / sizeof (struct key), 8, lkfrance_row1 },
  { 0, 8, 0 },
  { sizeof (lkfrance_row2) / sizeof (struct key), 8, lkfrance_row2 },
  { sizeof (lkfrance_row3) / sizeof (struct key), 8, lkfrance_row3 },
  { sizeof (lkfrance_row4) / sizeof (struct key), 8, lkfrance_row4 },
  { sizeof (lkfrance_row5) / sizeof (struct key), 8, lkfrance_row5 },
  { sizeof (lkfrance_row6) / sizeof (struct key), 8, lkfrance_row6 },
};

static struct keyboard lkfrance = {
  "LK444 (Francais)",
  sizeof (lkfrance_rows) / sizeof (struct row),
  lkfrance_rows,
  6, 3, 3
};
