 ...
 */
/*
 * @(#)$RCSfile: lkportugal.h,v $ $Revision: 1.1.4.4 $ (DEC) $Date: 1994/01/24 19:20:10 $
 */
...
static struct key lkportugal_row1 [] = {
...
static struct key lkportugal_row2 [] = {
 {0xbf, "|", "\\", 8, 8,	0,	XK_backslash, XK_bar, XK_backslash, XK_bar},
 {0xc0, "!", "1", 8, 8,	0,	XK_1, XK_exclam},
 {0xc5, "\"", "2",8, 8,	0,	XK_2, XK_quotedbl, XK_at},
 {0xcb, "#", "3", 8, 8,	0,	XK_3, XK_numbersign, XK_sterling},
 {0xd0, "$", "4", 8, 8,	0,	XK_4, XK_dollar, XK_section},
 {0xd6, "", "5", 8, 8,	0,	XK_5, XK_percent},
 {0xdb, "&", "6", 8, 8,	0,	XK_6, XK_ampersand},
 {0xe0, "\\", "7", 8, 8,	0,	XK_7, XK_backslash, XK_bracketleft},
 {0xe5, "(", "8", 8, 8,	0,	XK_8, XK_parenleft, XK_braceleft},
 {0xea, ")", "9", 8, 8,	0,	XK_9, XK_parenright, XK_braceright},
 {0xef, "=", "0", 8, 8,	0,	XK_0, XK_equal, XK_bracketright},
 {0xf9, "?", "'", 8, 8,	0,	XK_apostrophe, XK_question},
 {0xf5, StrXK_guillemotright, StrXK_guillemotleft, 8, 8,	0,	XK_guillemotleft, XK_guillemotright},
/*DEL*/
...
static struct key lkportugal_row3 [] = {
 ...
 {0xeb, 0, "O", 8, 8,	0,	XK_O},
 {0xf0, 0, "P", 8, 8,	0,	XK_P},
 {0xfa, "*", "+", 8, 8,	0,	XK_plus, XK_asterisk, XK_diaeresis},
 {0xf6, "`", StrXK_acute, 8, 8,	0,	XK_acute, XK_grave},
 {0,    0,  0, 	2, 7},
...
static struct key lkportugal_row4 [] = {
 ...
 {0xe7, 0, "K", 8, 8,	0,	XK_K},
 {0xec, 0, "L", 8, 8,	0,	XK_L},
 {0xf2, StrXK_Ccedilla, StrXK_ccedilla, 8, 8,	0,	XK_ccedilla, XK_Ccedilla},
 {0xfb, StrXK_ordfeminine, StrXK_masculine, 8, 8,	0,	XK_masculine, XK_ordfeminine},
 {0xf7, "^", "~", 8, 8,	0,	XK_asciitilde, XK_asciicircum},
 {0,    0,  0, 42, 7},
/*LEFT*/
...
static struct key lkportugal_row5 [] = {
...
static struct key lkportugal_row6 [] = {
...
static struct row lkportugal_rows [] = {
  { sizeof (lkportugal_row1) / sizeof (struct key), 8, lkportugal_row1 },
  { 0, 8, 0 },
  { sizeof (lkportugal_row2) / sizeof (struct key), 8, lkportugal_row2 },
  { sizeof (lkportugal_row3) / sizeof (struct key), 8, lkportugal_row3 },
  { sizeof (lkportugal_row4) / sizeof (struct key), 8, lkportugal_row4 },
  { sizeof (lkportugal_row5) / sizeof (struct key), 8, lkportugal_row5 },
  { sizeof (lkportugal_row6) / sizeof (struct key), 8, lkportugal_row6 },
};

static struct keyboard lkportugal = {
  "LK444 (Portugues)",
  sizeof (lkportugal_rows) / sizeof (struct row),
  lkportugal_rows,
  6, 3, 3
};
