 ...
 */
/*
 * @(#)$RCSfile: UilDefI.h,v $ $Revision: 1.1.2.2 $ (DEC) $Date: 1993/05/07 00:33:27 $
 */
/* 
 ...
 * Motif Release 1.2
*/ 
/*   $RCSfile: UilDefI.h,v $ $Revision: 1.1.2.2 $ $Date: 1993/05/07 00:33:27 $ */
...
cfe: Warning: ./UilDefI.h: 52: Undefined the ANSI standard library defined macro NULL (4.1.2.1(9))
*/
#ifdef NULL
#undef NULL
#endif
...
extern void sar_append_ncs_value  _ARGUMENTS(( yystype *value_frame ,yystype *table_frame ));
#endif
...
#ifdef DEC_MOTIF_EXTENSION
extern void sar_add_ncs_char_8_attr   _ARGUMENTS(( yystype *value_frame ,yystype *attr_frame ));
extern void sar_make_ncs   _ARGUMENTS(( yystype *target_frame ,yystype *value_frame , Boolean right_to_left ));
#endif
...
#ifdef DEC_MOTIF_EXTENSION
extern sym_value_entry_type *sem_evaluate_value_ncs  _ARGUMENTS((sym_value_entry_type *csval_entry ));
#endif
...
#ifdef VMS
extern status convert_unix_to_vms _ARGUMENTS(( char *name, int type));
#endif
