 ...
 * Motif Release 1.2
*/ 
/*   $RCSfile: UilSrcDef.h,v $ $Revision: 1.1.4.2 $ $Date: 1993/05/07 00:39:04 $ */
...
#define _src_null_access_key( _key ) (_key.l_key == 0)
#define src_k_key_length 6


typedef struct
{
    unsigned long       l_key;
    unsigned short      w_key;
} z_key;
