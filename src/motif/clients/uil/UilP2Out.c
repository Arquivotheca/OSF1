...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: UilP2Out.c,v $ $Revision: 1.1.4.3 $ $Date: 1993/07/15 18:40:45 $"
#endif
#endif
...
#ifdef VMS
    uid_fcb.os_param.default_fname = ".uid";
    uid_fcb.os_param.nam_flg.related_nam =
        src_az_source_file_table[0]->fab.fab$l_nam;
#else
