...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: UilLstMac.c,v $ $Revision: 1.1.4.3 $ $Date: 1993/07/15 18:38:52 $"
#endif
#endif
...
#define _Offset(type,base,field)    \
        ((unsigned long)((char *)base + XtOffsetOf(type, field)))

#define _OffsetArray(type,base,field)    \
        ((unsigned long)((short)((char *)base + XtOffsetOf(type, field))))
#else
#define _Offset(type,base,field)    \
...
#define _OffsetArray(type,base,field)    \
        ((unsigned int)((short)(base + XtOffsetOf(type, field))))
#else
#define _Offset(type,base,field)    \
