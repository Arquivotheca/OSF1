...
/* $Header: /usr/sde/x11/rcs/x11/src/./motif/clients/paint/ps.h,v 1.1.2.2 92/12/11 08:35:52 devrcs Exp $ */
/*
**************************************************************************
...
**  ABSTRACT:
**
**   This module contains things taken from the printscreen
**   utility for DECwindows V1.0
**
**  ENVIRONMENT:
**
...
**	16-Aug-1988 : Dan Latham created module from prdw.h & iprdw.h
**
**--
**/           
/*
