...
static char *BuildSystemHeader =
  "$Header: /usr/sde/osf1/rcs/x11/src/motif/clients/dxclock/clockint.c,v 1.1.7.3 1993/10/19 19:56:36 Susan_Ng Exp $";
#endif
#endif
...
**
**  ABSTRACT:
**	This main module creates an instance of the Clock widget.
**
**  AUTHORS:
...
extern DwtMyClockCreate();
external ClockWidgetClass clockwidgetclass;
XtAppContext app_context;
Widget toplevel;
Widget top_wid;

static char CLOCK_75_bits[] = {
   ,
   ...
   };

static char CLOCK_50_bits[] = {
   };

static char CLOCK_32_bits[] = {
   };

static char CLOCK_17_bits[] = {
    ...
    char **argv;
{
    ...
    stat = MrmRegisterClass(MrmwcUnknown, "clock_widget", "DwtMyClockCreate",
      DwtMyClockCreate, clockwidgetclass);
    if (stat == MrmFAILURE) {
    ...
    /* unmanaged_toplevel  = XtInitialize (NULL, CLASS_NAME, NULL, 0, &argc,
     * argv); */
...
**--
**/
static Pixmap fetch_bitmap_icon(dpy, scr, icon_size)
    Display *dpy;
    Screen *scr;
    int icon_size;
{
	...
	case 75: 
	    pixmap_rtn =
	      MakePixmap(dpy, root, CLOCK_75_bits, icon_size, icon_size);
	    break;

	case 50: 
	    pixmap_rtn =
	      MakePixmap(dpy, root, CLOCK_50_bits, icon_size, icon_size);
	    break;

	case 32: 
	    pixmap_rtn =
	      MakePixmap(dpy, root, CLOCK_32_bits, icon_size, icon_size);
	    break;

	case 17: 
	    pixmap_rtn =
	      MakePixmap(dpy, root, CLOCK_17_bits, icon_size, icon_size);
	    break;
