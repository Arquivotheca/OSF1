 ...
 */
/*
	@(#)$RCSfile: item.h,v $ $Revision: 1.1.5.2 $ (DEC) $Date: 1993/08/02 23:57:49 $
*/
...
typedef struct
    ...
    XEvent	*event;
    Boolean	value;
    } DXmItemCallbackStruct;

#ifndef ITEM
externalref WidgetClass	itemwidgetclass;
#endif
