...
/* $Header: /alphabits/u3/x11/ode/rcs/x11/src/motif/clients/dxmail/capsar.h,v 1.1.2.2 92/06/26 11:43:08 Dave_Hill Exp $ */
/************************************************************/
/*                                                          */
...
#define EOM		(-1)		/* end of message */
#define EBFOUND		(0)		/* encapsulation found */
...
#define UUDECODE_ALT_CMD "/usr/bin/uudecode"
...
#define DTIF_MAGICNO 	020037577777
#define PSTAG		"%!PS"
