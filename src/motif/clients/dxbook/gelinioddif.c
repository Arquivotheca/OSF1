 ...
 * HISTORY
 */
static char SccsId[] = "@(#)gelinioddif.c	1.1\t11/22/88";
/*
*****************************************************************************
**                                                                          *
**                         COPYRIGHT (c) 1988 BY                            *
...
**  FACILITY:
**
**	GELINIODDIF	             	       Line object IO handler DDIF format
**
**  ABSTRACT:
**
**
...
if (cmd == GEWRITE)
  {geCdaPrevAgg = geCdaAgg;
    ...
    */
   geCdaAggType = DDIF$_LIN;              /* LINE aggregate            */
   geCdaTrk         = 14;
   ...
   CdaAggregateItem   = DDIF$_LIN_FLAGS;
   CdaBufLen          = sizeof(CdaLVal);
   CdaLVal            = 0x0A;
   geCdaTrk         = 16;
   ...
   CdaAggregateItem   = DDIF$_LIN_DRAW_PATTERN;
   CdaBufLen          = sizeof(CdaLVal) * 8 - 1;
   CdaLVal            = 0x55AA55AA;
   geCdaTrk         = 17;
   geCdaStat = cda$store_item(
                        &geCdaRtAgg,
   ...
   CdaAggregateItem   = DDIF$_LIN_PATH_C;
   CdaBufLen          = sizeof(CdaLVal);
   CdaLVal            = 0;
   CdaAggregateIndex  = DDIF$K_VALUE_CONSTANT;
   geCdaTrk         = 18;
   geCdaStat = cda$store_item(
                        &geCdaRtAgg,
                        &geCdaAgg,
   ...
   CdaAggregateItem   = DDIF$_LIN_PATH;
   CdaBufLen          = sizeof(CdaLVal);
   CdaLVal            = 0;
   CdaAggregateIndex  = 0;
   geCdaTrk         = 19;
