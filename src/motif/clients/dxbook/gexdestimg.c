 ...
 * HISTORY
 */
static char SccsId[] = "@(#)gexdestimg.c	1.3\t5/19/89";
/*
*****************************************************************************
**                                                                          *
**                         COPYRIGHT (c) 1988 BY                            *
...
**  FACILITY:
**
**	GEXDESTIMG			Layer routine for XDestroyImage
**
**  ABSTRACT:
**
...
{                                                                         
if (ximage)
  {if (ximage->f.destroy_image) XDestroyImage(ximage);
   else
     {geFree(&ximage->data, ximage->bytes_per_line * ximage->height);
      XFree (ximage);
     }
  }
}
