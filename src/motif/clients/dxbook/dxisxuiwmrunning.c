 ...
 * HISTORY
 */
/*  DEC/CMS REPLACEMENT HISTORY, Element DXISXUIWMRUNNING.C */
/*  *2    13-DEC-1991 14:51:02 FERGUSON "Include stdlib.h" */
/*  *1    18-JUN-1991 13:17:50 JACKIE "Initial Entry" */
/*  DEC/CMS REPLACEMENT HISTORY, Element DXISXUIWMRUNNING.C */
/* 
*******************************************************************************
...
Boolean DXIsXUIWMRunning PARAM_NAMES((widget,check))
    Widget widget PARAM_SEP
    Boolean check PARAM_END
{
