...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: WmCPlace.c,v $ $Revision: 1.1.4.3 $ $Date: 1993/07/16 22:22:36 $"
#endif
#endif
/*
...
Boolean PlaceWindowInteractively(pcd)
#else
...
#else /* _NO_PROTO */
#ifdef DEC_MOTIF_BUG_FIX
Boolean PlaceWindowInteractively (ClientData *pcd)
#else
#endif
#endif /* _NO_PROTO */
{
