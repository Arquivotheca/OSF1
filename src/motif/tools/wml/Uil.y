 ...
 * Motif Release 1.2.1
*/ 
/* "$RCSfile: Uil.y,v $ $Revision: 1.1.4.3 $ $Date: 1993/07/15 18:44:17 $" */
/*
...
%token	NESTED_COMPOUND_STRING                  97      /* keyword */
%token  RTOL                                    98      /* keyword */
%token  LTOR                                    99      /* keyword */
...
operand
    ...
    | LOC_STRING						{ sar_make_private_value(&$$, &$1, sym_k_localized_string_value,
								  &$1, 0); }
/****************8
    | NESTED_COMPOUND_STRING LEFT_PAREN ncs_result RIGHT_PAREN { $$ = $3 }
*************/
    ;
...
/****************
ncs_result
    : ncs_result ncs_string                             { sar_append_ncs_value ( &$2, &$1 ); $$ = $2; }
    | ncs_string                                        { sar_append_ncs_value ( &$1, &gz_yynullval ); $$ = $1; }
    ;


ncs_string
    : ncs_primative_string                              { $$ = $1; }
    | RTOL LEFT_PAREN ncs_result RIGHT_PAREN            { sar_make_ncs ( &$$, &$3, TRUE ); }
    | LTOR LEFT_PAREN ncs_result RIGHT_PAREN            { sar_make_ncs ( &$$, &$3, FALSE ); }
    ;

ncs_primative_string
    : ncs_private_value                                 { sar_add_ncs_char_8_attr( &$1, &gz_yynullval ); }
    | ncs_private_value ncs_attrs                       { sar_add_ncs_char_8_attr( &$1, &$2 ); }
    ;

ncs_private_value
    : optional_charset CHAR_8_LITERAL                   { 
...
ncs_attrs
    : COMMA ncs_attr                                    { sar_chk_comp_str_attr( &$$, &$2, &gz_yynullval ); }
    ;
