...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: wmldbcreate.c,v $ $Revision: 1.1.4.4 $ $Date: 1993/11/03 14:39:02 $"
#endif
#endif
/*
 ...
 * Since we do ship this source file, we'll insert the contents of
 * MrmWidget.h directly into it at this point.
 */

/*   $RCSfile: wmldbcreate.c,v $ $Revision: 1.1.4.4 $ $Date: 1993/11/03 14:39:02 $ */
