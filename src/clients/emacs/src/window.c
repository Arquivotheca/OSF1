...
#endif /* _NO_EMACS_PROTO */
{
  ...
  register Lisp_Object top;
  register Lisp_Object height;
  register Lisp_Object posint;
...
#endif /* _NO_EMACS_PROTO */
{
  ...
  Lisp_Object oheight = XFASTINT (w->height);
  Lisp_Object top, pos, lastbot, opos, lastobot;
  Lisp_Object child;
...
#endif /* _NO_EMACS_PROTO */
{
  register struct window *w = XWINDOW (window);
  register struct window *c;
  Lisp_Object owidth = XFASTINT (w->width);
  Lisp_Object left, pos, lastright, opos, lastoright;
  Lisp_Object child;
...
#endif /* _NO_EMACS_PROTO */
{
  ...
  register void (*setsizefun) () = widthflag ? set_window_width : set_window_height;
...
#endif /* _NO_EMACS_PROTO */
{
  register Lisp_Object ht = window_height (selected_window)
    - !EQ (selected_window, minibuf_window);
...
{
  register struct window *w = XWINDOW (selected_window);
  register Lisp_Object height = XFASTINT (w->height);
  register int start;
