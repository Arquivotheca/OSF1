...
/* FIXME: why do this at all, since alpha has union type? */
#ifdef __alpha
...
#define XSETCONS(a, b) XSETPNTR(a, (long) (b))
#define XSETBUFFER(a, b) XSETPNTR(a, (long) (b))
#define XSETVECTOR(a, b) XSETPNTR(a, (long) (b))
#define XSETSUBR(a, b) XSETPNTR(a, (long) (b))
#define XSETSTRING(a, b) XSETPNTR(a, (long) (b))
#define XSETSYMBOL(a, b) XSETPNTR(a, (long) (b))
#define XSETFUNCTION(a, b) XSETPNTR(a, (long) (b))
#define XSETMARKER(a, b) XSETPNTR(a, (long) (b))
#define XSETOBJFWD(a, b) XSETPNTR(a, (long) (b))
#define XSETINTPTR(a, b) XSETPNTR(a, (long) (b))
#define XSETWINDOW(a, b) XSETPNTR(a, (long) (b))
#define XSETPROCESS(a, b) XSETPNTR(a, (long) (b))

...
/* proto.h extern temp_output_buffer_setup (), temp_output_buffer_show (); */
