...
#else /* _NO_EMACS_PROTO */
Lisp_Object
store_in_keymap ( Lisp_Object keymap, register int idx, 
		 register Lisp_Object def)
#endif /* _NO_EMACS_PROTO */
{
  register Lisp_Object tem;
...
DEF is anything that can be a key's definition:\n\
 ...
 or a symbol.  The symbol's function definition is used as the key's\n\
definition, and may be any of the above (including another symbol).")
  ( register Lisp_Object keymap, Lisp_Object key, Lisp_Object def )
#endif /* _NO_EMACS_PROTO */
{
  register int idx;
  register int c;
...
#else /* _NO_EMACS_PROTO */
void
describe_map (Lisp_Object map, Lisp_Object string, int partial, 
	      Lisp_Object shadow)
#endif /* _NO_EMACS_PROTO */
{
...
#else /* _NO_EMACS_PROTO */
void
describe_alist (register Lisp_Object alist, Lisp_Object elt_prefix, 
		void (*elt_describer)(), int partial, Lisp_Object shadow)
#endif /* _NO_EMACS_PROTO */
{
  Lisp_Object this;
...
#else /* _NO_EMACS_PROTO */
void
describe_vector (register Lisp_Object vector, Lisp_Object elt_prefix, 
		 void (*elt_describer) (), int partial, Lisp_Object shadow)
#endif /* _NO_EMACS_PROTO */
{
  Lisp_Object this;
