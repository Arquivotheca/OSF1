...
/*
 *	$Source: /usr/sde/x11/rcs/x11/src/./clients/emacs/src/xterm.c,v $
 *	$Author: devrcs $
 *	$Locker:  $
 *	$Header: /usr/sde/x11/rcs/x11/src/./clients/emacs/src/xterm.c,v 1.2 92/08/25 17:37:00 devrcs Exp $
 */

#ifndef lint
static char *rcsid_TrmXTERM_c = "$Header: /usr/sde/x11/rcs/x11/src/./clients/emacs/src/xterm.c,v 1.2 92/08/25 17:37:00 devrcs Exp $";
#endif	lint
...
void
spacecheck ( int mindex, int rindex, int windex, int minfreespace )
{
