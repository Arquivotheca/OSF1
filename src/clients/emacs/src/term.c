...
void (*move_cursor_hook) ();
void (*raw_move_cursor_hook) ();
...
void (*insert_chars_hook) ();
void (*output_chars_hook) ();
void (*delete_chars_hook) ();
...
void (*fix_screen_hook) ();
void (*calculate_costs_hook) ();
...
#else /* _NO_EMACS_PROTO */  
void
insert_chars (register char *start, int len)
#endif /* _NO_EMACS_PROTO */
{
  register char *buf;
  register int c;
