...
# HISTORY
# 
# @(#)$RCSfile: xdm-config.fs.mrg.sh,v $ $Revision: 1.1.2.2 $ (DEC) $Date: 1993/10/01 15:14:18 $
# 
#
# =========================================================================
...
#	Given:	Nothing
#
#	Does:	Performs any merge processing that is necessary
...
MergeConfigFs()
{
MRG_FILE="xdm-config.fs"	# Name of file to merge
