...
# HISTORY
# 
# @(#)$RCSfile: Xsetup_0.mrg.sh,v $ $Revision: 1.1.2.2 $ (DEC) $Date: 1993/10/01 15:14:03 $
# 
#
# =========================================================================
...
MergeXsetup()
{
    ...
    MRG_FILE="Xsetup_0"	# Name of file to merge


	(grep -q "/usr/lib/X11/fonts/user" $MRG_FILE) &&
	{
	    return 0
	}
#
