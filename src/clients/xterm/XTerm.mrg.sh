...
# HISTORY
# 
# @(#)$RCSfile: XTerm.mrg.sh,v $ $Revision: 1.1.2.3 $ (DEC) $Date: 1993/10/19 18:33:58 $
# 
# 
#
# =========================================================================
...
#
#	Returns:	0 suceess, -1 failure
#
MergeXTerm()
{
	[ "$OPTION" = "ToProto" ] && return 0

	MRG_FILE="XTerm"	# Name of file to merge
#
#	test if merge has already been performed 
#
	(grep -q hiliteTrackInhibit $MRG_FILE) &&
	{
	    return 0
	}
#
...
/appkeypad
a
*vtMenu*bsisdel*Label:  BackSpace sends Delete
.
/tekMenu
i
!disable Hilite Mouse Tracking
*VT100*hiliteTrackInhibit:	True
.
w
q
END
