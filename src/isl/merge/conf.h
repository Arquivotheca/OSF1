 ...
 */
/*
 * @(#)$RCSfile: conf.h,v $ $Revision: 1.1.2.2 $ (DEC) $Date: 1993/08/13 20:38:36 $
 */
...
#define DIFF "/usr/lbin/upd_diff" /* name of 'diff' program */
#define DIFF3 "/usr/lbin/upd_diff3" /* name of 'diff3' program */
