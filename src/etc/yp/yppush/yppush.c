 ...
 */
#ifndef lint
static char     *sccsid = "@(#)$RCSfile: yppush.c,v $ $Revision: 4.2.3.2 $ (DEC) $Date: 1992/03/26 14:06:10 $";
#endif
/*
 */
	...
	int *err;
{
	...
	signal(SIGALRM, (void *) send_time_up);
	alarm(PORTMAP_TIME);
	if (setjmp(port_died) != 0) {
