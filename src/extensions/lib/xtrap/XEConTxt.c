...
#ifndef lint
static char RCSID[] = "$Header: /alphabits/u3/x11/ode/rcs/x11/src/extensions/lib/xtrap/XEConTxt.c,v 1.1.2.3 92/04/27 12:49:07 Leela_Obilichetti Exp $";
#endif
...
#endif
{
    ...
    {   /* We can't seem to communicate with the extension! */
        ...
        XtWarningMsg("CantComm", "XECreateTC", "XTrapToolkitError",
		     "Can't commuinicate with extension %s",
		     (String *)&params, (Cardinal *)&num_params);
