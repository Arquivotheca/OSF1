...
static char *BuildSystemHeader= "$Header: /alphabits/u3/x11/ode/rcs/x11/src/extensions/lib/xtrap/XEKeybCtrl.c,v 1.1.2.3 92/04/27 12:49:21 Leela_Obilichetti Exp $";	/* BuildSystemHeader */
...
int XEEnableCtrlKeys(void (*rtn)())
#else
int XEEnableCtrlKeys(rtn)
    void (*rtn)();
#endif
{
#ifndef vms
