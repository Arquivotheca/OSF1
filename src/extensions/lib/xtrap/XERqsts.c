...
static char *BuildSystemHeader= "$Header: /alphabits/u3/x11/ode/rcs/x11/src/extensions/lib/xtrap/XERqsts.c,v 1.1.2.4 92/06/12 09:27:33 Jim_Ludwig Exp $";	/* BuildSystemHeader */
