 ...
 double	    value;
{
    ...
    */
    ptr->m_sign   = (CARD8) (mantissa >= 0.0);
    ptr->mantissa = (CARD32) (Convert_Mantissa_(ptr)
    ...
    */
    ptr->e_sign   = (CARD8)  (exponent >= 0);
    ptr->exponent = (CARD16) (ptr->e_sign ? exponent : -exponent);
}

/*****************************************************************************
**  MiDecodeDouble
 ...
 XieFloat   ptr;
{
    ...
    */
    return( pow( 2.0, (ptr->e_sign ? 1.0 : -1.0) * ptr->exponent )
		    * (ptr->m_sign ? 1.0 : -1.0)
		    * ((long)ptr->mantissa >> 1) /  Convert_Mantissa_(ptr) );
}
