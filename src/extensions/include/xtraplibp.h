...
/* $Header: /alphabits/u3/x11/ode/rcs/x11/src/extensions/include/xtraplibp.h,v 1.1.2.3 92/04/27 12:33:25 Leela_Obilichetti Exp $ */
...
char *XERequestIDToExtString P((register CARD8 id ));
