 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: pmap_rmt.c,v $ $Revision: 1.1.3.2 $ (DEC) $Date: 1992/03/18 18:00:47 $";
#endif
#if defined(LIBC_SCCS) && !defined(lint)
static char sccsid[] = 	"@(#)pmap_rmt.c	1.9 90/07/19 4.1NFSSRC Copyr 1990 Sun Micro";
#endif
