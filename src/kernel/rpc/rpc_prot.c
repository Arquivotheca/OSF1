 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: rpc_prot.c,v $ $Revision: 1.1.5.2 $ (DEC) $Date: 1993/05/18 21:06:58 $";
#endif
#if defined(LIBC_SCCS) && !defined(lint)
static char sccsid[] = 	"@(#)rpc_prot.c	1.4 90/07/19 4.1NFSSRC Copyr 1990 Sun Micro";
#endif
