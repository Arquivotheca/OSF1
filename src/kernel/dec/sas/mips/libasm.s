 ...
 */
/*	
 *	@(#)$RCSfile: libasm.s,v $ $Revision: 4.3.4.2 $ (DEC) $Date: 1992/05/05 13:36:53 $
 */ 
/*
 */
/*
 ...
 */
/* 
 * derived from libasm.s	3.2	(ULTRIX/OSF)	3/5/91
 */
/*
 * libasm.s
 *
 ...
 *	Merged to v4.2. Added Joe's changes listed below.
 *	ifdef'd out _cksum1, nuxi_s, nuxi_l, clearpage, wbflush
 *	routines since they are unused and needed space in bootblks.
 *
 ...
 *	Moved outside of the ifdef notdef ***DDF
 */
LEAF(nuxi_s)			# a0 = ??ab
	srl	v0,a0,8		# v0 = 0??a
	and	v0,0xff		# v0 = 000a
