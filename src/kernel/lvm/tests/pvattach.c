 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: pvattach.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/19 22:29:17 $";
#endif 
/*
 */
/*
...
struct stat statbuf;
	...
	printf("%s: Attaching physical %s volume on volume group %s\n",
	       progname, pvol, path);
