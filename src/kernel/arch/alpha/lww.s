 ...
 */
	.rdata
	.asciiz "@(#)$RCSfile: lww.s,v $ $Revision: 1.1.2.3 $ (DEC) $Date: 1993/10/19 19:44:42 $"
	.text
 ...
 */
	...
	stq	a4, 0(a3)	  # write the transaction id to the user buffer
	addq	a3, 0x8, a3
 ...
 */
	...
	bis    s0, t2, t8         # dual,  set lww bit in pte
	stq    t8, 0(a0)          # update pte
	zap    s0, 0x0f, t12      # single, compute phys address
	bis    zero, zero, zero 
	srl    t12, 0x13, t10      # dual
	stq    t10, 0(a3)         # write phys addr to user buffer 
