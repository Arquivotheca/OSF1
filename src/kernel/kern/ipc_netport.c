 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: ipc_netport.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/19 22:24:30 $";
#endif 
/*
 */
/*
...
#include <sys/param.h>		/* NBPG, CLBYTES, etc. */
...
netport_init(ServPort)
{
	...
	netport_hash_zone = zinit(sizeof(struct netport_hash_entry), 
			512 * 1024, page_size, "netport translations");
