 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: gvp_dg.c,v $ $Revision: 1.1.6.2 $ (DEC) $Date: 1993/07/13 17:07:47 $";
#endif
/*
 * derived from gvp_dg.c	4.1	(ULTRIX)	7/2/90";
 */
/************************************************************************
 *                                                                      *
    ...
    PCCB		*pccb;
{
    ...
    SCA_KM_ALLOC( gvpbp, GVPH *, pccb->lpinfo.Dg_size, KM_SCABUF, 
	      KM_NOWAIT|KM_WIRED )
    if( gvpbp ) {
