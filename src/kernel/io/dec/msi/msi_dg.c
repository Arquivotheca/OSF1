 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: msi_dg.c,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1993/07/13 17:39:24 $";
#endif
/*
 * derived from msi_dg.c	4.1	(ULTRIX)	7/2/90";
 */
/************************************************************************
 *                                                                      *
 *                      Copyright (c) 1989                              *
    ...
    PCCB		*pccb;
{
    ...
    SCA_KM_ALLOC( msibp, MSIB *, pccb->lpinfo.Dg_size, KM_SCABUF, KM_NOWAIT )
    if( msibp ) {
