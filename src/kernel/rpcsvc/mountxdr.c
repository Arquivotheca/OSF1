 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: mountxdr.c,v $ $Revision: 1.1.3.2 $ (DEC) $Date: 1992/03/18 18:36:47 $";
#endif
#ifndef lint
static char sccsid[] = 	"@(#)mountxdr.c	1.5 90/07/19 4.1NFSSRC Copyr 1990 Sun Micro";
#endif
