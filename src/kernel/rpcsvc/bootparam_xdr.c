 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: bootparam_xdr.c,v $ $Revision: 1.1.3.2 $ (DEC) $Date: 1992/03/18 18:35:47 $";
#endif
#ifndef lint
static char sccsid[] = 	"@(#)bootparam_xdr.c	1.4 90/07/19 4.1NFSSRC Copyr 1990 Sun Micro";
#endif
