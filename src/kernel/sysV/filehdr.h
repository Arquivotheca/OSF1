 ...
 */
/*	
 *	@(#)filehdr.h	9.2	(ULTRIX/OSF)	10/18/91
 */ 
/*
 * *****************************************************************
 * *                                                               *
...
/* | All Rights Reserved.                                  | */
/* --------------------------------------------------------- */
/* $Header: /usr/sde/alpha/rcs/alpha/src/./kernel/sysV/filehdr.h,v 4.3.3.2 1992/12/09 15:01:57 Jay_Estabrook Exp $ */
#ifndef __FILEHDR_H
#define __FILEHDR_H
...
/* START ALPHA */
      f_symptr : quad;			/* file pointer to symbolic header   */
/* END ALPHA */
