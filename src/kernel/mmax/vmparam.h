 ...
 */
/*	
 *	@(#)$RCSfile: vmparam.h,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/19 22:43:46 $
 */ 
/*
 */
/*
...
/*
 * Machine dependent constants for MMAX
 *
 */
...
/*
 * END_OF_VMEM is the end of where virtual memory can be mapped.
...
#define BTOPUSRSTACK	(USRSTACK/NS32K_PGBYTES)    /* btop(USRSTACK) */
#endif	MMAX_XPC || MMAX_APC || MMAX_DPC
/* removed P1PAGES definition -- nonsense on ns32000 */
#define LOWPAGES	0
#define HIGHPAGES	0
...
/*
 * What's even sillier is the values we're setting this to here!
 *
 * OK, this is a kludge, you have any better ideas?
 */
#if	MMAX_XPC || MMAX_APC
#define	SYSPTSIZE	((20+MAXUSERS)/8*NPTEPG)
#define	USRPTSIZE 	(NPTEPG)
