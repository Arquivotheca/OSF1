...
# 
#
# @(#)kernel.sh	3.6	(ULTRIX/OSF)	10/2/91
#
# *****************************************************************
# *                                                               *
# *    Copyright (c) Digital Equipment Corporation, 1991, 1994    *
...
#
# Note: remove this later. Is this the correct path?
#PATH="${toolsdir}/gcc:${hostbindir}:${bindir}:/usr/ucb:/bin:/usr/bin"
...
case $# in
     ...
     # Behaves like the old kernel.sh (i.e., hernel.sh with no arguments).
