...
# 
#
# @(#)cmds.sh	3.4	(ULTRIX/OSF)	10/2/91
#
# *****************************************************************
# *                                                               *
# *    Copyright (c) Digital Equipment Corporation, 1991, 1994    *
...
# This is the script for building the user commands of the snapshot.
# This script should be run after the setup scripts (setup.sh, includes.sh
# tools.sh, and libs.sh) have completed successfully.
# Good Luck!
#
# NOTE: Most changes to this file should also be made to
# the onecmd.sh script as well.
# 
...
# Set up the env var REL so we export the /usr/lib/cmplrs/cc items into
#   /usr/lib/cmplrs/cc3.0 like the ode system expects. (jpm 4/7/92)
