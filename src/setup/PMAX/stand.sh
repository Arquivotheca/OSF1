...
# 
#
# @(#)stand.sh	3.5	(ULTRIX/OSF)	6/30/91
#
# *****************************************************************
# *                                                               *
# *    Copyright (c) Digital Equipment Corporation, 1991, 1994    *
...
# REVISION HISTORY:
#
# 11-Mar-1991	Don Dutile
#	Changed the path(s) to be kernel/dec/sas(/mips)
#	instead of the original osf path of kernel/mips/PMAX/stand
#
...
(cd kernel/dec/sas/mips; make -ckEF $1 DESTROOT=$2)
