...
unsigned int        WellKnownConnections;
unsigned int        AllSockets[mskcnt];
unsigned int        AllClients[mskcnt];
unsigned int        LastSelectMask[mskcnt];
unsigned int        ClientsWithInput[mskcnt];
unsigned int        ClientsWriteBlocked[mskcnt];
unsigned int        OutputPending[mskcnt];
...
static unsigned int IgnoredClientsWithInput[mskcnt];
