...
{
       register Word dx,dy;  /* change in x and y, in my own precision       */
       register Word x,y;    /* integer pel starting point                   */
       register int count;   /* integer pel delta y                          */
       register Word d;      /* the Bresenham algorithm error term           */
