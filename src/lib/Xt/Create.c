...
#ifdef DEC_EXTENSION
    new_shell = _XtCreate(name, class, widget_class, (Widget)NULL,
#else
...
/******************************************************************/
/* This call will initialize the widget visualizer if the logical */
/* DECW$VXT is defined as "ON" -- otherwise, the function returns */
/* without doing anything					  */
/******************************************************************/
    VXtInitialize (XtDisplay(new_shell), new_shell);
#endif
#endif
