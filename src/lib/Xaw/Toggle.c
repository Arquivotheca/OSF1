...
Cardinal *num_params;	/* unused */
{
  ...
  if (tw->command.set) 
    class->toggle_class.Unset(w, event, (String *) NULL, 0);
  else 
    ToggleSet(w, event, params, num_params);
}
...
Widget current, request, new;
{
	...
	Toggle(new, (XEvent *) NULL, 
		(String *) NULL, (Cardinal *) 0); /* Does a redisplay. */
    }
    return(FALSE);
}
...
Widget w;
{
  ...
  while ( group != NULL ) {
    ...
    if ( local_tog->command.set ) {
      class->toggle_class.Unset(group->widget, (XEvent *) NULL, (String *) NULL, 0);
      Notify( group->widget, (XEvent *) NULL, (String *) NULL, 0);
    }
    group = group->next;
  }
}
...
/* Special case case of no radio group. */
  ...
  if ( (group = GetRadioGroup(radio_group)) == NULL) {
    ...
    if ( (local_tog->toggle.radio_data == radio_data) )     
      if (!local_tog->command.set) {
	ToggleSet((Widget) local_tog, (XEvent *) NULL, (String *) NULL, 0);
	Notify((Widget) local_tog, (XEvent *) NULL, (String *) NULL, 0);
      }
    return;
  }
...
#endif
{
  ...
  if (local_tog->command.set) {
    ...
    class->toggle_class.Unset(radio_group, (XEvent *) NULL, (String *) NULL, 0);
    Notify(radio_group, (XEvent *) NULL, (String *) NULL, 0);
  }
