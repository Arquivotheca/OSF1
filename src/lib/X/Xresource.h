 ...
 ****************************************************************/
    ...
    /* note that it is assumed in Xt that XrmQuark must be the 
       same size as String so that XtResource can match XrmResource */
typedef long int     XrmQuark, *XrmQuarkList;
#else
