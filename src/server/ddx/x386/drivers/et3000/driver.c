 ...
 *
 * $Header: /usr/sde/x11/rcs/x11/src/./server/ddx/x386/drivers/et3000/driver.c,v 1.2 91/12/15 12:42:16 devrcs Exp $
 */
...
ET3000Probe()
{
  if (vga256InfoRec.chipset)
    {
      if (strcmp(vga256InfoRec.chipset, "et3000"))
	return (FALSE);
      else
