...
#ifdef __alpha /* sparse space */
#define TCO_CURSOR0       0x080020  /* Cursor 0. */
#define TCO_CURSOR1       0x080040  /* Cursor 1. */
#define TCO_EIGHT_BIT     0x400000  /* Eight bit frame buffer. */
#define TCO_FB_REGISTERS  0x080000  /* Frame buffer device registers. */
#define TCO_MAP_REGISTER  0x080060  /* vid on, int ena, int pend,seg ena,seg */
#define TCO_PIP_REGISTERS 0x100180  /* Pip device registers. */
#define TCO_SELECTION     0x200000  /* Selection memory. */
#define TCO_TRUE_COLOR    0x800000  /* True color frame buffer. */
#define TCO_VIDEO_ENABLE  0x1400000  /* Video enable memory. */
#define TCO_3MAX_MAP_AREA 0x400000  /* Area in 3MAX slot which is mapped. */

/* DENSE ADDRESSES */

#define TCO_CURSOR0_DENSE       0x040010  /* Cursor 0. */
#define TCO_CURSOR1_DENSE       0x040020  /* Cursor 1. */
#define TCO_EIGHT_BIT_DENSE     0x200000  /* Eight bit frame buffer. */
#define TCO_FB_REGISTERS_DENSE  0x040000  /* Frame buffer device registers. */
#define TCO_MAP_REGISTER_DENSE  0x040030  /* vid on, int ena, int pend,
					     seg ena,seg */
#define TCO_PIP_REGISTERS_DENSE 0x0800C0  /* Pip device registers. */
#define TCO_SELECTION_DENSE     0x100000  /* Selection memory. */
#define TCO_TRUE_COLOR_DENSE    0x400000  /* True color frame buffer. */
#define TCO_VIDEO_ENABLE_DENSE  0xA00000  /* Video enable memory. */
#define TCO_3MAX_MAP_AREA_DENSE 0x200000  /* Area in 3MAX slot which is 
					     mapped. */
#else /* !__alpha */
...
typedef struct {
    ...
    volatile unsigned int    	control_status; 	
    					/* 800C0: pip control/status reg 0. */
    volatile unsigned int	control_status1; 
					/* 800C4: pip control/status reg 1. */
    unsigned int		fill1[14];	/* 800C8 - 800FF Unused. */
    volatile unsigned int	x_source_start_hi;  
					/* 80100: video source start (high). */
    volatile unsigned int	x_source_start_low;	
					/* 80104: video source start (low). */
    volatile unsigned int	x_source_end_hi;	
					/* 80108: video source end (high). */
    volatile unsigned int	x_source_end_low;	
					/* 8010C: video source end (low). */
    volatile unsigned int	x_source_scale_hi;	
					/* 80110: video source scale (high). */
    volatile unsigned int	x_source_scale_low;	
					/* 80114: video source scale (low). */
    unsigned int		fill2[2];	
					/* 80118 - 8011F Unused. */
    volatile unsigned int	y_source_start_hi;	
					/* 80120: video source start (high). */
    volatile unsigned int	y_source_start_low;	
					/* 80124: video source start (low). */
    volatile unsigned int	y_source_end_hi;	
					/* 80128: video source end (high). */
    volatile unsigned int	y_source_end_low;	
					/* 8012C: video source end (low). */
    volatile unsigned int	y_source_scale_hi;	
					/* 80130: video source scale (high). */
    volatile unsigned int	y_source_scale_low;	
					/* 80134: video source scale (low). */
    volatile unsigned int	fb_pitch_hi;		
					/* 80138: frame buffer pitch (high). */
    volatile unsigned int	fb_pitch_low;		
					/* 8013C: frame buffer pitch (low). */
    unsigned int		fill3[1];	
					/* 80140 - 80143 Unused. */
    volatile unsigned int	start_offset_hi;	
					/* 80144: pip starting offset (high). */
    volatile unsigned int	start_offset_mid;	
					/* 80148: pip starting offset (mid). */
    volatile unsigned int	start_offset_low;	
					/* 8014C: pip starting offset (low). */
    volatile unsigned int	control_status2;	
					/* 80150: pip control/status reg 2. */
#else /* !__alpha */
