 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: WatchFIFO_parts.c,v $ $Revision: 1.1.2.2 $ (DEC) $Date: 1993/11/19 21:36:17 $";
#endif
watchfifo_code( adr )
     Net_Entry **adr;
{
  extern void WatchFIFO();
  ...
  WatchFIFO( t_wrBuff, (*(adr+2))->value, (*(adr+1))->value, (*(adr+0))->value );
}
