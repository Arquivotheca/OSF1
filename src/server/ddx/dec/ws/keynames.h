...
#define MAX_LK201_KEY           255
#define LK201_GLYPHS_PER_KEY      2

/* Need to use a more general min/max, allowing it to be set
   by LoadKeyMap based upon real mins and maxs for a keymap. 
   MIN_LK201_KEY needs to change to some arbitrary low number
   later, but references to the keysym array need to be 
   changed to make this work.  */

#define MIN_KEY                 MIN_LK201_KEY
#define MAX_KEY                 255
