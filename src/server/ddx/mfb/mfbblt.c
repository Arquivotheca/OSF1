    ...
    DDXPointPtr	    pptSrc;
{
    ...
    {
	psrcBase = (unsigned long *)(((PixmapPtr)pSrc)->devPrivate.ptr);
	widthSrc = (int)(((PixmapPtr)pSrc)->devKind) / sizeof(long);
    }
    ...
    {
	pdstBase = (unsigned long *)(((PixmapPtr)pDst)->devPrivate.ptr);
	widthDst = (int)(((PixmapPtr)pDst)->devKind) / sizeof(long);
    }
...
#endif
		    DuffL(nl, label1,
			    *pdst = MROP_SOLID (*psrc, *pdst); pdst++; psrc++;)
#endif
