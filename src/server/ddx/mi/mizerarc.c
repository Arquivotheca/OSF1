...
#ifndef SLEAZY /* this was suggested on the net. Don't know if it fixes
		* anything, but just in case... doesn't hurt.
		*/
    points = (DDXPointPtr)ALLOCATE_LOCAL(sizeof(DDXPointRec) * (2+numPts));
#else
