    ...
    unsigned long   planemask;
{
    ...
    pboxNew1 = (BoxPtr)NULL;
    pptNew1 = (DDXPointPtr)NULL;
    pboxNew2 = (BoxPtr)NULL;
    pptNew2 = (DDXPointPtr)NULL;
...
#define BodyOdd(n) \
bits = psrc[n-1]; \
pdst[n-1] = MROP_SOLID(BitRight(bits1, rightShift) | BitLeft(bits, leftShift),\
    pdst[n-1]);

#define BodyEven(n) \
bits1 = psrc[n-1]; \
pdst[n-1] = MROP_SOLID(BitRight(bits, rightShift) | BitLeft(bits1, leftShift),\
   pdst[n-1]);
