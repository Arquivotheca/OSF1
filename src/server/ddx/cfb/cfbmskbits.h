...
extern unsigned long cfbstarttab[];
extern unsigned long cfbendtab[];
extern unsigned long cfbstartpartial[];
extern unsigned long cfbendpartial[];
extern unsigned long cfbrmask[];
extern unsigned long cfbmask[];
extern unsigned long QuartetBitsTable[];
extern unsigned long QuartetPixelMaskTable[];
...
#    define PPW		2
#    define PWSH	1
#    define PMSK	0xFFFFFFFFFFFFFFFFL
#    define PixelType   unsigned int
#  endif /* LONG_BIT */
#define PIXEL_ADDR
#endif

/* These are useful when dealing with the mfb/cfb interface 
 * They must match ../mfb/maskbits.h
 */
#if LONG_BIT == 32
#define MFB_PPW		32
#define MFB_PLST	31
