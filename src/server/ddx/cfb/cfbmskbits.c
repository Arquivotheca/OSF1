...
unsigned long cfbstarttab[] =
    {
	cfbBits(0x0000000000000000L),
	cfbBits(0x0FFFFFFFFFFFFFFFL),
	cfbBits(0x00FFFFFFFFFFFFFFL),
	cfbBits(0x000FFFFFFFFFFFFFL),
	cfbBits(0x0000FFFFFFFFFFFFL),
	cfbBits(0x00000FFFFFFFFFFFL),
	cfbBits(0x000000FFFFFFFFFFL),
	cfbBits(0x0000000FFFFFFFFFL),
	cfbBits(0x00000000FFFFFFFFL),
	cfbBits(0x000000000FFFFFFFL),
	cfbBits(0x0000000000FFFFFFL),
	cfbBits(0x00000000000FFFFFL),
	cfbBits(0x000000000000FFFFL),
	cfbBits(0x0000000000000FFFL),
	cfbBits(0x00000000000000FFL),
	cfbBits(0x000000000000000FL),
    };
unsigned long cfbendtab[] =
    {
	cfbBits(0x0000000000000000L),
	cfbBits(0xF000000000000000L),
	cfbBits(0xFF00000000000000L),
	cfbBits(0xFFF0000000000000L),
	cfbBits(0xFFFF000000000000L),
	cfbBits(0xFFFFF00000000000L),
	cfbBits(0xFFFFFF0000000000L),
	cfbBits(0xFFFFFFF000000000L),
	cfbBits(0xFFFFFFFF00000000L),
	cfbBits(0xFFFFFFFFF0000000L),
	cfbBits(0xFFFFFFFFFF000000L),
	cfbBits(0xFFFFFFFFFFF00000L),
	cfbBits(0xFFFFFFFFFFFF0000L),
	cfbBits(0xFFFFFFFFFFFFF000L),
	cfbBits(0xFFFFFFFFFFFFFF00L),
	cfbBits(0xFFFFFFFFFFFFFFF0L),
    };
#endif /* LONG_BIT */
#endif
...
unsigned long cfbmask[] =
    {
	cfbBits(0xF000000000000000L),
	cfbBits(0x0F00000000000000L),
 	cfbBits(0x00F0000000000000L),
 	cfbBits(0x000F000000000000L),
 	cfbBits(0x0000F00000000000L),
 	cfbBits(0x00000F0000000000L),
 	cfbBits(0x000000F000000000L),
 	cfbBits(0x0000000F00000000L),
	cfbBits(0x00000000F0000000L),
	cfbBits(0x000000000F000000L),
 	cfbBits(0x0000000000F00000L),
 	cfbBits(0x00000000000F0000L),
 	cfbBits(0x000000000000F000L),
 	cfbBits(0x0000000000000F00L),
 	cfbBits(0x00000000000000F0L),
 	cfbBits(0x000000000000000FL),
    }; 
unsigned long cfbrmask[] = 
    {
	cfbBits(0x0FFFFFFFFFFFFFFFL),
	cfbBits(0xF0FFFFFFFFFFFFFFL),
 	cfbBits(0xFF0FFFFFFFFFFFFFL),
 	cfbBits(0xFFF0FFFFFFFFFFFFL),
 	cfbBits(0xFFFF0FFFFFFFFFFFL),
 	cfbBits(0xFFFFF0FFFFFFFFFFL),
 	cfbBits(0xFFFFFF0FFFFFFFFFL),
 	cfbBits(0xFFFFFFF0FFFFFFFFL),
	cfbBits(0xFFFFFFFF0FFFFFFFL),
	cfbBits(0xFFFFFFFFF0FFFFFFL),
 	cfbBits(0xFFFFFFFFFF0FFFFFL),
 	cfbBits(0xFFFFFFFFFFF0FFFFL),
 	cfbBits(0xFFFFFFFFFFFF0FFFL),
 	cfbBits(0xFFFFFFFFFFFFF0FFL),
 	cfbBits(0xFFFFFFFFFFFFFF0FL),
 	cfbBits(0xFFFFFFFFFFFFFFF0L),
    };
#endif /* LONG_BIT */
#endif
...
unsigned long cfbmask[] =
    {
	cfbBits(0xFF00000000000000L),
 	cfbBits(0x00FF000000000000L),
 	cfbBits(0x0000FF0000000000L),
 	cfbBits(0x000000FF00000000L),
	cfbBits(0x00000000FF000000L),
 	cfbBits(0x0000000000FF0000L),
 	cfbBits(0x000000000000FF00L),
 	cfbBits(0x00000000000000FFL),
    }; 
unsigned long cfbrmask[] = 
    {
	cfbBits(0x00FFFFFFFFFFFFFFL),
 	cfbBits(0xFF00FFFFFFFFFFFFL),
 	cfbBits(0xFFFF00FFFFFFFFFFL),
 	cfbBits(0xFFFFFF00FFFFFFFFL),
	cfbBits(0xFFFFFFFF00FFFFFFL),
 	cfbBits(0xFFFFFFFFFF00FFFFL),
 	cfbBits(0xFFFFFFFFFFFF00FFL),
 	cfbBits(0xFFFFFFFFFFFFFF00L),
    };
#endif /* LONG_BIT */
#endif
...
unsigned long cfbmask[] =
    {
	cfbBits(0xFFFF000000000000L),
 	cfbBits(0x0000FFFF00000000L),
	cfbBits(0x00000000FFFF0000L),
 	cfbBits(0x000000000000FFFFL),
    }; 
unsigned long cfbrmask[] = 
    {
	cfbBits(0xFFFFFFFFFFFF0000L),
 	cfbBits(0xFFFFFFFF0000FFFFL),
	cfbBits(0xFFFF0000FFFFFFFFL),
 	cfbBits(0x0000FFFFFFFFFFFFL),
    };
#endif /* LONG_BIT */
#endif
 ...
 */
#if PSZ == 4
unsigned long QuartetBitsTable[] = {
#if LONG_BIT == 32
#if (BITMAP_BIT_ORDER == MSBFirst)
...
#else /* LONG_BIT == 64 */
#if (BITMAP_BIT_ORDER == MSBFirst)
    0x00000000L,                         /* 0 - 0000000000000000 */
    0x00008000L,				/* 1 - 1000000000000000 */
    0x0000C000L,                         /* 2 - 1100000000000000 */
    0x0000E000L,                         /* 3 - 1110000000000000 */
    0x0000F000L,                         /* 4 - 1111000000000000 */
    0x0000F800L,                         /* 5 - 1111100000000000 */
    0x0000FC00L,                         /* 6 - 1111110000000000 */
    0x0000FE00L,                         /* 7 - 1111111000000000 */
    0x0000FF00L,                         /* 8 - 1111111100000000 */
    0x0000FF80L,				/* 9 - 1111111110000000 */
    0x0000FFC0L,                         /* 10- 1111111111000000 */
    0x0000FFE0L,                         /* 11- 1111111111100000 */
    0x0000FFF0L,                         /* 12- 1111111111110000 */
    0x0000FFF8L,                         /* 13- 1111111111111000 */
    0x0000FFFCL,                         /* 14- 1111111111111100 */
    0x0000FFFEL,                         /* 15- 1111111111111110 */
    0x0000FFFFL,                         /* 16- 1111111111111111 */
#else /* (BITMAP_BIT_ORDER == LSBFirst */
    0x00000000L,                         /* 0 - 0000000000000000 */
    0x00000001L,                         /* 1 - 0000000000000001 */
    0x00000003L,                         /* 2 - 0000000000000011 */
    0x00000007L,                         /* 3 - 0000000000000111 */
    0x0000000FL,                         /* 4 - 0000000000001111 */
    0x0000001FL,                         /* 5 - 0000000000011111 */
    0x0000003FL,                         /* 6 - 0000000000111111 */
    0x0000007FL,                         /* 7 - 0000000001111111 */
    0x000000FFL,                         /* 8 - 0000000011111111 */
    0x000001FFL,                         /* 9 - 0000000111111111 */
    0x000003FFL,                         /* 10- 0000001111111111 */
    0x000007FFL,                         /* 11- 0000011111111111 */
    0x00000FFFL,                         /* 12- 0000111111111111 */
    0x00001FFFL,                         /* 13- 0001111111111111 */
    0x00003FFFL,                         /* 14- 0011111111111111 */
    0x00007FFFL,                         /* 15- 0111111111111111 */
    0x0000FFFFL,                         /* 16- 1111111111111111 */
#endif /* (BITMAP_BIT_ORDER == MSBFirst) */
#endif /* LONG_BIT */
};
...
#else /* LONG_BIT == 64 */
#if (BITMAP_BIT_ORDER == MSBFirst)
    0x00000000L,                         /* 0 - 00000000 */
    0x00000080L,                         /* 1 - 10000000 */
    0x000000C0L,                         /* 2 - 11000000 */
    0x000000E0L,                         /* 3 - 11100000 */
    0x000000F0L,                         /* 4 - 11110000 */
    0x000000F8L,                         /* 5 - 11111000 */
    0x000000FCL,                         /* 6 - 11111100 */
    0x000000FEL,                         /* 7 - 11111110 */
    0x000000FFL                          /* 8 - 11111111 */
#else /* (BITMAP_BIT_ORDER == LSBFirst */
    0x00000000L,                         /* 0 - 00000000 */
    0x00000001L,                         /* 1 - 00000001 */
    0x00000003L,                         /* 2 - 00000011 */
    0x00000007L,                         /* 3 - 00000111 */
    0x0000000FL,                         /* 4 - 10000111 */
    0x0000001FL,                         /* 5 - 00011111 */
    0x0000003FL,                         /* 6 - 00111111 */
    0x0000007FL,                         /* 7 - 01111111 */
    0x000000FFL                          /* 8 - 11111111 */
#endif /* (BITMAP_BIT_ORDER == MSBFirst) */
#endif /* LONG_BIT */
};
...
#if PSZ == 4
#if LONG_BIT == 32
unsigned long QuartetPixelMaskTable[] = {
    0x00000000,
    0x0000000F,
    0x000000F0,
    0x000000FF,
...
unsigned long QuartetPixelMaskTable[] = {
    ...
    0xFFFFFFFF,
#else /* LONG_BIT == 64 */
    0x0000000000000000L,    0x000000000000FFFFL,
    0x00000000FFFF0000L,    0x00000000FFFFFFFFL,
    0x0000FFFF00000000L,    0x0000FFFF0000FFFFL,
    0x0000FFFFFFFF0000L,    0x0000FFFFFFFFFFFFL,
    0xFFFF000000000000L,    0xFFFF00000000FFFFL,
    0xFFFF0000FFFF0000L,    0xFFFF0000FFFFFFFFL,
    0xFFFFFFFF00000000L,    0xFFFFFFFF0000FFFFL,
    0xFFFFFFFFFFFF0000L,    0xFFFFFFFFFFFFFFFFL,
#endif /* LONG_BIT */
};
#endif
#if PSZ == 32
