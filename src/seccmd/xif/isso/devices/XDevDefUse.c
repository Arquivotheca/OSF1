 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: XDevDefUse.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/20 00:09:37 $";
#endif 
/*
 */
/*
...
/*
	...
	function:
		X windows front end for setting the default authorized users
		for a device
...
CREATE_SCREEN_ROUTINES (DevDefUseStart, DevDefUseOpen, DevDefUseClose,
			DevDefUseStop)
...
MakeWidgets() 
{
	...
	/**********************************************************************/
	form_widget = CreateForm(mother_form, "DevDefUse");
	XtAddCallback(form_widget, XmNhelpCallback,
				    HelpDisplayOpen, "devices,DevDefUse");
...
CREATE_CALLBACKS(msg_header[3], DevDefUseClose)
