 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: headers.c,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/04/01 20:11:43 $";
#endif
/*
 * @OSF_COPYRIGHT@
 */
 ...
 *  *** OSF1_1_1 version ***
 * 
 * Revision 1.1.4.2  1992/06/11  17:04:03  hosking
 * 	bug 6057: ANSI C changes to allow '-pedantic' to be enabled
 * 	[1992/06/11  16:58:57  hosking]
 *
 * Revision 1.1.2.3  1992/04/05  18:19:36  marquard
 * 	paclif POSIX ACL interface program.
 * 	[1992/04/05  11:52:11  marquard]
 * 
 * $OSF_EndLog$
 */
/*
 ...
 *	@(#)headers.c	2.10 16:31:02 5/17/91 SecureWare
 */

/* #ident "@(#)headers.c	1.1 11:16:36 11/8/91 SecureWare" */
