 ...
 */
#ifndef lint
static char *rcsid = "@(#)$RCSfile: putscr.c,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1993/04/01 20:13:33 $";
#endif
/*
 * @OSF_COPYRIGHT@
 */
 ...
 *  *** OSF1_1_1 version ***
 * 
 * Revision 1.1.4.2  1992/06/11  17:05:16  hosking
 * 	bug 6057: ANSI C changes to allow '-pedantic' to be enabled
 * 	[1992/06/11  17:00:01  hosking]
 *
 * Revision 1.1.2.3  1992/04/05  18:20:27  marquard
 * 	paclif POSIX ACL interface program.
 * 	[1992/04/05  11:53:41  marquard]
 * 
 * $OSF_EndLog$
 */
/*
 ...
 *	@(#)putscr.c	1.18 16:31:18 5/17/91 SecureWare
 */

/* #ident "@(#)putscr.c	1.1 11:18:17 11/8/91 SecureWare" */

/*
 * the putscreen() routine and the subroutines that it calls to display
 * a screen.
 */
...
static void draw_prompt(), draw_toggle(), draw_alpha(), draw_number(),
     draw_yn(), draw_scrtogl1items();

void draw_scrollitems();

#define HEREAMI(Q) DUMPDECP(Q, NULL, NULL, NULL);

void
putscreen (screenp, structp, clear_it)
struct	scrn_parms	*screenp;	/* screen description */
struct	scrn_struct	*structp;	/* data values for screen */
uchar	clear_it;			/* clear screen? */
{
