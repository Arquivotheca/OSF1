 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: test05.c,v $ $Revision: 4.2 $ (DEC) $Date: 1991/09/19 23:43:32 $";
#endif 
/*
 */
/*
...
char testpurpose[] = "test no such loader name (ENOENT)";
char usagestring[] = "[-v] [-q]";

extern char **environ;
extern int optind;

#define	LOADER	"/abc/def/ghi/jkl"
