...
# HISTORY
#
#	@(#)$RCSfile: machdep.mk,v $ $Revision: 4.2.4.2 $ (DEC) $Date: 1992/03/19 09:16:04 $
#
...
# in a sandbox to pick of the include file.

rcoff_relocate.o__CCFLAGS_ = ${_CCFLAGS_} -I../rcoff/PMAX/include
../rcoff/rcoff_relocate.o_CFLAGS = ${CFLAGS} -I../rcoff/PMAX/include
