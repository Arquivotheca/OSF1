 ...
 */
#ifndef lint
static char	*sccsid = "@(#)$RCSfile: kls_switch.c,v $ $Revision: 1.1.3.2 $ (DEC) $Date: 1992/03/19 09:16:22 $";
#endif 
/*
...
/* kls_switch.c
 * 
 * the kernel loader switch (only used when statically linking the
 * kernel loader server)
 *
 * OSF/1 Release 1.0
 */
