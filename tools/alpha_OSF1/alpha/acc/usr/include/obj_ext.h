...
forall_previous_objs (
    ...
    unsigned long	(*routine)(
#if __STDC__
				struct obj	*cur, struct obj	*orig,
				unsigned long d
#endif
				),
    unsigned long	data
...
foreach_sublist (
    ...
    unsigned long	(*routine)(
#if __STDC__
		struct obj_list *head, unsigned long data
#endif
				),
    unsigned long	data
    );
...
dbx_obj_open(struct obj	*obj,
	char		*objname);
extern struct obj *
dbx_obj_open_fd(struct obj	*obj,
	int		procfd);
extern struct obj * 
...
extern Elf32_Addr
obj_dynsym_got_fcn(struct obj *o, int i);
extern Elf32_Addr
obj_set_dynsym_got_fcn(struct obj *o, int i, Elf32_Addr x);
extern unsigned long
procedure_symbol(
	struct obj	*obj,
	long		procedure);
...
extern void
obj_set_hash_address(struct obj *obj, Elf32_Word *x);
extern char *
...
extern Elf32_Word
obj_mgot_count(struct obj *obj);
extern void
obj_set_mgot_count(struct obj *obj, Elf32_Word x);
extern void
obj_set_mgot_local_table(struct obj *obj, Elf32_Got **x);
extern void
obj_set_mgot_external_table(struct obj *obj, Elf32_Got **x);
extern Elf32_Got *
obj_mgot_local(struct obj *obj, Elf32_Word gotno);
extern void
obj_set_mgot_local(struct obj *obj, Elf32_Word gotno, Elf32_Got *x);
extern Elf32_Got *
obj_mgot_external(struct obj *obj, Elf32_Word gotno);
extern void
obj_set_mgot_external(struct obj *obj, Elf32_Word gotno, Elf32_Got *x);
extern Elf32_Word
obj_mgot_local_count(struct obj *obj, Elf32_Word gotno);
extern Elf32_Word
obj_mgot_external_count(struct obj *obj, Elf32_Word gotno);
extern Elf32_Addr
obj_mgot_local_entry(struct obj *obj, Elf32_Word gotno, int i);
extern void
obj_set_mgot_local_entry(struct obj *obj, Elf32_Word gotno, int i,
			 Elf32_Addr x);
extern Elf32_Addr
obj_mgot_external_entry(struct obj *obj, Elf32_Word gotno, int i);
extern void
obj_set_mgot_external_entry(struct obj *obj, Elf32_Word gotno, int i,
			    Elf32_Addr x);
extern Elf32_Word
obj_mgot_first_multisym(struct obj *obj);
extern void
obj_set_mgot_first_multisym(struct obj *obj, Elf32_Word x);
#endif /* __OBJ_EXT_H */
